...
SIMPLE_TARGETS = (
    SimpleTarget(
        "algae/3n_bbm_v.yaml", "CultureMech:000039", "MR_3N_BBM_V.pdf",
        (row("Make up to 1 litre with deionised water. For agar, add", "15", "G_PER_L"),),
        steps=(make_up("deionised water"), add_agar(), AUTOCLAVE),
    ),
    SimpleTarget(
        "algae/CCAP_ASW 150 + barley  + barley grain_).yaml", "CultureMech:000045", "MR_ASW_150.pdf",
    ...
    SimpleTarget(
        "algae/CCAP_ASW 300 + barley  + barley grain_).yaml", "CultureMech:000049", "MR_ASW_300.pdf",
    ...
    SimpleTarget(
        "algae/CCAP_C Medium_ Modified.yaml", "CultureMech:000057", "MR_C_Modified.pdf",
        (row("Add to 1000 ml of distilled water", "0.75", "G_PER_L"),),
        replacements=(NA2_EDTA,),
        steps=(
            step("DISSOLVE", "Dissolve Tris in 900 mL distilled water, then add the remaining final-medium components."),
    ...
    SimpleTarget(
        "algae/CCAP_TAP Medium.yaml", "CultureMech:000139", "MR_TAP.pdf",
        (row("Make up to 1 litre with deionised water. For agar, add", "15", "G_PER_L"),),
        steps=(make_up("deionised water"), add_agar(), AUTOCLAVE),
    ),
    SimpleTarget(
        "algae/asw.yaml", "CultureMech:000050", "MR_ASW.pdf",
        (row("Make up to", "1", "L"),),
        steps=(make_up("filtered natural seawater"), adjust_ph("7.6-7.8"), AUTOCLAVE),
    ),
    SimpleTarget(
        "algae/asw_150_barley.yaml", "CultureMech:000044", "MR_ASW_150.pdf",
        (row("Make up to 1 litre with deionised water. Adjust pH to 7-8 with", "1", "MOLAR"),),
        steps=(make_up("deionised water"), adjust_ph("7-8"), AUTOCLAVE),
    ),
    SimpleTarget(
        "algae/asw_300_barley.yaml", "CultureMech:000048", "MR_ASW_300.pdf",
        (row("Make up to 1 litre with deionised water. Adjust pH to 7.6-8 with", "1", "MOLAR"),),
        steps=(make_up("deionised water"), adjust_ph("7.6-8"), AUTOCLAVE),
    ),
    SimpleTarget(
        "algae/asw_barley.yaml", "CultureMech:000043", "MR_ASW_Barley.pdf",
        (row("HCl. Add", "1", "G_PER_L"),),
        replacements=(IngredientSpec(
            "Barley grain", "variable", "VARIABLE",
    ...
    SimpleTarget(
        "algae/aswp.yaml", "CultureMech:000051", "MR_ASWP.pdf",
        (row("Make up to 1 litre with deionised water and adjust pH to 7.6 - 7.8 with", "1", "MOLAR"),),
        steps=(make_up("deionised water"), adjust_ph("7.6-7.8"), AUTOCLAVE),
    ),
    SimpleTarget(
        "algae/bg.yaml", "CultureMech:000055", "MR_BG11.pdf",
        (
            row("Make up to 1 litre with deionised water. Adjust pH to 7.1 with", "1", "MOLAR"),
            row("For agar, add", "15.0", "G_PER_L"),
        ),
        steps=(make_up("deionised water"), adjust_ph("7.1", "1 M NaOH or HCl"), add_agar("15.0"), AUTOCLAVE),
    ),
    SimpleTarget(
        "algae/c_medium_modified.yaml", "CultureMech:000056", "MR_C_Modified.pdf",
        (row("Add to 1000 ml of distilled water", "0.75", "G_PER_L"),),
        replacements=(NA2_EDTA,),
        steps=(
            step("DISSOLVE", "Dissolve Tris in 900 mL distilled water, then add the remaining final-medium components."),
    ...
    SimpleTarget(
        "algae/cgm.yaml", "CultureMech:000058", "MR_CGM.pdf",
        (row("Make up to 1 litre with deionised water. For agar, add", "15", "G_PER_L"),),
        steps=(make_up("deionised water"), add_agar(), AUTOCLAVE),
    ),
    SimpleTarget(
        "algae/dm.yaml", "CultureMech:000063", "MR_DM.pdf",
    ...
    SimpleTarget(
        "algae/eg.yaml", "CultureMech:000070", "MR_EG.pdf",
        (row("Add the above constituents and make up to 1 litre with deionised water. For agar, add", "15", "G_PER_L"),),
        steps=(make_up("deionised water"), add_agar(), AUTOCLAVE),
    ),
    SimpleTarget(
        "algae/f_2.yaml", "CultureMech:000149", "MR_f2.pdf",
        (row("Make up to 1 litre with filtered natural seawater. Adjust pH to 8.0 with", "1", "MOLAR"),),
        steps=(make_up("filtered natural seawater"), adjust_ph("8.0"), add_agar(), AUTOCLAVE),
    ),
    SimpleTarget(
        "algae/f_2_si.yaml", "CultureMech:000148", "MR_f2Si.pdf",
        (
            row("Make up to 1 litre with filtered natural seawater. Adjust pH to 8.0 with", "1", "MOLAR"),
    ...
    SimpleTarget(
        "algae/f_2_si_for_heterotrophic_growth.yaml", "CultureMech:000147", "MR_f2Si_heterotrophic.pdf",
        (row("Make up to 1 litre with filtered natural seawater. Adjust pH to 8.0 with", "1", "MOLAR"),),
        steps=(make_up("filtered natural seawater"), adjust_ph("8.0", "1 M NaOH or HCl"), AUTOCLAVE),
    ),
    SimpleTarget(
        "algae/fdmed.yaml", "CultureMech:000072", "MR_FDMed.pdf",
    ...
    SimpleTarget(
        "algae/jm.yaml", "CultureMech:000074", "MR_JM.pdf",
    ...
    SimpleTarget(
        "algae/k35.yaml", "CultureMech:000078", "MR_K35.pdf",
        (row("Make up to 1 litre with deionised water. Adjust pH to 8.1 - 8.4 with", "1", "MOLAR"),),
        steps=(make_up("deionised water"), adjust_ph("8.1-8.4"), add_agar(), AUTOCLAVE),
    ),
    SimpleTarget(
        "algae/k_medium.yaml", "CultureMech:000076", "MR_K.pdf",
        (row("Make up to 1 litre with filtered natural seawater. Adjust pH to 8.0 with", "1", "MOLAR"),),
        steps=(make_up("filtered natural seawater"), adjust_ph("8.0"), AUTOCLAVE),
    ),
    SimpleTarget(
        "algae/k_minimum.yaml", "CultureMech:000077", "MR_Kmin.pdf",
        (row("Make up to 1 litre with filtered natural seawater. Adjust pH to 8.0 with", "1", "MOLAR"),),
        steps=(make_up("filtered natural seawater"), adjust_ph("8.0"), AUTOCLAVE),
    ),
    SimpleTarget(
        "algae/l1.yaml", "CultureMech:000079", "MR_L1.pdf",
        (row("Make up to 1 litre with filtered natural seawater. Adjust pH to 8.0 with", "1", "MOLAR"),),
        steps=(make_up("filtered natural seawater"), adjust_ph("8.0"), add_agar(), AUTOCLAVE),
    ),
    SimpleTarget(
        "algae/maf6_se.yaml", "CultureMech:000081", "MR_MAF6_SE.pdf",
        (
            row("Add to 1000 ml of distilled water", "0.75", "G_PER_L"),
            row("Soil is prepared as above.", "105", "G_PER_L"),
        ),
        replacements=(NA2_EDTA,),
        add_solutions=(SolutionSpec(
            "SE2 (Soil Extract 2)", "30", "ML_PER_L", "CultureMech:000129", "SE2",
    ...
    SimpleTarget(
        "algae/masm.yaml", "CultureMech:000082", "MR_MASM.pdf",
    ...
    SimpleTarget(
        "algae/mdy_v.yaml", "CultureMech:000088", "MR_MDY_V.pdf",
        (row("Add to 1000 ml of distilled water", "0.75", "G_PER_L"),),
        replacements=(NA2_EDTA,),
        steps=(
            make_up("distilled water"),
    ...
    SimpleTarget(
        "algae/met_44.yaml", "CultureMech:000096", "MR_MET44.pdf",
    ...
    SimpleTarget(
        "algae/mhy.yaml", "CultureMech:000091", "MR_MHY.pdf",
    ...
    SimpleTarget(
        "algae/mp.yaml", "CultureMech:000092", "MR_MP_Modified_Provasoli.pdf",
        (row("For agar, add", "15", "G_PER_L"),),
        steps=(add_agar(),),
    ),
    SimpleTarget(
        "algae/my75s.yaml", "CultureMech:000095", "MR_MY75S.pdf",
        (row("Make up the", "75", "PERCENT_W_V"),),
        replacements=(
            IngredientSpec(
                "Filtered natural seawater", "750", "ML_PER_L",
                "Source-asserted liquid volume in the final medium.",
            ),
            IngredientSpec(
                "Deionised water", "250", "ML_PER_L",
                "Source-asserted liquid volume in the final medium.",
                "CHEBI:15377", "water", True,
            ),
        ),
        steps=(
    ...
    SimpleTarget(
        "algae/pp.yaml", "CultureMech:000115", "MR_PP.pdf",
        (row("Make up to 1 litre with deionised water. For agar, add", "15", "G_PER_L"),),
        steps=(make_up("deionised water"), add_agar(), AUTOCLAVE),
    ),
    SimpleTarget(
        "algae/ucm.yaml", "CultureMech:000140", "MR_UCM.pdf",
    ...
    SimpleTarget(
        "algae/um.yaml", "CultureMech:000141", "MR_UM.pdf",
        (row("Make up to 1 litre with deionised water and adjust pH to 7.6 - 7.8 with", "1", "MOLAR"),),
        steps=(make_up("deionised water"), adjust_ph("7.6-7.8"), AUTOCLAVE),
    ),
    SimpleTarget(
        "algae/waris_h.yaml", "CultureMech:000143", "MR_Waris_H.pdf",
    ...
    SimpleTarget(
        "algae/wmy.yaml", "CultureMech:000150", "MR_wMY.pdf",
        (row("Add the above constituents and make up to 1 litre with deionised water. For agar, add", "15", "G_PER_L"),),
        steps=(make_up("deionised water"), add_agar(), AUTOCLAVE),
    ),
    SimpleTarget(
        "algae/zm_10.yaml", "CultureMech:000146", "MR_ZM10.pdf",
        ...
        steps=(
            ...
            AUTOCLAVE,
            step("COOL", "Cool to approximately 55 deg C before adding sterile marine supplement stock."),
        ),
        field_updates=(("physical_state", "SOLID_AGAR"),),
    ),
)
...
REBUILD_TARGETS = (
    RebuildTarget(
        "algae/ajs.yaml", "CultureMech:000041", "MR_AJS.pdf",
        (
        ...
        ingredients=(IngredientSpec(
            "Concentrated H2SO4", "10", "ML_PER_L",
            "Source-asserted addition to approximately 1 L final medium.",
            "CHEBI:26836", "sulfuric acid", True,
        ),),
        solutions=(
            SolutionSpec("JM (Jaworski's Medium)", "970", "ML_PER_L", "CultureMech:000074", "JM", "97% constituent medium."),
            SolutionSpec("SE2 (Soil Extract 2)", "30", "ML_PER_L", "CultureMech:000129", "SE2", "3% constituent medium."),
        ),
        steps=(
    ...
    RebuildTarget(
        "algae/bb_merds.yaml", "CultureMech:000054", "MR_BB_MErds.pdf",
        (
        ...
        ingredients=(),
        solutions=(
            SolutionSpec("BB (Bold's Basal Medium)", "variable", "VARIABLE", "CultureMech:000053", "BB", "Use 800 mL/L in the 8:2 variant or 500 mL/L in the 1:1 variant."),
            SolutionSpec("MErds (Modified Foyns Erdschreiber Medium)", "variable", "VARIABLE", "CultureMech:000089", "MErds", "Use 200 mL/L in the 8:2 variant or 500 mL/L in the 1:1 variant."),
        ),
        steps=(step("MIX", "Mix the two constituent media, then autoclave at 15 psi for 15 minutes."),),
        add_variants=(
            {
                "name": "bb_merds_8_2",
    ...
    RebuildTarget(
        "algae/eg_jm.yaml", "CultureMech:000071", "MR_EG_JM.pdf",
        (
        ...
        ingredients=(),
        solutions=(
            SolutionSpec("EG (Euglena gracilis Medium)", "500", "ML_PER_L", "CultureMech:000070", "EG", "One half of the final 1:1 mixture."),
            SolutionSpec("JM (Jaworski's Medium)", "500", "ML_PER_L", "CultureMech:000074", "JM", "One half of the final 1:1 mixture."),
        ),
        steps=(step("MIX", "Mix EG and JM in a 1:1 ratio."), AUTOCLAVE),
    ),
    RebuildTarget(
        "algae/mbbm.yaml", "CultureMech:000083", "MR_MBBM.pdf",
        (
        ...
        ingredients=(
            IngredientSpec("Bacto peptone", "1", "G_PER_L", "Direct final-medium ingredient.", "MICRO:0000178", "peptone"),
            IngredientSpec("Sucrose", "5", "G_PER_L", "Direct final-medium ingredient.", "CHEBI:17992", "sucrose", True),
        ),
        solutions=(SolutionSpec(
            "3N-BBM+V", "1000", "ML_PER_L", "CultureMech:000039", "3N-BBM+V",
    ...
    RebuildTarget(
        "algae/per.yaml", "CultureMech:000111", "MR_PER.pdf",
        (row("Soil is prepared as above.", "105", "G_PER_L"),),
        ingredients=(IngredientSpec("Complan", "1", "G_PER_L", "Source-asserted commercial nutrient powder."),),
        solutions=(SolutionSpec(
            "SES (Soil Extract with Added Salts)", "1000", "ML_PER_L", "CultureMech:000130", "SES",
            "Source-defined base medium.",
        ),),
        steps=(step("MIX", "Add 1 g Complan to 1 L SES."), AUTOCLAVE),
    ),
    RebuildTarget(
        "algae/sbbm.yaml", "CultureMech:000127", "MR_SBBM.pdf",
        (
            row("Make up to 1 litre with distilled water. For agar add", "15", "G_PER_L"),
            row("Add to 1000 ml of distilled water", "0.75", "G_PER_L"),
            row("FeCl3 x 6 H2O", "0.097", "G_PER_L"),
        ...
        ingredients=(),
        solutions=(
            SolutionSpec("3N-BBM+V", "970", "ML_PER_L", "CultureMech:000039", "3N-BBM+V", "97% constituent medium."),
            SolutionSpec("SE2 (Soil Extract 2)", "30", "ML_PER_L", "CultureMech:000129", "SE2", "3% constituent medium."),
        ),
        steps=(step("MIX", "Prepare and sterilize both constituent media, then mix aseptically at 97:3."),),
    ),
    RebuildTarget(
        "algae/ses_mp.yaml", "CultureMech:000132", "MR_SES_MP.pdf",
        (row("Soil is prepared as above.", "105", "G_PER_L"),),
        ingredients=(),
        solutions=(
            SolutionSpec("SES (Soil Extract with Added Salts)", "750", "ML_PER_L", "CultureMech:000130", "SES", "Three quarters of the final 3:1 mixture."),
            SolutionSpec("Chapman-Andresen's Modified Pringsheim's Solution", "250", "ML_PER_L", "CultureMech:000062", "Modified Pringsheim's Solution", "One quarter of the final 3:1 mixture."),
        ),
        steps=(step("MIX", "Autoclave the constituent media separately, then mix aseptically at 3:1."),),
    ),
    RebuildTarget(
        "algae/ses_pj.yaml", "CultureMech:000131", "MR_SES_PJ.pdf",
        (
        ...
        ingredients=(),
        solutions=(
            SolutionSpec("SES (Soil Extract with Added Salts)", "500", "ML_PER_L", "CultureMech:000130", "SES", "One half of the final 1:1 mixture."),
            SolutionSpec("PJ (Prescott's and James's Solution)", "500", "ML_PER_L", "CultureMech:000112", "PJ", "One half of the final 1:1 mixture."),
        ),
        steps=(step("MIX", "Autoclave the constituent media separately, then mix aseptically at 1:1."),),
    ),
)
...
def _already_applied(doc: dict[str, Any], path: str) -> bool:
    return any(
        ...
        for event in _history(doc, path)
    )
...
def _append_event(
    doc: dict[str, Any], path: str, source: str, before: int, after: int
) -> None:
...
def repair_simple(doc: dict[str, Any], target: SimpleTarget) -> tuple[dict[str, Any], bool]:
    ...
    if _already_applied(doc, target.path):
        ...
        if lingering:
            raise ValueError(f"{target.path}: repaired event exists but old rows remain: {lingering!r}")
        return doc, False
    ...
    for expected in target.rows:
        ...
        if len(matches) != 1:
            raise ValueError(
                f"{target.path}: expected one {expected!r} row, found {len(matches)}"
            )
        indexes.append(matches[0])

    repaired = copy.deepcopy(doc)
    new_ingredients = [
        item for index, item in enumerate(current) if index not in set(indexes)
    ]
    ...
    _append_event(
        repaired, target.path, target.source, len(current), len(new_ingredients)
    )
...
def repair_rebuild(doc: dict[str, Any], target: RebuildTarget) -> tuple[dict[str, Any], bool]:
    ...
    repaired["ingredients"] = [
        ingredient(spec, target.source) for spec in target.ingredients
    ]
    ...
    if target.add_variants:
        ...
        variants.extend(copy.deepcopy(target.add_variants))
    _append_event(
        repaired, target.path, target.source, len(current), len(target.ingredients)
    )
    return repaired, True
