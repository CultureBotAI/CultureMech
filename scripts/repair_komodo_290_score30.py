...
KOMODO_290_URL = (
    "https://komodo.modelseed.org/servlet/" "KomodoTomcatServerSideUtilitiesModelSeed?MediaInfo=290"
)
DSMZ_290_URL = (
        ...
        if component.preferred_term == "MgCl2 x 6 H2O":
            components.append(
                Component(
                    ...
                    SOURCE_290,
                    (f"{SOURCE_290} changes the DSMZ Medium 193 " "MgCl2 x 6 H2O to 2.2 g/L."),
                )
            )
            continue
