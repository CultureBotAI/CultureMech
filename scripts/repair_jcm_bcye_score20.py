#!/usr/bin/env python3
"""Repair JCM 119 BCYE Agar and its TOGO source duplicate."""
...
CURATOR = "repair_jcm_bcye_score20.py"
ACTION = "RESOLVED_JCM_J119_BCYE_AGAR"
TIMESTAMP = "2026-09-10T00:00:00-07:00"

JCM = "bacterial/JCM_J119_BCYE_AGAR.yaml"
TOGO = "bacterial/TOGO_M111_BCYE_Agar.yaml"

JCM_URL = "https://www.jcm.riken.jp/cgi-bin/jcm/jcm_grmd?GRMD=119"
TOGO_URL = "https://togomedium.org/medium/M111"

BCYE = "BCYE agar (BD-Difco)"
IMPORTED_BCYE = "BCYE agar"
LEGIONELLA = "Legionella agar enrichment (BD-Difco)"
IMPORTED_LEGIONELLA = "Legionella agar enrichment"
WATER = "Distilled water"

EXPECTED_IDS = {
    JCM: "CultureMech:002367",
    TOGO: "CultureMech:007640",
}

EXPECTED_SOURCE_TERMS = {
    JCM: "mediadive.medium:J119",
    TOGO: "TOGO:M111",
}
...
TARGETS: tuple[Target, ...] = (
    Target(
        ...
        notes=(
            "Source: JCM Medium 119 | Link: "
            "https://www.jcm.riken.jp/cgi-bin/jcm/jcm_grmd?GRMD=119\n\n"
            "The JCM BCYE Agar table lists BCYE agar, Legionella agar "
            "enrichment, and distilled water as supplied BD-Difco products."
        ),
    ),
    Target(
        path=TOGO,
        ...
        notes=(
            "Source: TOGO Medium M111 | Link: https://togomedium.org/medium/M111\n\n"
            "TOGO Medium M111 mirrors JCM Medium 119 BCYE Agar: BCYE agar, "
            "Legionella agar enrichment, and distilled water."
        ),
    ),
)
...
INGREDIENTS: tuple[dict[str, Any], ...] = (
    _ingredient(
        ...
        "37",
        "G_PER_L",
        notes="JCM Medium 119 lists this commercial BD-Difco medium base as supplied.",
    ),
    _ingredient(
        LEGIONELLA,
        "100",
        "ML_PER_L",
        notes="JCM Medium 119 lists this commercial BD-Difco enrichment as supplied.",
    ),
    _ingredient(
        WATER,
        "900",
        ...
        notes="JCM Medium 119 brings the base plus enrichment to 1 L.",
    ),
)
...
ACCEPTED_CONCENTRATIONS = {
    BCYE: ({"value": "37", "unit": "G_PER_L"},),
    IMPORTED_BCYE: ({"value": "37", "unit": "G_PER_L"},),
    LEGIONELLA: (
    ...
    WATER: (
        {"value": "900", "unit": "ML_PER_L"},
        {"value": "900", "unit": "G_PER_L"},
    ),
}

OFFICIAL_NAMES = frozenset(ACCEPTED_CONCENTRATIONS)
BCYE_NAMES = frozenset((BCYE, IMPORTED_BCYE))
LEGIONELLA_NAMES = frozenset((LEGIONELLA, IMPORTED_LEGIONELLA))
...
TOGO_CHILD = {
    ...
    "name": "bcye_agar",
    "notes": "TOGO Medium M111 points to the same JCM Medium 119 recipe.",
}
...
JCM_PARENT = {
    ...
    "id": EXPECTED_IDS[JCM],
    "name": "bcye_agar",
    "notes": "MediaDive JCM import for the same JCM Medium 119 recipe.",
}
...
def _require_target(doc: dict[str, Any], path: str) -> None:
    ...
    if not BCYE_NAMES.intersection(ingredients) or not LEGIONELLA_NAMES.intersection(ingredients):
        raise ValueError(f"{path}: missing BCYE Agar core ingredient")
...
def _append_curation_event(doc: dict[str, Any], target: Target) -> None:
    event = {
        ...
        "curator": CURATOR,
        "action": ACTION,
        "changes": "Resolved JCM Medium 119 BCYE Agar composition",
        "source": "; ".join(target.reference_urls),
        "notes": "Rebuilt the BCYE Agar ingredients from the JCM Medium 119 table.",
    }
