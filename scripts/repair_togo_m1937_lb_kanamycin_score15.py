#!/usr/bin/env python3
"""Repair TOGO M1937 LB + Kanamycin medium."""
...
TARGET = Path("bacterial/lb_kanamycin_medium.yaml")
LB_PARENT = Path("bacterial/lb_medium.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_togo_m1937_lb_kanamycin_score15.py"
ACTION = "RESOLVED_TOGO_M1937_LB_KANAMYCIN_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

EXPECTED_ID = "CultureMech:008515"
EXPECTED_MEDIA_TERM = "TOGO:M1937"
LB_PARENT_ID = "CultureMech:008037"
TOGO_M1937 = "https://togomedium.org/medium/M1937"
NBRC_1204 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=1204"
SOURCE = "TOGO M1937 / NBRC Medium 1204"
...
IMPORTED_SOLUTION_SIGNATURE: tuple[SolutionSignature, ...] = (
    ("Kanamycin sulfate solution (20 mg/ml)*", "1", "G_PER_L", ()),
)
...
KANAMYCIN_SIGNATURE: tuple[Component, ...] = (("Kanamycin sulfate", "20.0", "MG_PER_ML"),)

FINAL_SOLUTION_SIGNATURE: tuple[SolutionSignature, ...] = (
    ("Kanamycin sulfate solution (20 mg/ml)", "1.0", "ML_PER_L", KANAMYCIN_SIGNATURE),
)
...
NOTES = (
    "TOGO M1937 imports NBRC Medium 1204 LB + Kanamycin medium. NBRC 1204 "
    "lists the LB base with 1.0 ml/L Kanamycin sulfate solution (20 mg/ml), "
...
PARENT_MEDIA = {
    ...
    "name": "lb_medium",
    "notes": (
        "NBRC Medium 1204 supplements LB Medium with 1.0 ml/L separately "
        "filter-sterilized Kanamycin sulfate solution (20 mg/ml)."
    ),
}
...
VARIANT_CHILD = {
    ...
    "relationship": "SUPPLEMENTED_VARIANT",
    "id": EXPECTED_ID,
    "name": "lb_kanamycin_medium",
    "notes": PARENT_MEDIA["notes"],
}

VARIANT_MODIFICATIONS = (
    "Adds 1.0 ml/L Kanamycin sulfate solution (20 mg/ml) after separate " "filter sterilization."
)
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "description": "Sterilize the 20 mg/ml kanamycin sulfate stock separately by filtration.",
    },
    {
        "step_number": 3,
        "action": "MIX",
...
INGREDIENTS: tuple[dict[str, Any], ...] = (
    _component(
        ...
        "G_PER_L",
        notes=(
            "NBRC Medium 1204 lists Bacto Tyrptone (Difco) as a source-disclosed "
...
SOLUTIONS: tuple[dict[str, Any], ...] = (
    {
        "preferred_term": "Kanamycin sulfate solution (20 mg/ml)",
        "concentration": {"value": "1.0", "unit": "ML_PER_L"},
        "source": SOURCE,
        "notes": f"{SOURCE} lists 1 ml/L Kanamycin sulfate solution (20 mg/ml).",
        ...
        "composition": [
            _component(
                ...
                "20.0",
                "MG_PER_ML",
                notes="NBRC Medium 1204 specifies this stock as 20 mg/ml Kanamycin sulfate.",
            )
        ],
        "name": "Kanamycin sulfate solution (20 mg/ml)",
...
def _ensure_references(doc: dict[str, Any]) -> None:
    ...
    for reference in (TOGO_M1937, NBRC_1204):
...
def _append_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            ...
            "20 mg/ml kanamycin sulfate stock."
        ),
    }
