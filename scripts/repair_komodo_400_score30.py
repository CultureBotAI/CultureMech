#!/usr/bin/env python3
"""Repair empty KOMODO 400 DESULFOVIBRIO GIGANTEUS MEDIUM."""
...
TARGET = Path("bacterial/desulfovibrio_giganteus_medium.yaml")
EXPECTED_ID = "CultureMech:005196"
EXPECTED_MEDIA_TERM = "komodo.medium:400"
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

KOMODO_400_URL = (
    "https://komodo.modelseed.org/servlet/" "KomodoTomcatServerSideUtilitiesModelSeed?MediaInfo=400"
)
DSMZ_400_URL = (
    "https://web.archive.org/web/20121030082653id_/"
    "http://www.dsmz.de/microorganisms/medium/pdf/DSMZ_Medium400.pdf"
)

SOURCE_400 = "Archived DSMZ Medium 400"

CURATOR = "repair_komodo_400_score30.py"
ACTION = "RESOLVED_KOMODO_400_SCORE30"
TIMESTAMP = "2026-09-10T00:00:00-07:00"
NOTES = (
    "Archived DSMZ Medium 400 defines DESULFOVIBRIO GIGANTEUS MEDIUM as DSMZ "
    "Medium 193 with 20 g/L NaCl, 0.4 g/L MgCl2 x 6 H2O, and 2.5 g/L "
    "sodium lactate replacing the DSMZ 193 acetate substrate; this record "
    "expands archived DSMZ Media 400, 193, 320, and 141 into final "
    "per-liter components."
)


def _iter_komodo_400_components() -> tuple[Component, ...]:
        ...
        if component.preferred_term == "NaCl":
            components.append(
                Component(
                    ...
                    SOURCE_400,
                    f"{SOURCE_400} changes the DSMZ Medium 193 NaCl to 20 g/L.",
                )
            )
            continue
        if component.preferred_term == "MgCl2 x 6 H2O":
            components.append(
                Component(
                    ...
                    SOURCE_400,
                    (f"{SOURCE_400} changes the DSMZ Medium 193 " "MgCl2 x 6 H2O to 0.4 g/L."),
                )
            )
            continue
        if component.preferred_term == "Sodium propionate":
            components.append(
                Component(
                    ...
                    SOURCE_400,
                    (
                        f"{SOURCE_400} replaces the acetate substrate with "
                        "2.5 g/L sodium lactate."
                    ),
                )
            )
            continue
    ...
    components.append(
        Component(
            ...
            (
                ...
                f"additions; {SOURCE_400} replaces the DSMZ Medium 193 "
                "acetate substrate."
            ),
        )
    )
...
COMPONENTS = _iter_komodo_400_components()
...
def _ensure_references(doc: dict[str, Any]) -> None:
    doc["references"] = [
        {"reference": KOMODO_400_URL},
        {"reference": DSMZ_400_URL},
