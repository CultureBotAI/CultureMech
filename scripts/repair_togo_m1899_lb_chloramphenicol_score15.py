#!/usr/bin/env python3
"""Repair TOGO M1899 LB + Chloramphenicol medium."""
...
TARGET = Path("bacterial/lb_chloramphenicol_medium.yaml")
LB_PARENT = Path("bacterial/lb_medium.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_togo_m1899_lb_chloramphenicol_score15.py"
ACTION = "RESOLVED_TOGO_M1899_LB_CHLORAMPHENICOL_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

EXPECTED_ID = "CultureMech:008474"
EXPECTED_MEDIA_TERM = "TOGO:M1899"
LB_PARENT_ID = "CultureMech:008037"
TOGO_M1899 = "https://togomedium.org/medium/M1899"
NBRC_1158 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=1158"
SOURCE = "TOGO M1899 / NBRC Medium 1158"
...
IMPORTED_SOLUTION_SIGNATURE: tuple[SolutionSignature, ...] = (
    ("Chloramphenicol solution (25 mg/ml)*", "1", "G_PER_L", ()),
)
...
FINAL_SOLUTION_SIGNATURE: tuple[SolutionSignature, ...] = (
    (
        "Chloramphenicol solution (25 mg/ml)",
        "1.0",
        "ML_PER_L",
        CHLORAMPHENICOL_SIGNATURE,
    ),
)
...
NOTES = (
    "TOGO M1899 imports NBRC Medium 1158 LB + Chloramphenicol medium. "
    "NBRC 1158 lists the LB base with 1.0 ml/L Chloramphenicol solution "
    "(25 mg/ml), 15 g/L agar if needed, and pH 7.0."
)
...
PARENT_MEDIA = {
    ...
    "name": "lb_medium",
    "notes": (
        "NBRC Medium 1158 supplements LB Medium with 1.0 ml/L separately "
        "filter-sterilized Chloramphenicol solution (25 mg/ml)."
    ),
}
...
VARIANT_CHILD = {
    ...
    "relationship": "SUPPLEMENTED_VARIANT",
    "id": EXPECTED_ID,
    "name": "lb_chloramphenicol_medium",
...
INGREDIENTS: tuple[dict[str, Any], ...] = (
    _component(
        ...
        "G_PER_L",
        notes=(
            "NBRC Medium 1158 lists Bacto Tryptone (Difco) as a source-disclosed "
...
SOLUTIONS: tuple[dict[str, Any], ...] = (
    {
        "preferred_term": "Chloramphenicol solution (25 mg/ml)",
        "concentration": {"value": "1.0", "unit": "ML_PER_L"},
        "source": SOURCE,
        "notes": f"{SOURCE} lists 1 ml/L Chloramphenicol solution (25 mg/ml).",
        "term": _term(*GROUNDINGS["Chloramphenicol"]),
        "mediaingredientmech_chebi_term": _term(*GROUNDINGS["Chloramphenicol"]),
        "composition": [
            _component(
                "Chloramphenicol",
                "25.0",
...
def _ensure_references(doc: dict[str, Any]) -> None:
    ...
    for reference in (TOGO_M1899, NBRC_1158):
...
def _append_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "curator": CURATOR,
        "action": ACTION,
        "source": f"{TOGO_M1899}; {NBRC_1158}",
        "notes": (
            f"{NOTES} Corrected the imported distilled-water row from a g/L artifact "
            "to an ml/L volume and nested the 25 mg/ml chloramphenicol stock."
        ),
    }
