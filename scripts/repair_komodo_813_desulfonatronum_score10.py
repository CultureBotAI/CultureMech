#!/usr/bin/env python3
"""Repair KOMODO 813 Desulfonatronum exact and strain child links."""
...
PARENT = Path("bacterial/desulfonatronum_medium.yaml")
PARENT_ID = "CultureMech:001958"
PARENT_NAME = "desulfonatronum_medium"
PARENT_SOURCE_TERM = "mediadive.medium:813"
...
CHILDREN = (
    Child(
        Path("bacterial/KOMODO_813_DESULFONATRONUM_medium.yaml"),
        "CultureMech:006536",
        "komodo.medium:813",
        "KOMODO Medium 813",
        SOURCE_DUPLICATE_RELATIONSHIP,
        "KOMODO Medium 813 has the same 30-ingredient signature as DSMZ Medium 813.",
    ),
    Child(
        Path("bacterial/for_dsm_14708.yaml"),
        "CultureMech:006535",
        "komodo.medium:813.1",
        "KOMODO Medium 813.1",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 813.1 applies DSMZ Medium 813 to DSM 14708.",
    ),
)
CHILD_BY_PATH = {child.path: child for child in CHILDREN}
EXPECTED_CHILD_COUNT = 2

CURATOR = "repair_komodo_813_desulfonatronum_score10.py"
ACTION = "RESOLVED_KOMODO_813_DESULFONATRONUM_TOPOLOGY"
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Re-rooted KOMODO Medium 813 Desulfonatronum exact topology",
            "source": "DSMZ Medium 813; KOMODO Medium 813 and 813.1",
            "notes": (
                "Moved exact KOMODO Medium 813 plus its DSM 14708 wrapper under "
                "DSMZ Medium 813; left DSMZ 813a and 813b out because their "
                "signatures differ."
            ),
        },
    )
...
def repair_child(relative_path: Path, doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": f"Linked under DSMZ Medium 813 as {child.relationship}",
