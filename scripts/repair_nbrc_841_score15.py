#!/usr/bin/env python3
"""Repair the score-15 NBRC Medium 841 TOGO import."""
...
TARGET = Path("bacterial/togo_medium_m1638.yaml")
PARENT = Path("bacterial/TOGO_M1553_Methylobacterium_Medium.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

EXPECTED_ID = "CultureMech:008193"
EXPECTED_PARENT_ID = "CultureMech:008102"
EXPECTED_MEDIA_TERM = "TOGO:M1638"
EXPECTED_PARENT_MEDIA_TERM = "TOGO:M1553"

CURATOR = "repair_nbrc_841_score15.py"
ACTION = "RESOLVED_NBRC_841_SCORE15"
LINK_ACTION = "LINKED_NBRC_841_METHYLOBACTERIUM_VARIANT"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

TOGO_M1638 = "https://togomedium.org/medium/M1638"
NBRC_841 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=841"
SOURCE = "NBRC Medium 841"

HIPOLYPEPTON = "Hipolypepton*"
YEAST_EXTRACT = "Yeast extract"
MAGNESIUM_SULFATE = "MgSO4·7H2O"
KANAMYCIN_SOLUTION_LEGACY = "Kanamycin sulfate solution (250 \u03bcg/ml)**"
KANAMYCIN_SOLUTION = "Kanamycin sulfate solution (250 ug/ml)"
KANAMYCIN_SULFATE = "Kanamycin sulfate"
...
LEGACY_SOLUTIONS: tuple[SolutionSignature, ...] = (
    (KANAMYCIN_SOLUTION_LEGACY, "100", "G_PER_L", ()),
...
KANAMYCIN_COMPOSITION: tuple[Component, ...] = ((KANAMYCIN_SULFATE, "0.25", "MG_PER_ML"),)
FINAL_SOLUTIONS: tuple[SolutionSignature, ...] = (
    (KANAMYCIN_SOLUTION, "100", "ML_PER_L", KANAMYCIN_COMPOSITION),
)
...
REFERENCES = (TOGO_M1638, NBRC_841)

VARIANT_MODIFICATIONS = (
    "Substitutes 100 ml/L filter-sterilized 250 ug/ml Kanamycin sulfate solution "
    "for the 5 ml/L methanol supplement and 100 ml/L of the water in TOGO M1553.",
)
VARIANT_NOTES = (
    "Substitutes 100 ml/L filter-sterilized 250 ug/ml Kanamycin sulfate "
    "solution for methanol and 100 ml/L water."
)
PARENT_MEDIA = {
...
RECIPE_NOTES = (
    "TOGO M1638 imports NBRC Medium 841, which lists 10 g/L Hipolypepton "
    "from Wako Pure Chemical Industries, 2 g/L Yeast extract, 1 g/L "
    "MgSO4·7H2O, 100 ml/L Kanamycin sulfate solution (250 ug/ml), "
    "900 ml/L Distilled water, and 15 g/L Agar if needed at pH 7.0. "
    "The kanamycin stock is sterilized separately by filtration."
)
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "action": "MIX",
        "description": (
            "Combine 10 g/L Hipolypepton, 2 g/L Yeast extract, "
            "1 g/L MgSO4·7H2O, and 900 ml/L Distilled water."
        ),
    },
    {
        "step_number": 2,
        "action": "MIX",
        "description": "Add 15 g/L agar when solid NBRC Medium 841 is needed.",
    },
    {
        "step_number": 3,
        "action": "FILTER_STERILIZE",
        "description": "Sterilize Kanamycin sulfate solution (250 ug/ml) by filtration.",
    },
    {
        "step_number": 4,
        "action": "MIX",
        "description": "Add 100 ml/L filter-sterilized Kanamycin sulfate solution.",
    },
    {
        "step_number": 5,
        "action": "ADJUST_PH",
...
def _notes(preferred_term: str, value: str, unit: str) -> str:
    ...
    if preferred_term == HIPOLYPEPTON:
        return (
            f"{SOURCE} lists {value} {UNIT_LABELS[unit]} Hipolypepton and "
            "notes that the asterisk marks Wako Pure Chemical Industries; "
            "this peptone product is retained as an opaque complex component."
        )
...
def _kanamycin_stock() -> dict[str, Any]:
    return {
        "preferred_term": KANAMYCIN_SOLUTION,
        "concentration": {"value": "100", "unit": "ML_PER_L"},
        "source": SOURCE,
        "notes": f"{SOURCE} lists 100 ml/L Kanamycin sulfate solution (250 ug/ml).",
        "term": _term(*GROUNDINGS[KANAMYCIN_SULFATE]),
        "mediaingredientmech_chebi_term": _term(*GROUNDINGS[KANAMYCIN_SULFATE]),
        "composition": [
            _component(
                KANAMYCIN_SULFATE,
                "0.25",
                "MG_PER_ML",
                notes=(f"{SOURCE} specifies this stock as 250 ug/ml Kanamycin sulfate."),
            )
        ],
        "name": KANAMYCIN_SOLUTION,
...
def repair_target(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _put_after(repaired, "solutions", [_kanamycin_stock()], "ingredients")
    ...
    _append_curation_event(
        ...
        action=ACTION,
        notes=(
            "Curated TOGO:M1638 from TOGO and NBRC Medium 841; corrected "
            "Distilled water from a mass-like 900 g/L import to 900 ml/L, "
            "moved Hipolypepton and Kanamycin sulfate solution from migrated "
            "empty solutions to the formula, nested the 250 ug/ml kanamycin "
            "stock, added pH 7.0, grounded yeast extract, magnesium sulfate "
            "heptahydrate, kanamycin sulfate, water, and agar, retained "
            "Hipolypepton as a sourced opaque component, and linked M1638 "
            "to M1553 as a substituted-component variant."
        ),
    )
    repaired["parent_media"] = copy.deepcopy(PARENT_MEDIA)
    repaired["variant_relationship"] = "SUBSTITUTED_COMPONENT_VARIANT"
    repaired["variant_modifications"] = list(VARIANT_MODIFICATIONS)
    return repaired
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _append_curation_event(
        repaired,
        action=LINK_ACTION,
        notes=("Linked NBRC Medium 841 as a kanamycin-stock Methylobacterium Medium variant."),
    )
    return repaired
