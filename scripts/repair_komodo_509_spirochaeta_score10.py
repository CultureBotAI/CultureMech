#!/usr/bin/env python3
"""Repair KOMODO 509 topology rooted at a strain-specific duplicate."""
...
PARENT = Path("bacterial/spirochaeta_thermophila_medium.yaml")
PARENT_ID = "CultureMech:000268"
PARENT_NAME = "spirochaeta_thermophila_medium"
PARENT_SOURCE_TERM = "mediadive.medium:509"
PARENT_PH = {"min": 7.2, "max": 7.4}

INGREDIENT_SIGNATURE = (
    ("NaCl", "15.7563", "G_PER_L"),
    ("MgCl2 x 6 H2O", "2.41597", "G_PER_L"),
    ("KCl", "0.52521", "G_PER_L"),
    ("NH4Cl", "0.315126", "G_PER_L"),
    ("KH2PO4", "0.210084", "G_PER_L"),
    ("CaCl2 x 2 H2O", "0.0315126", "G_PER_L"),
    ("Yeast extract", "1.05042", "G_PER_L"),
    ("Sodium resazurin", "0.00052521", "G_PER_L"),
    ("Na2CO3", "50", "G_PER_L"),
    ("Starch", "100", "G_PER_L"),
...
CURATOR = "repair_komodo_509_spirochaeta_score10.py"
ACTION = "RESOLVED_KOMODO_509_SPIROCHAETA_TOPOLOGY"
...
CHILDREN = (
    Child(
        Path("bacterial/spirochete_thermophile_medium.yaml"),
        "CultureMech:005711",
        "spirochete_thermophile_medium",
        "komodo.medium:509",
        "PH_VARIANT",
        {"min": 6.9, "max": 7.0},
        "KOMODO Medium 509 applies SPIROCHAETA THERMOPHILA MEDIUM at pH 6.9-7.0.",
    ),
    Child(
        Path("bacterial/for_dsm_6578.yaml"),
        "CultureMech:005710",
        "for_dsm_6578",
        "komodo.medium:509.1",
        "PH_VARIANT",
        {"min": 6.9, "max": 7.0},
        (
            "KOMODO Medium 509.1 applies SPIROCHAETA THERMOPHILA MEDIUM "
            "at pH 6.9-7.0 for DSM 6578."
        ),
    ),
)
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "notes": (
                "Linked the exact KOMODO 509 imports under the DSMZ/MediaDive "
                "SPIROCHAETA THERMOPHILA MEDIUM record."
            ),
        },
    )
    return repaired
...
def repair_child(doc: dict[str, Any], child: Child) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Linked under MediaDive Medium 509",
