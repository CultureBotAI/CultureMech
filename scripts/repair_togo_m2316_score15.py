#!/usr/bin/env python3
"""Repair TOGO M2316 Ottow Medium."""
...
TARGET = Path("bacterial/TOGO_M2316_Ottow_Medium.yaml")
DSMZ_PARENT = Path("bacterial/ottow_medium.yaml")
EXPECTED_ID = "CultureMech:008903"
EXPECTED_PARENT_ID = "CultureMech:001596"
EXPECTED_MEDIA_TERM = "TOGO:M2316"
EXPECTED_PARENT_MEDIA_TERM = "mediadive.medium:467"
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_togo_m2316_score15.py"
ACTION = "RESOLVED_TOGO_M2316_SCORE15"
LINK_ACTION = "LINKED_TOGO_M2316_SOURCE_DUPLICATE"
TIMESTAMP = "2026-09-11T00:00:00-07:00"

TOGO_M2316 = "https://togomedium.org/medium/M2316"
DSMZ_467 = "https://www.dsmz.de/microorganisms/medium/pdf/DSMZ_Medium467.pdf"

SOURCE = "TOGO M2316 / DSMZ Medium 467"
TITLE = "Ottow Medium"
...
REFERENCES = (TOGO_M2316, DSMZ_467)
PH_VALUE = 8.5
...
PARENT_MEDIA = {
    ...
    "name": "ottow_medium",
    "notes": "TOGO M2316 imports DSMZ Medium 467 and exactly matches its formula.",
}
...
TOGO_CHILD = {
    ...
    "id": EXPECTED_ID,
    "name": "ottow_medium",
    "notes": "TOGO M2316 imports DSMZ Medium 467 and exactly matches this parent formula.",
}
...
NOTES = (
    "TOGO M2316 imports DSMZ Medium 467, Ottow Medium. DSMZ Medium 467 "
    "lists, per liter, 1 g Glucose, 7.5 g Peptone, 5 g Meat extract, "
    "2.5 g Yeast extract, 2.5 g Casamino acids, 5 g NaCl, and 1000 ml "
    "Tap water. Adjust pH to 8.5."
)
...
def _component(
    ...
    *,
    ...
    row: dict[str, Any] = {
        ...
        "source": SOURCE,
        "notes": notes or f"DSMZ Medium 467 lists {value} {UNIT_LABELS[unit]} {preferred_term}.",
    }
...
INGREDIENTS: tuple[dict[str, Any], ...] = (
    ...
    _component("Peptone", "7.5", "G_PER_L"),
    _component("Meat extract", "5.0", "G_PER_L"),
    _component("Yeast extract", "2.5", "G_PER_L"),
    _component("Casamino acids", "2.5", "G_PER_L"),
    _component("NaCl", "5.0", "G_PER_L"),
    _component(
        "Tap water",
        "1.0",
        "L",
        notes="DSMZ Medium 467 lists 1000 ml Tap water.",
    ),
)
...
def repair_target(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _append_curation_event(
        ...
        action=ACTION,
        notes=(
            f"{NOTES} Corrected the tap-water unit, added the DSMZ pH "
            "adjustment step, grounded all components, and linked the record "
            "as a DSMZ Medium 467 source duplicate."
        ),
    )
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _append_curation_event(
        repaired,
        action=LINK_ACTION,
        notes="Linked TOGO M2316 as a source duplicate of DSMZ Medium 467.",
    )
    return repaired
