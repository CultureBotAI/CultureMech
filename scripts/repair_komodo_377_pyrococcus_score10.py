#!/usr/bin/env python3
"""Repair KOMODO 377 topology rooted at a strain-specific duplicate."""
...
PARENT = Path("archaea/pyrococcus_staphylothermus_medium.yaml")
PARENT_ID = "CultureMech:005113"
PARENT_NAME = "pyrococcus_staphylothermus_medium"
PARENT_SOURCE_TERM = "komodo.medium:377"
PARENT_PH = 6.5
RELATIONSHIP = "PH_VARIANT"

INGREDIENT_SIGNATURE = (
    ("NaCl", "14.5122", "G_PER_L"),
    ("MgSO4 x 7 H2O", "6.41463", "G_PER_L"),
    ("MgCl2 x 6 H2O", "2.68293", "G_PER_L"),
    ("KCl", "0.321951", "G_PER_L"),
    ("NaBr", "0.0487805", "G_PER_L"),
    ("H3BO3", "0.0246341", "G_PER_L"),
    ("SrCl2 x 6 H2O", "0.00682927", "G_PER_L"),
    ("(NH4)2SO4", "0.0097561", "G_PER_L"),
    ("Citric acid", "0.00487805", "G_PER_L"),
    ("KI", "4.87805e-05", "G_PER_L"),
    ("CaCl2 x 2 H2O", "0.831707", "G_PER_L"),
    ("KH2PO4", "0.487805", "G_PER_L"),
    ("NiCl2 x 6 H2O", "0.03195122", "G_PER_L"),
    ("Sodium resazurin", "0.000487805", "G_PER_L"),
    ("Sulfur", "29.2683", "G_PER_L"),
    ("Peptone", "4.87805", "G_PER_L"),
    ("Yeast extract", "0.97561", "G_PER_L"),
    ("NaHCO3", "1.95122", "G_PER_L"),
    ("Na2S x 9 H2O", "0.487805", "G_PER_L"),
...
CURATOR = "repair_komodo_377_pyrococcus_score10.py"
ACTION = "RESOLVED_KOMODO_377_PYROCOCCUS_TOPOLOGY"
...
class Child:
    ...
    def notes(self) -> str:
        return (
            f"{self.source_label} applies PYROCOCCUS / STAPHYLOTHERMUS medium "
...
CHILDREN = (
    Child(
        Path("archaea/pyrococcus_st04_medium.yaml"),
        "CultureMech:001480",
        "pyrococcus_st04_medium",
        "mediadive.medium:377b",
        "MediaDive Medium 377b",
        6.8,
    ),
    Child(
        Path("bacterial/for_dsm_19918.yaml"),
        "CultureMech:005112",
        "for_dsm_19918",
        "komodo.medium:377.1",
        "DSM 19918",
    ...
    Child(
        Path("bacterial/medium_377_modified_for_dsm_12428.yaml"),
        "CultureMech:005109",
        "medium_377_modified_for_dsm_12428",
        "komodo.medium:377_12428",
        "DSM 12428",
        6.8,
    ),
    Child(
        Path("bacterial/medium_377_modified_for_dsm_13482.yaml"),
        "CultureMech:005110",
        "medium_377_modified_for_dsm_13482",
        "komodo.medium:377_13482",
        "DSM 13482",
        6.8,
    ),
    Child(
        Path("bacterial/medium_377_modified_for_dsm_15127.yaml"),
        "CultureMech:005111",
        "medium_377_modified_for_dsm_15127",
        "komodo.medium:377_15127",
        "DSM 15127",
        6.8,
    ),
)
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Promoted KOMODO Medium 377 to the Pyrococcus family parent",
            "source": "KOMODO Medium 377-377.1, 377 DSM modifiers, and MediaDive Medium 377b",
            "notes": (
                "Moved the family root from strain-specific KOMODO Medium 377.1 "
                "to base KOMODO Medium 377 and reclassified exact-formula "
                "records with pH shifts as pH variants."
            ),
        },
    )
    return repaired
...
def repair_child(doc: dict[str, Any], child: Child) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Linked under KOMODO Medium 377",
