#!/usr/bin/env python3
"""Repair KOMODO 1321.1 topology rooted at a strain-specific duplicate."""
...
PARENT = Path("bacterial/KOMODO_1321_ACIDIHALOBACTER_medium.yaml")
PARENT_ID = "CultureMech:004077"
PARENT_NAME = "acidihalobacter_medium"
PARENT_SOURCE_TERM = "komodo.medium:1321"

CHILD = Path("bacterial/for_dsm_14174.yaml")
CHILD_ID = "CultureMech:004076"
CHILD_NAME = "for_dsm_14174"
CHILD_SOURCE_TERM = "komodo.medium:1321.1"
RELATIONSHIP = "STRAIN_SPECIFIC_VARIANT"
CHILD_NOTES = "KOMODO Medium 1321.1 applies ACIDIHALOBACTER medium to DSM 14174."

PH = 1.7
INGREDIENT_SIGNATURE = (
    ("NaCl", "16.6667", "G_PER_L"),
    ("(NH4)2SO4", "0.222222", "G_PER_L"),
    ("MgSO4 x 7 H2O", "0.444444", "G_PER_L"),
    ("K2HPO4", "0.111111", "G_PER_L"),
    ("FeSO4 x 7 H2O", "139", "G_PER_L"),
    ("K2S4O6", "30", "G_PER_L"),
    ("Yeast extract", "10", "G_PER_L"),
    ("H2SO4", "variable", "VARIABLE"),
)

CURATOR = "repair_komodo_1321_acidihalobacter_score10.py"
ACTION = "RESOLVED_KOMODO_1321_ACIDIHALOBACTER_TOPOLOGY"
...
def _parent_ref() -> dict[str, str]:
    return {
        ...
        "id": PARENT_ID,
        "name": PARENT_NAME,
        "notes": "KOMODO Medium 1321 is the ACIDIHALOBACTER base for Medium 1321.1.",
    }
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Promoted KOMODO Medium 1321 to the Acidihalobacter parent",
            "source": "KOMODO Medium 1321 and KOMODO Medium 1321.1",
            "notes": (
                "Linked the strain-specific KOMODO Medium 1321.1 record under "
                "the KOMODO Medium 1321 ACIDIHALOBACTER base."
            ),
        },
    )
    return repaired
...
def repair_child(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Linked under KOMODO Medium 1321",
            "source": "KOMODO Medium 1321.1",
            "notes": CHILD_NOTES,
        },
    )
    return repaired
