#!/usr/bin/env python3
"""Repair TOGO M1541 Marine Cytophaga Agar."""
...
TARGET = Path("bacterial/marine_cytophaga_agar.yaml")
EXPECTED_ID = "CultureMech:008089"
EXPECTED_MEDIA_TERM = "TOGO:M1541"
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_togo_m1541_marine_cytophaga_score15.py"
ACTION = "RESOLVED_TOGO_M1541_MARINE_CYTOPHAGA_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

TOGO_M1541 = "https://togomedium.org/medium/M1541"
NBRC_333 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=333"

SOURCE = "TOGO M1541 / NBRC Medium 333"
TITLE = "Marine Cytophaga Agar"
...
REFERENCES = (TOGO_M1541, NBRC_333)
...
NOTES = (
    "TOGO M1541 imports NBRC Medium 333 as Marine Cytophaga Agar. NBRC 333 "
    "lists 2 g Bacto Tryptone (Difco), 0.5 g beef extract, 0.5 g yeast "
    "extract, 0.2 g sodium acetate, optional 15 g agar, and 1 L filtered aged "
    "seawater or artificial seawater at pH 7.2-7.4. The source footnotes "
    "Daigo's Artificial Seawater SP as an artificial seawater option but does "
    "not state sterilization, incubation temperature, or other preparation steps."
)
...
def _append_curation_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            f"{NOTES} Corrected the migrated Seawater* solution from 1 g/L "
            "to a 1 L medium component, added the NBRC pH range, and marked "
            "the NBRC formula as curated."
        ),
    }
