#!/usr/bin/env python3
"""Repair DSMZ Medium 438 Bordet-Gengou Medium and its KOMODO duplicate."""
...
CURATOR = "repair_dsmz_438_bordet_score15.py"
ACTION = "RESOLVED_DSMZ_438_BORDET_SCORE15"
TIMESTAMP = "2026-09-11T00:00:00-07:00"

DSMZ_438 = "https://www.dsmz.de/microorganisms/medium/pdf/DSMZ_Medium438.pdf"
SOURCE = "DSMZ Medium 438"

Component = tuple[str, str, str]

IMPORTED_INGREDIENT_SIGNATURE: tuple[Component, ...] = (
    ("Bordet-Gengou-Agar-Base", "1000", "G_PER_L"),
    ("Horse blood", "150", "G_PER_L"),
    ("Peptone", "5", "G_PER_L"),
...
TARGETS: tuple[Target, ...] = (
    Target(
        path="bacterial/bordet_gengou_medium_difco.yaml",
        expected_id="CultureMech:001546",
        expected_source_term="mediadive.medium:438",
    ),
    Target(
        path="bacterial/KOMODO_438_BORDET-GENGOU-MEDIUM_DIFCO.yaml",
        expected_id="CultureMech:005286",
        expected_source_term="komodo.medium:438",
    ),
)
...
INGREDIENTS: tuple[dict[str, Any], ...] = (
    _component(
        ...
        "ML_PER_L",
        notes=(
            "DSMZ Medium 438 lists Bordet-Gengou-Agar-Base but does not spell out "
            "the commercial agar base composition."
        ),
    ),
    _component(
        "Horse blood",
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    _step(
        1,
        "MIX",
        "Supplement Bordet-Gengou-Agar-Base with 15% horse blood.",
    ),
)

NOTES = (
    "DSMZ Medium 438 specifies Bordet-Gengou-Agar-Base supplemented with 15% "
    "horse blood; the source does not spell out the commercial agar base "
    "composition."
)
...
def _ensure_references(doc: dict[str, Any]) -> None:
    ...
    if DSMZ_438 not in existing:
        references.append({"reference": DSMZ_438})
