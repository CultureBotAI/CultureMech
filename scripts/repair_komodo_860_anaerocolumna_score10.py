#!/usr/bin/env python3
"""Repair KOMODO 860 Anaerocolumna exact and strain child links."""
...
PARENT = Path("bacterial/anaerocolumna_medium.yaml")
PARENT_ID = "CultureMech:002019"
PARENT_NAME = "anaerocolumna_medium"
PARENT_SOURCE_TERM = "mediadive.medium:860"
SOURCE_DUPLICATE_RELATIONSHIP = "SOURCE_DUPLICATE"
STRAIN_RELATIONSHIP = "STRAIN_SPECIFIC_VARIANT"

SIGNATURE = (
    ("NH4Cl", "0.998004", "G_PER_L"),
    ("K2HPO4", "0.299401", "G_PER_L"),
    ("KH2PO4", "0.299401", "G_PER_L"),
    ("MgCl2 x 6 H2O", "0.199601", "G_PER_L"),
    ("CaCl2 x 2 H2O", "0.0998004", "G_PER_L"),
    ("KCl", "0.0998004", "G_PER_L"),
    ("NaCl", "0.598802", "G_PER_L"),
    ("Yeast extract", "0.998004", "G_PER_L"),
    ("Sodium resazurin", "0.000499002", "G_PER_L"),
    ("Na2CO3", "1.49701", "G_PER_L"),
    ("D-Fructose", "3.99202", "G_PER_L"),
    ("L-Cysteine HCl x H2O", "0.499002", "G_PER_L"),
...
CHILDREN = (
    Child(
        Path("bacterial/hesp1_sr1_tmc4_lup_medium.yaml"),
        "CultureMech:006687",
        "komodo.medium:860",
        "KOMODO Medium 860",
        SOURCE_DUPLICATE_RELATIONSHIP,
        "KOMODO Medium 860 has the same 22-ingredient signature as DSMZ Medium 860.",
    ),
    Child(
        Path("bacterial/for_dsm_12503.yaml"),
        "CultureMech:006681",
        "komodo.medium:860.1",
        "KOMODO Medium 860.1",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 860.1 applies Anaerocolumna medium to DSM 12503.",
    ),
    Child(
        Path("bacterial/for_dsm_12504.yaml"),
        "CultureMech:006682",
        "komodo.medium:860.2",
        "KOMODO Medium 860.2",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 860.2 applies Anaerocolumna medium to DSM 12504.",
    ),
    Child(
        Path("bacterial/for_dsm_12505.yaml"),
        "CultureMech:006683",
        "komodo.medium:860.3",
        "KOMODO Medium 860.3",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 860.3 applies Anaerocolumna medium to DSM 12505.",
    ),
    Child(
        Path("bacterial/for_dsm_13105.yaml"),
        "CultureMech:006684",
        "komodo.medium:860.4",
        "KOMODO Medium 860.4",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 860.4 applies Anaerocolumna medium to DSM 13105.",
    ),
    Child(
        Path("bacterial/for_dsm_13106_and_dsm_23801.yaml"),
        "CultureMech:006685",
        "komodo.medium:860.5",
        "KOMODO Medium 860.5",
        STRAIN_RELATIONSHIP,
    ...
    Child(
        ...
        "KOMODO Medium 860.6",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 860.6 applies Anaerocolumna medium to DSM 13116.",
    ),
)
CHILD_BY_PATH = {child.path: child for child in CHILDREN}
EXPECTED_CHILD_COUNT = 7

CURATOR = "repair_komodo_860_anaerocolumna_score10.py"
ACTION = "RESOLVED_KOMODO_860_ANAEROCOLUMNA_TOPOLOGY"
...
def repair_child(relative_path: Path, doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": f"Linked under DSMZ Medium 860 as {child.relationship}",
