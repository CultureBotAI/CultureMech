#!/usr/bin/env python3
"""Repair KOMODO 897.1 topology rooted at a strain-specific duplicate."""
...
PARENT = Path("archaea/KOMODO_897_IGNICOCCUS_medium.yaml")
PARENT_ID = "CultureMech:006753"
PARENT_NAME = "ignicoccus_medium"
PARENT_SOURCE_TERM = "komodo.medium:897"

CHILD = Path("bacterial/for_dsm_18386.yaml")
CHILD_ID = "CultureMech:006752"
CHILD_NAME = "for_dsm_18386"
CHILD_SOURCE_TERM = "komodo.medium:897.1"
RELATIONSHIP = "STRAIN_SPECIFIC_VARIANT"
CHILD_NOTES = "KOMODO Medium 897.1 applies IGNICOCCUS medium to DSM 18386."

PH = 5.5
INGREDIENT_SIGNATURE = (
    ("NaCl", "13.5417", "G_PER_L"),
    ("MgSO4 x 7 H2O", "3.47222", "G_PER_L"),
    ("MgCl2 x 6 H2O", "2.72817", "G_PER_L"),
    ("KH2PO4", "0.496032", "G_PER_L"),
    ("(NH4)2SO4", "0.248016", "G_PER_L"),
    ("CaCl2 x 2 H2O", "0.376984", "G_PER_L"),
    ("KCl", "0.327381", "G_PER_L"),
    ("NaBr", "0.0496032", "G_PER_L"),
    ("H3BO3", "0.014881", "G_PER_L"),
    ("SrCl2 x 6 H2O", "0.00694444", "G_PER_L"),
    ("KI", "4.96032e-05", "G_PER_L"),
    ("Sodium resazurin", "0.000496032", "G_PER_L"),
    ("Sulfur", "4.96032", "G_PER_L"),
    ("Meat extract", "0.992063", "G_PER_L"),
    ("Na2S x 9 H2O", "0.198413", "G_PER_L"),
    ("H2SO4", "variable", "VARIABLE"),
)

CURATOR = "repair_komodo_897_ignicoccus_score10.py"
ACTION = "RESOLVED_KOMODO_897_IGNICOCCUS_TOPOLOGY"
...
def _parent_ref() -> dict[str, str]:
    return {
        ...
        "id": PARENT_ID,
        "name": PARENT_NAME,
        "notes": "KOMODO Medium 897 is the IGNICOCCUS base for Medium 897.1.",
    }
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Promoted KOMODO Medium 897 to the Ignicoccus parent",
            "source": "KOMODO Medium 897 and KOMODO Medium 897.1",
            "notes": (
                "Linked the strain-specific KOMODO Medium 897.1 record under "
                "the KOMODO Medium 897 IGNICOCCUS base."
            ),
        },
    )
    return repaired
...
def repair_child(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Linked under KOMODO Medium 897",
            "source": "KOMODO Medium 897.1",
            "notes": CHILD_NOTES,
        },
    )
    return repaired
