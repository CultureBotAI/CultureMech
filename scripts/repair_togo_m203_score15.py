#!/usr/bin/env python3
"""Repair TOGO M203 Modified Medium 10."""
...
TARGET = Path("bacterial/TOGO_M203_Modified_Medium_10.yaml")
EXPECTED_ID = "CultureMech:008629"
EXPECTED_MEDIA_TERM = "TOGO:M203"
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_togo_m203_score15.py"
ACTION = "RESOLVED_TOGO_M203_SCORE15"
TIMESTAMP = "2026-09-11T00:00:00-07:00"

TOGO_M203 = "https://togomedium.org/medium/M203"
TOGO_M124 = "https://togomedium.org/medium/M124"
JCM_210 = "https://www.jcm.riken.jp/cgi-bin/jcm/jcm_grmd?GRMD=210"
JCM_133 = "https://www.jcm.riken.jp/cgi-bin/jcm/jcm_grmd?GRMD=133"

SOURCE = "TOGO M203 / JCM Medium 210"
M124_SOURCE = "TOGO M124 / JCM Medium 133"
TITLE = "Modified Medium 10"
...
HEMIN_SIGNATURE: tuple[Component, ...] = (("Hemin", "1.0", "PERCENT_W_V"),)
...
FINAL_SOLUTION_SIGNATURES: tuple[SolutionSignature, ...] = (
    ...
    ("1.0% Hemin solution", "1.0", "ML_PER_L", HEMIN_SIGNATURE),
...
REFERENCES = (TOGO_M203, JCM_210, TOGO_M124, JCM_133)
...
SOLUTIONS: tuple[dict[str, Any], ...] = (
    ...
    _stock(
        ...
        _component(
            ...
            "1.0",
            "PERCENT_W_V",
            notes=f"{SOURCE} identifies the growth-factor stock as 1.0% Hemin.",
        ),
    ),
    _stock(
        "4% Na2SO3 solution",
...
NOTES = (
    "TOGO M203 preserves JCM Medium 210 as Modified Medium 10. TOGO M203 "
    "records 850 ml distilled water, 0.5 g each of cellobiose, glucose, "
    "soluble starch, and Yeast extract from BD-Difco, 18 g agar, 2 g "
    "Trypticase peptone from BD-BBL, 0.5 ml 0.1% Resazurin solution, "
    "1 ml 1.0% Hemin solution, 100 ml 4% Na2SO3 solution, 2 ml 25% "
    "L-Ascorbic acid solution, 10 ml 5% L-Cysteine HCl H2O solution, "
    "and VFA and salt stocks from Medium 10 / TOGO M124, with pH "
    "adjusted to 6.7-6.8. It uses Medium 10 from JCM Medium 133 with "
    "1 ml/L final 1% hemin solution and omits Toray silicone solution. "
    "The current JCM Medium 210 URL no longer exposes the recipe."
)
