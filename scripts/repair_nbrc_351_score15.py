#!/usr/bin/env python3
"""Repair the score-15 NBRC Medium 351 TOGO import."""
...
TARGET = Path("bacterial/togo_medium_m1552.yaml")
PARENT = Path("bacterial/TOGO_M1553_Methylobacterium_Medium.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

EXPECTED_ID = "CultureMech:008101"
EXPECTED_PARENT_ID = "CultureMech:008102"
EXPECTED_MEDIA_TERM = "TOGO:M1552"
EXPECTED_PARENT_MEDIA_TERM = "TOGO:M1553"

CURATOR = "repair_nbrc_351_score15.py"
ACTION = "RESOLVED_NBRC_351_SCORE15"
LINK_ACTION = "LINKED_NBRC_351_METHYLOBACTERIUM_VARIANT"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

TOGO_M1552 = "https://togomedium.org/medium/M1552"
NBRC_351 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=351"
SOURCE = "NBRC Medium 351"

HIPOLYPEPTON = "Hipolypepton*"
YEAST_EXTRACT = "Yeast extract"
N_ACETYLGLUCOSAMINE = "N-Acetyl glucosamine**"
...
LEGACY_SOLUTIONS: tuple[SolutionSignature, ...] = (
    (N_ACETYLGLUCOSAMINE, "30", "G_PER_L", ()),
...
FINAL_INGREDIENTS: tuple[Component, ...] = (
    (HIPOLYPEPTON, "10", "G_PER_L"),
    (YEAST_EXTRACT, "2", "G_PER_L"),
    (N_ACETYLGLUCOSAMINE, "30", "MG_PER_L"),
    (MAGNESIUM_SULFATE, "1", "G_PER_L"),
    (AGAR_IF_NEEDED, "15", "G_PER_L"),
...
GROUNDINGS: dict[str, tuple[str, str]] = {
    ...
    N_ACETYLGLUCOSAMINE: ("CHEBI:59640", "N-Acetylglucosamine"),
...
REFERENCES = (TOGO_M1552, NBRC_351)

VARIANT_MODIFICATIONS = (
    "Substitutes 30 mg/L separately filter-sterilized N-Acetyl glucosamine "
    "for the 5 ml/L methanol supplement in TOGO M1553.",
)
VARIANT_NOTES = (
    "Substitutes 30 mg/L separately filter-sterilized N-Acetyl glucosamine for methanol."
)
PARENT_MEDIA = {
...
RECIPE_NOTES = (
    "TOGO M1552 imports NBRC Medium 351, which lists 10 g/L Hipolypepton "
    "from Wako Pure Chemical Industries, 2 g/L Yeast extract, 30 mg/L "
    "N-Acetyl glucosamine, 1 g/L MgSO4·7H2O, 15 g/L Agar if needed, "
    "and 1 L Distilled water at pH 7.0. The N-Acetyl glucosamine is "
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "description": (
            ...
            "1 g/L MgSO4·7H2O, and 1 L Distilled water."
        ),
    },
    {
        "step_number": 2,
        "action": "MIX",
        "description": "Add 15 g/L agar when solid NBRC Medium 351 is needed.",
    },
    {
        "step_number": 3,
        "action": "FILTER_STERILIZE",
        "description": "Sterilize N-Acetyl glucosamine separately by filtration.",
    },
    {
        "step_number": 4,
        "action": "MIX",
        "description": "Add 30 mg/L filter-sterilized N-Acetyl glucosamine.",
    },
    {
        "step_number": 5,
        "action": "ADJUST_PH",
...
def _notes(preferred_term: str, value: str, unit: str) -> str:
    ...
    if preferred_term == N_ACETYLGLUCOSAMINE:
        return (
            f"{SOURCE} lists {value} {UNIT_LABELS[unit]} N-Acetyl "
            "glucosamine, sterilized separately by filtration."
        )
...
def repair_target(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _append_curation_event(
        ...
        action=ACTION,
        notes=(
            "Curated TOGO:M1552 from TOGO and NBRC Medium 351; corrected "
            "Distilled water from a mass-like 1 g/L import to 1 L, moved "
            "Hipolypepton and N-Acetyl glucosamine from migrated empty "
            "solutions to sourced formula ingredients, corrected N-Acetyl "
            "glucosamine from 30 g/L to 30 mg/L, added pH 7.0, grounded "
            "yeast extract, N-Acetylglucosamine, magnesium sulfate "
            "heptahydrate, water, and agar, retained Hipolypepton as a "
            "sourced opaque component, and linked M1552 to M1553 as a "
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _append_curation_event(
        ...
        action=LINK_ACTION,
        notes=(
            "Linked NBRC Medium 351 as a substituted-component Methylobacterium Medium variant."
        ),
    )
    return repaired
