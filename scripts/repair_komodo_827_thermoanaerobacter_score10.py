#!/usr/bin/env python3
"""Repair KOMODO 827 Thermoanaerobacter exact and strain child links."""
...
PARENT = Path("bacterial/thermoanaerobacter_sulfurophilus_medium.yaml")
PARENT_ID = "CultureMech:001976"
PARENT_NAME = "thermoanaerobacter_sulfurophilus_medium"
PARENT_SOURCE_TERM = "mediadive.medium:827"
...
CHILDREN = (
    Child(
        Path("bacterial/KOMODO_827_THERMOANAEROBACTER_SULFUROPHILUS_medium.yaml"),
        "CultureMech:006558",
        "komodo.medium:827",
        "KOMODO Medium 827",
        SOURCE_DUPLICATE_RELATIONSHIP,
        "KOMODO Medium 827 has the same 30-ingredient signature as DSMZ Medium 827.",
    ),
    Child(
        Path("bacterial/for_dsm_16547.yaml"),
        "CultureMech:006557",
        "komodo.medium:827.1",
        "KOMODO Medium 827.1",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 827.1 applies DSMZ Medium 827 to DSM 16547.",
    ),
)
CHILD_BY_PATH = {child.path: child for child in CHILDREN}
EXPECTED_CHILD_COUNT = 2

CURATOR = "repair_komodo_827_thermoanaerobacter_score10.py"
ACTION = "RESOLVED_KOMODO_827_THERMOANAEROBACTER_TOPOLOGY"
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Re-rooted KOMODO Medium 827 Thermoanaerobacter exact topology",
            "source": "DSMZ Medium 827; KOMODO Medium 827 and 827.1",
            "notes": (
                "Moved exact KOMODO Medium 827 plus its DSM 16547 wrapper " "under DSMZ Medium 827."
            ),
        },
    )
    return repaired
...
def repair_child(relative_path: Path, doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": f"Linked under DSMZ Medium 827 as {child.relationship}",
