#!/usr/bin/env python3
"""Repair empty KOMODO 724 DESULFOMICROBIUM WHB MEDIUM."""
...
TARGET = "bacterial/desulfomicrobium_whb_medium.yaml"
EXPECTED_ID = "CultureMech:006367"
EXPECTED_MEDIA_TERM = "komodo.medium:724"
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

KOMODO_724_URL = (
    "https://komodo.modelseed.org/servlet/" "KomodoTomcatServerSideUtilitiesModelSeed?MediaInfo=724"
)
DSMZ_724_URL = (
    "https://web.archive.org/web/20121030082653id_/"
    "http://www.dsmz.de/microorganisms/medium/pdf/DSMZ_Medium724.pdf"
)
DSMZ_195_URL = (
    "https://web.archive.org/web/20121030082653id_/"
...
SOURCE_724 = "Archived DSMZ Medium 724"
...
CURATOR = "repair_komodo_724_score35.py"
ACTION = "RESOLVED_KOMODO_724_SCORE35"
TIMESTAMP = "2026-09-10T00:00:00-07:00"
NOTES = (
    "Archived DSMZ Medium 724 defines DESULFOMICROBIUM WHB MEDIUM as DSMZ "
    "Medium 195 with 4 g/L sodium lactate as the substrate, 1 mL/L DSMZ "
    "Medium 385 selenite/tungstate solution, and 1 mL/L DSMZ Medium 503 "
    "Seven Vitamins Solution; DSMZ Medium 195 derives from DSMZ Medium 193 "
    "with elevated NaCl and MgCl2 x 6 H2O, so this record expands archived "
    "DSMZ Media 193, 195, 320, 141, 385, and 503 into final per-liter "
    "components."
)
...
def _medium_503_note(name: str, stock_amount: str, value: str) -> str:
    return (
        f"{SOURCE_724} uses 1 mL/L of the {SOURCE_503}; the Seven Vitamins "
...
def _selenite_tungstate_note(name: str, stock_amount: str, value: str) -> str:
    return (
        f"{SOURCE_724} adds 1 mL/L of the {SOURCE_385}; the stock contains "
...
COMPONENTS: tuple[Component, ...] = (
    ...
    Component(
        ...
        SOURCE_724,
        f"{SOURCE_724} specifies 4 g/L sodium lactate as the substrate.",
    ),
    Component(
        "Biotin",
        "0.0000199",
    ...
    Component(
        ...
        ("CHEBI:31345", "Calcium pantothenate"),
        SOURCE_503,
        _medium_503_note("Calcium pantothenate", "0.100 g/L", "0.0000997"),
    ),
    Component(
        "Vitamin B12",
        "0.000101",
    ...
    Component(
        ...
        (
            ...
            f"{SOURCE_724} supplies sodium lactate as the substrate."
        ),
    ),
)
...
def _ensure_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "curator": CURATOR,
        "action": ACTION,
        "changes": "Replaced empty KOMODO 724 composition with archived DSMZ data",
        "source": DSMZ_724_URL,
        "notes": NOTES,
    }
