#!/usr/bin/env python3
"""Repair the recovered NBRC Medium 1286 biphenyl LB record."""
...
CURATOR = "repair_nbrc_1287_score15.py"
ACTION = "RESOLVED_NBRC_1287_SCORE15"
TIMESTAMP = "2026-09-11T00:00:00-07:00"

TARGET_PATH = "bacterial/NBRC_1287.yaml"
TARGET_ID = "CultureMech:007469"
REQUIRED_ACTION = "Recovered composition from source HTML"

SOURCE = "NBRC Medium 1286"
NBRC_URL = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=1286"
TITLE = "1/3 Diluted LB Medium with Biphenyl"

Component = tuple[str, str, str]

IMPORTED_INGREDIENT_SIGNATURE: tuple[Component, ...] = (
    ("Bacto tryptone", "3.3", "G_PER_L"),
    ("Yeast extract", "1.6", "G_PER_L"),
    ("NaCl", "3.3", "G_PER_L"),
    ("Distilled water", "1", "L"),
    ("Agar", "15", "G_PER_L"),
)
...
GROUNDINGS: dict[str, tuple[str, str]] = {
    ...
    "Biphenyl crystal": ("CHEBI:17097", "biphenyl"),
...
INGREDIENTS: tuple[dict[str, Any], ...] = (
    _component(
        ...
        "3.3",
        "G_PER_L",
        notes="NBRC Medium 1286 lists 3.3 g Bacto tryptone.",
    ),
    _component(
        "Yeast extract",
        "1.6",
        "G_PER_L",
        notes="NBRC Medium 1286 lists 1.6 g yeast extract.",
    ),
    _component(
        "NaCl",
        "3.3",
        "G_PER_L",
        notes="NBRC Medium 1286 lists 3.3 g NaCl.",
    ),
    _component(
        "Distilled water",
        "1",
        "L",
        notes="NBRC Medium 1286 lists 1 L distilled water.",
    ),
    _component(
        "Agar",
        "15",
        "G_PER_L",
        notes="NBRC Medium 1286 lists 15 g agar.",
    ),
    _component(
        "Biphenyl crystal",
        "variable",
...
NOTES = (
    "Source: NBRC Medium 1286 | Link: "
    "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=1286\n\n"
    "NBRC lists 1/3 Diluted LB Medium with Biphenyl at pH 7.0, made from "
    "Bacto tryptone, yeast extract, NaCl, distilled water, and agar. Biphenyl "
    "crystal is supplied on a petri-dish lid as a vapor phase."
)
...
def _ensure_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "curator": CURATOR,
        "action": ACTION,
        "changes": "Curated NBRC Medium 1286 identity, pH, and biphenyl",
        "source": NBRC_URL,
        "notes": (
            "Added the NBRC Medium 1286 source term and official title, "
            "grounded the LB and agar formula, recorded pH 7.0, and represented "
            "the vapor-phase biphenyl crystal as a variable component."
        ),
    }
...
def repair_document(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _put_after(
        ...
        "media_term",
        {
            ...
            "term": _term("nbrc.medium:1286", SOURCE),
        },
        "physical_state",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(f"{action} {changed_count} NBRC 1287 records")
    return 0
