#!/usr/bin/env python3
"""Repair KOMODO 2056 Trace element solution (medium 925)."""
...
TARGET = Path("bacterial/trace_element_solution_medium_925.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_komodo_2056_score15.py"
ACTION = "RESOLVED_KOMODO_2056_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

EXPECTED_ID = "CultureMech:004329"
EXPECTED_MEDIA_TERM = "komodo.medium:2056"
KOMODO_2056 = (
    "https://komodo.modelseed.org/servlet/KomodoTomcatServerSideUtilitiesModelSeed?MediaInfo=2056"
)
SOURCE = "KOMODO Medium 2056"
...
NOTES = (
    "KOMODO 2056 lists Trace element solution (medium 925) as a defined "
    "submedium at pH 3.0. Its metabolite table contains 0.30 g/L H3BO3, "
    "0.20 g/L CoCl2 x 6 H2O, 0.10 g/L ZnSO4 x 7 H2O, "
    "0.03 g/L MnCl2 x 4 H2O, 0.03 g/L Na2MoO4 x 2 H2O, "
    "0.02 g/L NiCl2 x 6 H2O, 0.01 g/L CuCl2 x 2 H2O, "
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "description": (
            ...
            "and the cobalt, nickel, zinc, manganese, iron, copper, borate, and "
            "molybdate salts listed by KOMODO 2056."
        ),
    },
    {
        "step_number": 2,
...
def _component(preferred_term: str, value: str, unit: str) -> dict[str, Any]:
    ...
    if preferred_term == "H2O":
        row["notes"] = (
            ...
            "the solvent for 1 L of Trace element solution (medium 925)."
        )
...
def _ensure_references(doc: dict[str, Any]) -> None:
    ...
    if not any(row.get("reference") == KOMODO_2056 for row in references if isinstance(row, dict)):
        references.append({"reference": KOMODO_2056})
...
def _append_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            ...
            "2056 metabolite table; preserved HCl as a variable listed "
