#!/usr/bin/env python3
"""Repair KOMODO 866 Desulfofalx exact and strain child links."""
...
PARENT = Path("bacterial/desulfofalx_medium.yaml")
PARENT_ID = "CultureMech:002024"
PARENT_NAME = "desulfofalx_medium"
PARENT_SOURCE_TERM = "mediadive.medium:866"
...
SIGNATURE = (
    ...
    ("NaCl", "4.99002", "G_PER_L"),
    ("Yeast extract", "1.49701", "G_PER_L"),
    ("Sodium resazurin", "0.000499002", "G_PER_L"),
    ("Na2CO3", "0.499002", "G_PER_L"),
    ("NaHCO3", "7.98403", "G_PER_L"),
    ("Na-formate", "4.99002", "G_PER_L"),
...
CHILDREN = (
    Child(
        Path("bacterial/desulfotomaculum_alkaliphilum_medium.yaml"),
        "CultureMech:006696",
        "komodo.medium:866",
        "KOMODO Medium 866",
        SOURCE_DUPLICATE_RELATIONSHIP,
        "KOMODO Medium 866 has the same 31-ingredient signature as DSMZ Medium 866.",
    ),
    Child(
        Path("bacterial/for_dsm_16529.yaml"),
        "CultureMech:006695",
        "komodo.medium:866.1",
        "KOMODO Medium 866.1",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 866.1 applies DSMZ Medium 866 to DSM 16529.",
    ),
)
CHILD_BY_PATH = {child.path: child for child in CHILDREN}
EXPECTED_CHILD_COUNT = 2

CURATOR = "repair_komodo_866_desulfofalx_score10.py"
ACTION = "RESOLVED_KOMODO_866_DESULFOFALX_TOPOLOGY"
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Re-rooted KOMODO Medium 866 Desulfofalx exact topology",
            "source": "DSMZ Medium 866; KOMODO Medium 866 and 866.1",
            "notes": (
                "Moved exact KOMODO Medium 866 plus its DSM 16529 wrapper " "under DSMZ Medium 866."
            ),
        },
    )
    return repaired
...
def repair_child(relative_path: Path, doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": f"Linked under DSMZ Medium 866 as {child.relationship}",
