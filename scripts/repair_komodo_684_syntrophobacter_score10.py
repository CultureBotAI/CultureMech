#!/usr/bin/env python3
"""Repair KOMODO 684 Syntrophobacter exact and strain child links."""
...
PARENT = Path("bacterial/syntrophobacter_mpob_medium.yaml")
PARENT_ID = "CultureMech:001821"
PARENT_NAME = "syntrophobacter_mpob_medium"
PARENT_SOURCE_TERM = "mediadive.medium:684"
SOURCE_DUPLICATE_RELATIONSHIP = "SOURCE_DUPLICATE"
STRAIN_RELATIONSHIP = "STRAIN_SPECIFIC_VARIANT"

SIGNATURE = (
    ("Na2HPO4 x 2 H2O", "0.528415", "G_PER_L"),
    ("KH2PO4", "0.408774", "G_PER_L"),
    ("NH4Cl", "0.299103", "G_PER_L"),
    ("CaCl2 x 2 H2O", "0.109671", "G_PER_L"),
    ("MgCl2 x 6 H2O", "0.0997009", "G_PER_L"),
    ("NaCl", "0.299103", "G_PER_L"),
    ("Yeast extract", "0.199402", "G_PER_L"),
    ("Sodium resazurin", "0.000498504", "G_PER_L"),
    ("Na2CO3", "1.49551", "G_PER_L"),
    ("Na2-fumarate", "3.19043", "G_PER_L"),
...
CHILDREN = (
    Child(
        Path("bacterial/KOMODO_684_MPOB_medium.yaml"),
        "CultureMech:006289",
        "komodo.medium:684",
        "KOMODO Medium 684",
        SOURCE_DUPLICATE_RELATIONSHIP,
        "KOMODO Medium 684 has the same 33-ingredient signature as DSMZ Medium 684.",
    ),
    Child(
        Path("bacterial/for_dsm_14823.yaml"),
        "CultureMech:006286",
        "komodo.medium:684.1",
        "KOMODO Medium 684.1",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 684.1 applies DSMZ Medium 684 to DSM 14823.",
    ),
    Child(
        Path("bacterial/for_dsm_17232.yaml"),
        "CultureMech:006288",
        "komodo.medium:684.2",
        "KOMODO Medium 684.2",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 684.2 applies DSMZ Medium 684 to DSM 17232.",
    ),
    Child(
        Path("bacterial/medium_684_modified_for_dsm_14055.yaml"),
        "CultureMech:006285",
        "komodo.medium:684_14055",
        "KOMODO Medium 684_14055",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 684_14055 applies DSMZ Medium 684 to DSM 14055.",
    ),
    Child(
        Path("bacterial/medium_684_modified_for_dsm_23957.yaml"),
        "CultureMech:006287",
        "komodo.medium:684_23957",
        "KOMODO Medium 684_23957",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 684_23957 applies DSMZ Medium 684 to DSM 23957.",
    ),
)
CHILD_BY_PATH = {child.path: child for child in CHILDREN}
EXPECTED_CHILD_COUNT = 5

CURATOR = "repair_komodo_684_syntrophobacter_score10.py"
ACTION = "RESOLVED_KOMODO_684_SYNTROPHOBACTER_TOPOLOGY"
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Re-rooted KOMODO Medium 684 Syntrophobacter exact topology",
            "source": "DSMZ Medium 684; KOMODO Medium 684, 684.1, 684.2, 684_14055, 684_23957",
            "notes": (
                "Moved exact KOMODO Medium 684 plus its DSM-specific wrappers "
                "under DSMZ Medium 684."
            ),
        },
    )
    return repaired
...
def repair_child(relative_path: Path, doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": f"Linked under DSMZ Medium 684 as {child.relationship}",
