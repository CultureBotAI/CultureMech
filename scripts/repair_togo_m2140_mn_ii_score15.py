#!/usr/bin/env python3
"""Repair TOGO M2140 Mn(II) oxidation medium."""
...
TARGET = Path("bacterial/mn_ii_oxidation_medium.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

EXPECTED_ID = "CultureMech:008735"
EXPECTED_MEDIA_TERM = "TOGO:M2140"

CURATOR = "repair_togo_m2140_mn_ii_score15.py"
ACTION = "RESOLVED_TOGO_M2140_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

TOGO_M2140 = "https://togomedium.org/medium/M2140"
NBRC_1481 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=1481"
SOURCE = "TOGO M2140 / NBRC Medium 1481"
TITLE = "Mn(II) oxidation medium"
MNCL2_HYDRATE = "MnCl2\u00b74H2O"
PH_VALUE = 7.0
...
FINAL_INGREDIENT_SIGNATURE: tuple[Component, ...] = (
    ...
    ("Yeast extract", "0.5", "G_PER_L"),
    (MNCL2_HYDRATE, "36.0", "MG_PER_L"),
    ("Agar (if needed)", "15.0", "G_PER_L"),
    ("Peptone", "1.0", "G_PER_L"),
)

REFERENCES = (TOGO_M2140, NBRC_1481)

GROUNDINGS: dict[str, tuple[str, str]] = {
    "Distilled water": ("CHEBI:15377", "water"),
    "Yeast extract": ("FOODON:03315426", "Yeast extract"),
    MNCL2_HYDRATE: ("CHEBI:86368", "manganese(II) chloride tetrahydrate"),
...
NOTES = (
    "TOGO M2140 imports NBRC Medium 1481 as Mn(II) oxidation medium. "
    "The NBRC formula lists 1 L distilled water, 0.5 g yeast extract, "
    "36 mg MnCl2 x 4H2O, 15 g agar if needed, 1 g peptone, and pH 7.0."
)
...
def _append_curation_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            f"{NOTES} Corrected the imported Distilled water and MnCl2 hydrate "
            "units, added the source pH, and grounded every ingredient."
        ),
    }
