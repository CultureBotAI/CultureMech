#!/usr/bin/env python3
"""Repair the empty KOMODO 279 Methanocorpusculum medium record."""
...
TARGET = "archaea/methanocorpusculum_medium.yaml"
...
CURATOR = "repair_komodo_279_score35.py"
ACTION = "RESOLVED_KOMODO_279_SCORE35"
TIMESTAMP = "2026-09-10T00:00:00-07:00"

NOTES = (
    "KOMODO MediaInfo 279 lists 27 quantified g/L components for "
    "METHANOCORPUSCULUM medium and also lists CO2, H2O, H2, distilled water, "
    "and NaOH without gram or mol amounts."
)

KOMODO_279_COMPONENTS: tuple[tuple[str, str | None, tuple[str, str] | None], ...] = (
    ...
    ("NiCl2 x 6 H2O", "0.02", ("CHEBI:53542", "nickel chloride hexahydrate")),
    ...
    ("Na-acetate", "4.99", ("CHEBI:32954", "sodium acetate")),
    ...
    ("NaCl", "0.40", ("CHEBI:26710", "sodium chloride")),
...
def _ensure_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "curator": CURATOR,
        "action": ACTION,
        "changes": "Replaced empty KOMODO 279 composition with live KOMODO MediaInfo data",
        "source": SOURCE_URL,
        "notes": NOTES,
    }
...
def repair_record(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    repaired["ingredients"] = [_ingredient(*component) for component in KOMODO_279_COMPONENTS]
