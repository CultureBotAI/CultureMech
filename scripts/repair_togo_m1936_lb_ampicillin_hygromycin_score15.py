...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "description": (
            "Sterilize the 50 mg/ml ampicillin and hygromycin B stocks " "separately by filtration."
        ),
    },
    {
        "step_number": 3,
    ...
    },
    {
        ...
        "composition": [
            _component(
                ...
                "50.0",
                "MG_PER_ML",
                notes=("NBRC Medium 1203 specifies this stock as 50 mg/ml " "Hygromycin B."),
            )
        ],
