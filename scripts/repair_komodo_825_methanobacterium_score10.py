#!/usr/bin/env python3
"""Repair KOMODO 825 Methanobacterium II strain child links."""
...
PARENT = Path("archaea/KOMODO_825_METHANOBACTERIUM_II_medium.yaml")
PARENT_ID = "CultureMech:006555"
PARENT_NAME = "methanobacterium_ii_medium"
PARENT_SOURCE_TERM = "komodo.medium:825"
SOURCE_DUPLICATE_RELATIONSHIP = "SOURCE_DUPLICATE"
STRAIN_RELATIONSHIP = "STRAIN_SPECIFIC_VARIANT"

INGREDIENT_SIGNATURE = (
    ("NH4Cl", "0.98912", "G_PER_L"),
    ("K2HPO4", "0.296736", "G_PER_L"),
    ("KH2PO4", "0.296736", "G_PER_L"),
    ("MgCl2 x 6 H2O", "0.197824", "G_PER_L"),
    ("CaCl2 x 2 H2O", "0.198912", "G_PER_L"),
    ("KCl", "0.098912", "G_PER_L"),
    ("NaCl", "1.593472", "G_PER_L"),
    ("Na-acetate", "0.49456", "G_PER_L"),
    ("Yeast extract", "0.98912", "G_PER_L"),
    ("Sodium resazurin", "0.00049456", "G_PER_L"),
    ("NaHCO3", "3.95648", "G_PER_L"),
    ("L-Cysteine HCl x H2O", "0.49456", "G_PER_L"),
    ("Na2S x 9 H2O", "0.49456", "G_PER_L"),
...
SOURCE_DUPLICATE = SourceDuplicate(
    Path("archaea/methanobacterium_ii_medium.yaml"),
    "CultureMech:001973",
    "mediadive.medium:825",
    "DSMZ Medium 825",
)

STRAIN_CHILDREN = (
    StrainChild(
        Path("bacterial/dsm_10131_and_dsm_10132.yaml"),
        "CultureMech:006552",
        "komodo.medium:825.1",
        "KOMODO Medium 825.1",
        "DSM 10131 and DSM 10132",
    ),
    StrainChild(
        Path("bacterial/dsm_10111.yaml"),
        "CultureMech:006553",
        "komodo.medium:825.2",
        "KOMODO Medium 825.2",
        "DSM 10111",
...
EXPECTED_STRAIN_CHILD_COUNT = 3

CURATOR = "repair_komodo_825_methanobacterium_score10.py"
ACTION = "RESOLVED_KOMODO_825_METHANOBACTERIUM_TOPOLOGY"
...
def _duplicate_notes() -> str:
    return (
        "DSMZ Medium 825 has the same 36-component Methanobacterium II "
        "signature as KOMODO Medium 825."
    )


def _strain_notes(child: StrainChild) -> str:
    return f"{child.source_label} applies METHANOBACTERIUM II medium to {child.target}."
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Resolved KOMODO Medium 825 strain wrappers",
            "source": "KOMODO Medium 825.1, 825.2, 825.3; DSMZ Medium 825",
            "notes": (
                "Kept KOMODO Medium 825 as the Methanobacterium II base and "
                "moved exact-signature DSMZ Medium 825 and DSM-specific KOMODO "
                "wrappers under it."
            ),
        },
    )
...
def repair_source_duplicate(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Linked under KOMODO Medium 825",
...
def repair_strain_child(relative_path: Path, doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Linked as a KOMODO Medium 825 strain-specific variant",
