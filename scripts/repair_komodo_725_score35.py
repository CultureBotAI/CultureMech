#!/usr/bin/env python3
"""Repair empty KOMODO 725 DESULFOVIBRIO SHV MEDIUM."""
...
TARGET = "bacterial/desulfovibrio_shv_medium.yaml"
EXPECTED_ID = "CultureMech:006368"
EXPECTED_MEDIA_TERM = "komodo.medium:725"
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

KOMODO_725_URL = (
    "https://komodo.modelseed.org/servlet/" "KomodoTomcatServerSideUtilitiesModelSeed?MediaInfo=725"
)
DSMZ_725_URL = (
    "https://web.archive.org/web/20121030082653id_/"
    "http://www.dsmz.de/microorganisms/medium/pdf/DSMZ_Medium725.pdf"
)
DSMZ_194_URL = (
    "https://web.archive.org/web/20121030082653id_/"
...
SOURCE_725 = "Archived DSMZ Medium 725"
...
CURATOR = "repair_komodo_725_score35.py"
ACTION = "RESOLVED_KOMODO_725_SCORE35"
TIMESTAMP = "2026-09-10T00:00:00-07:00"
NOTES = (
    "Archived DSMZ Medium 725 defines DESULFOVIBRIO SHV MEDIUM as DSMZ "
    "Medium 194 with 4 g/L sodium lactate as the substrate, 1 mL/L DSMZ "
    "Medium 385 selenite-tungstate solution, and 1 mL/L DSMZ Medium 503 "
    "Seven Vitamins Solution; this record expands archived DSMZ Media 193, "
    "194, 320, 141, 385, and 503 into final per-liter components."
)
...
def _medium_503_note(name: str, stock_amount: str, value: str) -> str:
    return (
        f"{SOURCE_725} uses 1 mL/L of the {SOURCE_503}; the Seven Vitamins "
...
def _selenite_tungstate_note(name: str, stock_amount: str, value: str) -> str:
    return (
        f"{SOURCE_725} adds 1 mL/L of the {SOURCE_385}; the stock contains "
...
COMPONENTS: tuple[Component, ...] = (
    ...
    Component(
        ...
        SOURCE_725,
        f"{SOURCE_725} replaces sodium propionate with 4 g/L sodium lactate.",
    ),
    Component(
        "Biotin",
        "0.0000199",
    ...
    Component(
        ...
        (
            ...
            f"solutions A, C, D, and F before {SOURCE_725} stock additions."
        ),
    ),
)
...
def _ensure_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "curator": CURATOR,
        "action": ACTION,
        "changes": "Replaced empty KOMODO 725 composition with archived DSMZ data",
        "source": DSMZ_725_URL,
        "notes": NOTES,
    }
