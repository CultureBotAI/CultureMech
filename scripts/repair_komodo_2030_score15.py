#!/usr/bin/env python3
"""Repair KOMODO 2030 Trace element solution (medium 1131)."""
...
TARGET = Path("bacterial/trace_element_solution_medium_1131.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_komodo_2030_score15.py"
ACTION = "RESOLVED_KOMODO_2030_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

EXPECTED_ID = "CultureMech:004301"
EXPECTED_MEDIA_TERM = "komodo.medium:2030"
KOMODO_2030 = (
    "https://komodo.modelseed.org/servlet/KomodoTomcatServerSideUtilitiesModelSeed?MediaInfo=2030"
)
SOURCE = "KOMODO Medium 2030"
...
FINAL_INGREDIENT_SIGNATURE: tuple[Component, ...] = (
    ...
    ("CoSO4 x 7 H2O", "0.10", "G_PER_L"),
    ("H3BO3", "0.01", "G_PER_L"),
    ("Na2MoO4 x 2 H2O", "0.01", "G_PER_L"),
    ("MnSO4 x X H2O", "0.50", "G_PER_L"),
    ("MgSO4 x 7 H2O", "3.00", "G_PER_L"),
    ("ZnSO4 x 7 H2O", "0.10", "G_PER_L"),
    ("H2O", "1.0", "L"),
    ("NaCl", "1.00", "G_PER_L"),
    ("AlK(SO4)2 x 12 H2O", "0.01", "G_PER_L"),
)

GROUNDINGS: dict[str, tuple[str, str]] = {
    "AlK(SO4)2 x 12 H2O": ("CHEBI:86465", "potassium aluminium sulfate dodecahydrate"),
    ...
    "MnSO4 x X H2O": ("CHEBI:86360", "manganese(II) sulfate"),
...
NOTES = (
    "KOMODO 2030 lists Trace element solution (medium 1131) as a defined "
    "submedium at pH 7.0. Its metabolite table contains 3.00 g/L MgSO4 x 7 "
    "H2O, 1.50 g/L nitrilotriacetic acid, 1.00 g/L NaCl, 0.50 g/L MnSO4 x X "
    "H2O, 0.10 g/L CaCl2 x 2 H2O, 0.10 g/L FeSO4 x 7 H2O, 0.10 g/L "
    "CoSO4 x 7 H2O, 0.10 g/L ZnSO4 x 7 H2O, 0.01 g/L CuSO4 x 5 H2O, "
    "0.01 g/L H3BO3, 0.01 g/L Na2MoO4 x 2 H2O, 0.01 g/L AlK(SO4)2 x 12 H2O, "
    "variable KOH, and H2O."
)
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "action": "MIX",
        "description": (
            "Prepare the 1 L Trace element solution stock from H2O, "
            "nitrilotriacetic acid, KOH, and the chloride, sulfate, borate, "
            "molybdate, and alum salts listed by KOMODO 2030."
        ),
    },
    {
        "step_number": 2,
...
def _component(preferred_term: str, value: str, unit: str) -> dict[str, Any]:
    ...
    if preferred_term == "H2O":
        row["notes"] = (
            ...
            "the solvent for 1 L of Trace element solution (medium 1131)."
        )
    ...
    elif preferred_term == "MnSO4 x X H2O":
        row["notes"] = (
            f"{SOURCE} lists 0.50 g/L MnSO4 x X H2O; the hydration state is "
            "left variable in the source label."
        )
...
def _ensure_references(doc: dict[str, Any]) -> None:
    ...
    if not any(row.get("reference") == KOMODO_2030 for row in references if isinstance(row, dict)):
        references.append({"reference": KOMODO_2030})
...
def _append_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            ...
            "2030 metabolite table; preserved KOH as a variable listed "
