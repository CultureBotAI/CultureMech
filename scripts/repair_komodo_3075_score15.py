#!/usr/bin/env python3
"""Repair KOMODO 3075 Trace element solution (medium 663)."""
...
TARGET = Path("bacterial/trace_element_solution_medium_663.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_komodo_3075_score15.py"
ACTION = "RESOLVED_KOMODO_3075_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

EXPECTED_ID = "CultureMech:004861"
EXPECTED_MEDIA_TERM = "komodo.medium:3075"
KOMODO_3075 = (
    "https://komodo.modelseed.org/servlet/KomodoTomcatServerSideUtilitiesModelSeed?MediaInfo=3075"
)
SOURCE = "KOMODO Medium 3075"
...
FINAL_INGREDIENT_SIGNATURE: tuple[Component, ...] = (
    ...
    ("Nitrilotriacetic acid (NTA)", "12.80", "G_PER_L"),
    ("CuCl2 x 2 H2O", "0.02", "G_PER_L"),
    ("H3BO3", "0.01", "G_PER_L"),
    ("Na2MoO4 x 2 H2O", "0.02", "G_PER_L"),
    ("Na2SeO3 x 5 H2O", "0.03", "G_PER_L"),
    ("FeCl3 x 6 H2O", "1.35", "G_PER_L"),
    ("NiCl2 x 6 H2O", "0.12", "G_PER_L"),
...
NOTES = (
    "KOMODO 3075 lists Trace element solution (medium 663) as a defined "
    "submedium at pH 6.5. Its metabolite table contains 12.80 g/L "
    "nitrilotriacetic acid (NTA), 1.35 g/L FeCl3 x 6 H2O, 1.00 g/L NaCl, "
    "0.12 g/L NiCl2 x 6 H2O, 0.10 g/L CaCl2 x 2 H2O, 0.10 g/L ZnCl2, "
    "0.10 g/L MnCl2 x 4 H2O, 0.03 g/L Na2SeO3 x 5 H2O, 0.02 g/L "
    "CoCl2 x 6 H2O, 0.02 g/L CuCl2 x 2 H2O, 0.02 g/L Na2MoO4 x 2 H2O, "
    "0.01 g/L H3BO3, variable KOH, and distilled water."
)
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "description": (
            ...
            "KOH, nitrilotriacetic acid, NaCl, the cobalt, calcium, zinc, "
            "manganese, copper, borate, molybdate, selenite, iron, and nickel "
            "salts listed by KOMODO 3075."
        ),
    },
    {
        "step_number": 2,
        "action": "ADJUST_PH",
        "description": "Adjust the Trace element solution stock to pH 6.5 with KOH as needed.",
    },
)
...
def _component(preferred_term: str, value: str, unit: str) -> dict[str, Any]:
    ...
    if preferred_term == "Distilled water":
        row["notes"] = (
            ...
            "as the solvent for 1 L of Trace element solution (medium 663)."
        )
    elif preferred_term == "KOH":
        row["notes"] = (
            f"{SOURCE} lists KOH without a gram amount and also identifies "
            "KOH as the pH adjuster for pH 6.5."
        )
...
def _ensure_references(doc: dict[str, Any]) -> None:
    ...
    if not any(row.get("reference") == KOMODO_3075 for row in references if isinstance(row, dict)):
        references.append({"reference": KOMODO_3075})
...
def _append_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            ...
            "3075 metabolite table; preserved KOH as a variable listed "
