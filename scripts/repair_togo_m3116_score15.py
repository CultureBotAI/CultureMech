#!/usr/bin/env python3
"""Repair TOGO M3116 Nutrient Agar."""
...
TARGET = Path("bacterial/TOGO_M3116_Nutrient_Agar.yaml")
PARENT = Path("bacterial/nutrient_agar.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

EXPECTED_ID = "CultureMech:009588"
EXPECTED_PARENT_ID = "CultureMech:001297"
EXPECTED_MEDIA_TERM = "TOGO:M3116"
EXPECTED_PARENT_MEDIA_TERM = "mediadive.medium:1"

CURATOR = "repair_togo_m3116_score15.py"
ACTION = "RESOLVED_TOGO_M3116_SCORE15"
LINK_ACTION = "LINKED_TOGO_M3116_SOURCE_DUPLICATE"
TIMESTAMP = "2026-09-11T00:00:00-07:00"

TOGO_M3116 = "https://togomedium.org/medium/M3116"
DSMZ_1 = "https://www.dsmz.de/microorganisms/medium/pdf/DSMZ_Medium1.pdf"
SOURCE = "TOGO M3116 / DSMZ Medium 1"
TITLE = "Nutrient Agar"
PH_VALUE = 7.0
...
PARENT_MEDIA = {
    ...
    "name": "nutrient_agar",
    "notes": (
        "TOGO M3116 imports DSMZ Medium 1 and exactly matches its formula, "
...
VARIANT_MODIFICATIONS = (
    ...
    "M3116 explicitly retains the source distilled-water row."
)

NOTES = (
    "TOGO M3116 / DSMZ Medium 1 defines Nutrient Agar using DSMZ Medium 1. "
    "DSMZ Medium 1 lists, per liter, 5 g Peptone, 3 g Meat extract, 15 g "
    "Agar if necessary, and 1000 ml Distilled water. Adjust pH to 7.0."
)
...
def repair_target(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _append_curation_event(
        ...
        action=ACTION,
        notes=(
            f"{NOTES} Corrected the imported water unit artifact, grounded "
            "the disclosed simple and protein-hydrolysate components, kept "
            "Meat extract intentionally unmapped, and linked the record to "
            "DSMZ Medium 1."
        ),
    )
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _append_curation_event(
        repaired,
        action=LINK_ACTION,
        notes="Linked TOGO M3116 as a source duplicate of DSMZ Medium 1.",
    )
    return repaired
