#!/usr/bin/env python3
"""Repair empty KOMODO 560 MTP4 MEDIUM."""
...
TARGET = "bacterial/mtp4_medium.yaml"
EXPECTED_ID = "CultureMech:006012"
EXPECTED_MEDIA_TERM = "komodo.medium:560"
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

KOMODO_560_URL = (
    "https://komodo.modelseed.org/servlet/" "KomodoTomcatServerSideUtilitiesModelSeed?MediaInfo=560"
)
DSMZ_560_URL = (
    "https://web.archive.org/web/20121030082653id_/"
    "http://www.dsmz.de/microorganisms/medium/pdf/DSMZ_Medium560.pdf"
)
DSMZ_195_URL = (
    "https://web.archive.org/web/20121030082653id_/"
...
SOURCE_560 = "Archived DSMZ Medium 560"
...
CURATOR = "repair_komodo_560_score35.py"
ACTION = "RESOLVED_KOMODO_560_SCORE35"
TIMESTAMP = "2026-09-10T00:00:00-07:00"
NOTES = (
    "Archived DSMZ Medium 560 defines MTP4 MEDIUM as DSMZ Medium 195 "
    "without Na2SO4 and sodium acetate, with 20-30 mM methanol, 1-2 mL "
    "methanethiol gas per 50 mL culture, and 0.4 g/L sodium sulfide; "
    "DSMZ Medium 195 derives from DSMZ Medium 193 with elevated NaCl and "
    "MgCl2 x 6 H2O, so this record expands archived DSMZ Media 193, 195, "
    "320, 141, and 560 into final per-liter components."
)
...
class Component:
    ...
    source: str
    notes: str
    mediaingredientmech_link: bool = True
...
COMPONENTS: tuple[Component, ...] = (
    ...
    Component(
        ...
        SOURCE_560,
        f"{SOURCE_560} adds methanol to 20-30 mM as the liquid substrate.",
    ),
    Component(
        "Methanethiol",
        "20.000-40.000",
        "ML_PER_L",
        ("CHEBI:16007", "methanethiol"),
        SOURCE_560,
        (
            f"{SOURCE_560} adds 1-2 mL methanethiol gas per 50 mL culture, "
            "equivalent to 20-40 mL/L culture."
        ),
        False,
    ),
    Component(
        ...
        SOURCE_560,
        (
            f"{SOURCE_560} uses 0.4 g/L sodium sulfide as a reducing agent; "
            f"{SOURCE_193} identifies that reductant as Na2S x 9 H2O."
        ),
    ),
    Component(
        "Na2S2O4",
        ...
        SOURCE_193,
        (
            f"{SOURCE_560} also calls for dithionite as a reducing agent; "
            f"{SOURCE_193} instructs 10-20 mg/L sodium dithionite addition."
        ),
    ),
    Component(
        "CO2",
    ...
    Component(
        ...
        (
            ...
            f"{SOURCE_560} omits sulfate and acetate."
        ),
    ),
)
...
def _ensure_references(doc: dict[str, Any]) -> None:
    doc["references"] = [
        {"reference": KOMODO_560_URL},
        {"reference": DSMZ_560_URL},
        {"reference": DSMZ_195_URL},
...
def _ensure_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "curator": CURATOR,
        "action": ACTION,
        "changes": "Replaced empty KOMODO 560 composition with archived DSMZ data",
        "source": DSMZ_560_URL,
        "notes": NOTES,
    }
...
def _ingredient(component: Component) -> dict[str, Any]:
    ...
    if component.mediaingredientmech_link:
