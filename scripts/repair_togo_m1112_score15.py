#!/usr/bin/env python3
"""Repair TOGO M1112 Marinitoga Medium."""
...
TARGET = Path("bacterial/TOGO_M1112_Marinitoga_Medium.yaml")
EXPECTED_ID = "CultureMech:007632"
EXPECTED_MEDIA_TERM = "TOGO:M1112"
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_togo_m1112_score15.py"
ACTION = "RESOLVED_TOGO_M1112_SCORE15"
TIMESTAMP = "2026-09-11T00:00:00-07:00"

TOGO_M1112 = "https://togomedium.org/medium/M1112"
JCM_1047 = "https://www.jcm.riken.jp/cgi-bin/jcm/jcm_grmd?GRMD=1047"

SOURCE = "TOGO M1112 / JCM Medium 1047"
TITLE = "Marinitoga Medium"
...
REFERENCES = (TOGO_M1112, JCM_1047)
...
def _listed_component(
    ...
    *,
    ...
    return _component(
        ...
        value,
        unit,
        notes=f"JCM Medium 1047 lists {value} {UNIT_LABELS[unit]} {preferred_term}.",
        term=term,
    )
...
def _stock(
    ...
    return {
        ...
        "source": SOURCE,
        "notes": (
            f"JCM Medium 1047 adds {value} ml/L {preferred_term} aseptically and "
...
INGREDIENTS: tuple[dict[str, Any], ...] = (
    ...
    _listed_component("PIPES", "6.0", "G_PER_L"),
    ...
    _component(
        ...
        "VARIABLE",
        notes=(
            "JCM Medium 1047 bubbles the medium with N2 for 5 min, distributes "
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "action": "MIX",
        "description": (
            "Mix sea salts, PIPES, yeast extract, tryptone, resazurin, and " "distilled water."
        ),
    },
    {
        "step_number": 2,
...
NOTES = (
    "TOGO M1112 records JCM Medium 1047 with sea salts, PIPES, yeast extract, "
    "tryptone, resazurin, distilled water, and an N2 gas atmosphere. JCM 1047 "
    "adjusts the base medium to pH 7.0, bubbles it with N2 for 5 min, "
