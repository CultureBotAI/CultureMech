#!/usr/bin/env python3
"""Repair KOMODO 3062 Trace element solution (A) (medium 253)."""
...
TARGET = Path("bacterial/trace_element_solution_a_medium_253.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_komodo_3062_score15.py"
ACTION = "RESOLVED_KOMODO_3062_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

EXPECTED_ID = "CultureMech:004846"
EXPECTED_MEDIA_TERM = "komodo.medium:3062"
KOMODO_3062 = (
    "https://komodo.modelseed.org/servlet/KomodoTomcatServerSideUtilitiesModelSeed?MediaInfo=3062"
)
SOURCE = "KOMODO Medium 3062"
...
FINAL_INGREDIENT_SIGNATURE: tuple[Component, ...] = (
    ...
    ("MnCl2 x 4 H2O", "0.07", "G_PER_L"),
    ("CuCl2 x 2 H2O", "0.01", "G_PER_L"),
    ("FeCl2 x 4 H2O", "1.80", "G_PER_L"),
    ("Na2SeO3 x 5 H2O", "0.01", "G_PER_L"),
...
NOTES = (
    "KOMODO 3062 lists Trace element solution (A) (medium 253) as a defined "
    "submedium at pH 3.0. Its metabolite table contains 1.80 g/L FeCl2 x 4 "
    "H2O, 0.50 g/L H3BO3, 0.25 g/L CoCl2 x 6 H2O, 0.10 g/L ZnCl2, "
    "0.07 g/L MnCl2 x 4 H2O, 0.03 g/L Na2MoO4 x 2 H2O, 0.01 g/L "
    "NiCl2 x 6 H2O, 0.01 g/L CuCl2 x 2 H2O, 0.01 g/L Na2SeO3 x 5 H2O, "
    "variable HCl, and distilled water."
)
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "action": "MIX",
        "description": (
            "Prepare the 1 L Trace element solution (A) stock from distilled "
            "water, HCl, and the chloride, borate, molybdate, and selenite "
            "salts listed by KOMODO 3062."
        ),
    },
    {
        "step_number": 2,
        "action": "ADJUST_PH",
        "description": "Adjust the Trace element solution (A) stock to pH 3.0 with 1 N HCl as needed.",
    },
)
...
def _component(preferred_term: str, value: str, unit: str) -> dict[str, Any]:
    ...
    if preferred_term == "Distilled water":
        row["notes"] = (
            ...
            "here as the solvent for 1 L of Trace element solution (A)."
        )
    elif preferred_term == "HCl":
        row["notes"] = (
            f"{SOURCE} lists HCl without a gram amount and also identifies HCl "
            "as the pH adjuster for pH 3.0."
        )
...
def _ensure_references(doc: dict[str, Any]) -> None:
    ...
    if not any(row.get("reference") == KOMODO_3062 for row in references if isinstance(row, dict)):
        references.append({"reference": KOMODO_3062})
...
def _append_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            ...
            "3062 metabolite table; preserved HCl as a variable listed "
...
def repair_record(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _put_after(repaired, "ph_value", 3.0, "physical_state")
