#!/usr/bin/env python3
"""Repair KOMODO 3070 Trace element solution (medium 144)."""
...
TARGET = Path("bacterial/trace_element_solution_medium_144.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_komodo_3070_score15.py"
ACTION = "RESOLVED_KOMODO_3070_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

EXPECTED_ID = "CultureMech:004856"
EXPECTED_MEDIA_TERM = "komodo.medium:3070"
KOMODO_3070 = (
    "https://komodo.modelseed.org/servlet/KomodoTomcatServerSideUtilitiesModelSeed?MediaInfo=3070"
)
SOURCE = "KOMODO Medium 3070"
...
FINAL_INGREDIENT_SIGNATURE: tuple[Component, ...] = (
    ...
    ("Na2SeO3 x 5 H2O", "0.02", "G_PER_L"),
    ("NiCl2 x 6 H2O", "0.03", "G_PER_L"),
    ("Distilled water", "1.0", "L"),
    ("FeCl2 x 4 H2O", "0.20", "G_PER_L"),
    ("NaCl", "1.00", "G_PER_L"),
)
...
NOTES = (
    "KOMODO 3070 lists Trace element solution (medium 144) as a defined "
    "submedium at pH 6.5. Its metabolite table contains 12.80 g/L "
    "nitrilotriacetic acid, 1.00 g/L NaCl, 0.20 g/L FeCl2 x 4 H2O, "
    "0.17 g/L CoCl2 x 6 H2O, 0.10 g/L CaCl2 x 2 H2O, 0.10 g/L ZnCl2, "
    "0.10 g/L MnCl2 x 4 H2O, 0.03 g/L NiCl2 x 6 H2O, 0.02 g/L CuCl2, "
    "0.02 g/L Na2SeO3 x 5 H2O, 0.01 g/L H3BO3, 0.01 g/L Na2MoO4 x 2 H2O, "
    "variable KOH, and distilled water."
)
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "description": (
            ...
            "manganese, copper, borate, molybdate, selenite, nickel, and iron "
            "salts listed by KOMODO 3070."
        ),
    },
    {
        "step_number": 2,
...
def _component(preferred_term: str, value: str, unit: str) -> dict[str, Any]:
    ...
    if preferred_term == "Distilled water":
        row["notes"] = (
            ...
            "as the solvent for 1 L of Trace element solution (medium 144)."
        )
...
def _ensure_references(doc: dict[str, Any]) -> None:
    ...
    if not any(row.get("reference") == KOMODO_3070 for row in references if isinstance(row, dict)):
        references.append({"reference": KOMODO_3070})
...
def _append_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            ...
            "3070 metabolite table; preserved KOH as a variable listed "
