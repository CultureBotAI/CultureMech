#!/usr/bin/env python3
"""Repair the score-15 NBRC Medium 273 TOGO import."""
...
TARGET = Path("bacterial/togo_medium_m1490.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

EXPECTED_ID = "CultureMech:008035"
EXPECTED_MEDIA_TERM = "TOGO:M1490"

CURATOR = "repair_nbrc_273_score15.py"
ACTION = "RESOLVED_NBRC_273_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

TOGO_M1490 = "https://togomedium.org/medium/M1490"
NBRC_273 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=273"
SOURCE = "NBRC Medium 273"
...
LEGACY_INGREDIENTS: tuple[Component, ...] = (
    ...
    (SODIUM_CHLORIDE, "60", "G_PER_L"),
    (AGAR_IF_NEEDED, "15", "G_PER_L"),
    (MEAT_EXTRACT, "3", "G_PER_L"),
    (PEPTONE, "5", "G_PER_L"),
)
...
REFERENCES = (TOGO_M1490, NBRC_273)

RECIPE_NOTES = (
    "TOGO M1490 imports NBRC Medium 273, which lists 5 g/L Peptone, "
    "3 g/L Meat extract, 60 g/L NaCl, 1000 ml/L Distilled water, "
    "and 15 g/L Agar if needed. The final pH is 7.0."
)
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "action": "MIX",
        "description": (
            "Combine 5 g/L Peptone, 3 g/L Meat extract, 60 g/L NaCl, and 1000 ml/L Distilled water."
        ),
    },
    {
        "step_number": 2,
        "action": "MIX",
        "description": "Add 15 g/L agar when solid NBRC Medium 273 is needed.",
    },
    {
        "step_number": 3,
        "action": "ADJUST_PH",
...
def _notes(preferred_term: str, value: str, unit: str) -> str:
    ...
    if preferred_term == MEAT_EXTRACT:
        return (
            f"{SOURCE} lists {value} {UNIT_LABELS[unit]} Meat extract; this "
...
def _ensure_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            "Curated TOGO:M1490 from TOGO and NBRC Medium 273; corrected "
            "Distilled water from a mass-like 1 g/L import to 1000 ml/L, "
            "added pH 7.0, grounded peptone, sodium chloride, water, and agar, "
            "and retained Meat extract as a sourced unmapped component."
        ),
    }
