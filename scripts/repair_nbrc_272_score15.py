#!/usr/bin/env python3
"""Repair the score-15 NBRC Medium 272 TOGO import."""
...
TARGET = Path("bacterial/togo_medium_m1489.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

EXPECTED_ID = "CultureMech:008033"
EXPECTED_MEDIA_TERM = "TOGO:M1489"

CURATOR = "repair_nbrc_272_score15.py"
ACTION = "RESOLVED_NBRC_272_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

TOGO_M1489 = "https://togomedium.org/medium/M1489"
NBRC_272 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=272"
SOURCE = "NBRC Medium 272"
...
LEGACY_INGREDIENTS: tuple[Component, ...] = (
    ...
    (CALCIUM_CHLORIDE, "1.36", "G_PER_L"),
    (AGAR_IF_NEEDED, "15", "G_PER_L"),
    (BACTO_CASITONE, "3", "G_PER_L"),
)
...
REFERENCES = (TOGO_M1489, NBRC_272)

RECIPE_NOTES = (
    "TOGO M1489 imports NBRC Medium 272, which lists 3 g/L Bacto "
    "Casitone (Difco), 1 g/L Yeast extract, 1.36 g/L CaCl2·2H2O, "
    "1000 ml/L Distilled water, and 15 g/L Agar if needed. The final "
    "pH is 7.2."
)
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "action": "MIX",
        "description": (
            "Combine 3 g/L Bacto Casitone (Difco), 1 g/L Yeast extract, "
            "1.36 g/L CaCl2·2H2O, and 1000 ml/L Distilled water."
        ),
    },
    {
        "step_number": 2,
        "action": "MIX",
        "description": "Add 15 g/L agar when solid NBRC Medium 272 is needed.",
    },
    {
        "step_number": 3,
        "action": "ADJUST_PH",
...
def _notes(preferred_term: str, value: str, unit: str) -> str:
    ...
    if preferred_term == BACTO_CASITONE:
        return (
            ...
            "from Difco; this commercial casein digest is retained as an "
...
def _ensure_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            "Curated TOGO:M1489 from TOGO and NBRC Medium 272; corrected "
            "Distilled water from a mass-like 1 g/L import to 1000 ml/L, "
            "added pH 7.2, grounded the exact water, yeast extract, calcium "
            "chloride, and agar rows, and retained Bacto Casitone as a "
            "sourced unmapped component."
        ),
    }
