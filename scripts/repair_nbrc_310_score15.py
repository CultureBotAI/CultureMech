#!/usr/bin/env python3
"""Repair the recovered NBRC Medium 309 Rhamnose Salt Medium record."""
...
CURATOR = "repair_nbrc_310_score15.py"
ACTION = "RESOLVED_NBRC_310_SCORE15"
TIMESTAMP = "2026-09-11T00:00:00-07:00"

TARGET_PATH = "bacterial/NBRC_310.yaml"
TARGET_ID = "CultureMech:007486"
REQUIRED_ACTION = "Recovered composition from source HTML"

SOURCE = "NBRC Medium 309"
NBRC_URL = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=309"
TITLE = "Rhamnose Salt Medium"
...
IMPORTED_INGREDIENT_SIGNATURE: tuple[Component, ...] = (
    ...
    ("KH2PO4", "2.1", "G_PER_L"),
    ("NH4Cl", "2", "G_PER_L"),
    ("MgSO4·7H2O", "0.4", "G_PER_L"),
    ("NaCl", "30", "MG_PER_L"),
    ("CaCl2·2H2O", "3", "MG_PER_L"),
    ("FeSO4·7H2O", "1", "MG_PER_L"),
...
GROUNDINGS: dict[str, tuple[str, str]] = {
    ...
    "Rhamnose": ("CHEBI:26546", "rhamnose"),
}

NOTES = (
    "Source: NBRC Medium 309 | Link: "
    "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=309\n\n"
    "NBRC lists Rhamnose Salt Medium with K2HPO4, KH2PO4, NH4Cl, "
    "MgSO4·7H2O, NaCl, CaCl2·2H2O, FeSO4·7H2O, yeast extract, rhamnose, "
    "and distilled water at final pH 7.0."
)
...
def _ensure_target(doc: dict[str, Any]) -> None:
    ...
    if doc.get("name") not in {"310", TITLE}:
...
def _ensure_flags(doc: dict[str, Any]) -> None:
    ...
    chemical_rows = [
        ...
        and str(row.get("preferred_term") or "") != "Yeast extract"
    ]
...
def _ensure_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "curator": CURATOR,
        "action": ACTION,
        "changes": "Grounded recovered NBRC Medium 309 Rhamnose Salt Medium formula",
        "source": NBRC_URL,
        "notes": (
            "Added the NBRC Medium 309 source term and official title, "
            "structured the final pH, grounded the defined formula rows, "
            "and added the official NBRC reference."
        ),
    }
...
def repair_document(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _put_after(
        ...
        "media_term",
        {
            ...
            "term": _term("nbrc.medium:309", SOURCE),
        },
        "physical_state",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(f"{action} {changed_count} NBRC 310 records")
    return 0
