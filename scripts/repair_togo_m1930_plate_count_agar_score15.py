#!/usr/bin/env python3
"""Repair TOGO M1930 / NBRC Medium 1197 Plate Count Agar."""
...
TARGET = Path("bacterial/plate_count_agar_pca.yaml")
EXPECTED_ID = "CultureMech:008509"
EXPECTED_MEDIA_TERM = "TOGO:M1930"
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_togo_m1930_plate_count_agar_score15.py"
ACTION = "RESOLVED_TOGO_M1930_PLATE_COUNT_AGAR_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

TOGO_M1930 = "https://togomedium.org/sparqlist/api/gmdb_medium_by_gmid?gm_id=M1930"
NBRC_1197 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=1197"
REFERENCES = (TOGO_M1930, NBRC_1197)
SOURCE = "TOGO M1930 / NBRC Medium 1197"

Component = tuple[str, str, str]

IMPORTED_INGREDIENT_SIGNATURE: tuple[Component, ...] = (
    ("Disrilled water", "1", "G_PER_L"),
...
INGREDIENT_NOTES = {
    "Distilled water": (
        "TOGO M1930 / NBRC Medium 1197 lists 1 L water as the solvent; the "
        "source label typo 'Disrilled water' is normalized to Distilled water."
    ),
...
NOTES = (
    "TOGO M1930 imports NBRC Medium 1197 Plate Count Agar (PCA). NBRC 1197 "
    "lists 5 g tryptone, 2.5 g yeast extract, 1 g glucose, 15 g agar if "
    "needed, 1 L water, and pH 7.2."
)
...
def _append_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            "Corrected NBRC 1197 water from an imported 1 g/L 'Disrilled "
            "water' row to 1 L distilled water, added pH 7.2, grounded every "
            "PCA component, and removed a stale MediaDive Medium 21 match."
        ),
    }
