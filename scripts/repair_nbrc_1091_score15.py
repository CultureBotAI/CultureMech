#!/usr/bin/env python3
"""Repair the recovered NBRC Medium 1086 Thermophilic RC-I record."""
...
CURATOR = "repair_nbrc_1091_score15.py"
ACTION = "RESOLVED_NBRC_1091_SCORE15"
TIMESTAMP = "2026-09-11T00:00:00-07:00"

TARGET_PATH = "bacterial/NBRC_1091.yaml"
TARGET_ID = "CultureMech:007455"
REQUIRED_ACTION = "Recovered composition from source HTML"

SOURCE = "NBRC Medium 1086"
NBRC_URL = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=1086"
TITLE = "Thermophilic RC-I medium"
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        "step_number": 2,
        "action": "AUTOCLAVE",
        "description": "Autoclave the medium under H2/CO2 (80/20).",
    },
    {
        "step_number": 3,
        "action": "AUTOCLAVE",
        "description": (
            "Separately autoclave cysteine-HCl and Na2S·9H2O as 6% solutions "
    ...
    },
    {
        ...
        "description": (
            ...
            "and the cysteine-HCl and Na2S·9H2O solutions."
        ),
    },
    {
        "step_number": 6,
        "action": "MIX",
        "description": "Pressurize inoculated bottles to 150 kPa with H2/CO2.",
    },
    {
        "step_number": 7,
        "action": "ADJUST_PH",
...
NOTES = (
    "Source: NBRC Medium 1086 | Link: "
    "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=1086\n\n"
    "NBRC lists Thermophilic RC-I medium with mineral salts, Bacto Yeast "
    "Extract, acetate, trace elements, vitamins, resazurin, cysteine-HCl, and "
    "Na2S, with anaerobic H2/CO2 preparation and pH 7.0."
)
...
def _component(preferred_term: str, value: str, unit: str) -> dict[str, Any]:
    row: dict[str, Any] = {
        ...
        "source": SOURCE,
        "notes": (
            "NBRC Medium 1086 uses NaOH to adjust the trace elements solution "
...
def _ensure_target(doc: dict[str, Any]) -> None:
    ...
    if doc.get("name") not in {"1091", TITLE}:
...
def _ensure_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "curator": CURATOR,
        "action": ACTION,
        "changes": "Grounded recovered NBRC Medium 1086 Thermophilic RC-I formula",
        "source": NBRC_URL,
        "notes": (
            "Added the NBRC Medium 1086 source term, grounded the recovered "
            "Thermophilic RC-I medium formula and stocks, recorded pH 7.0, and "
            "converted anaerobic preparation instructions into structured "
            "steps."
        ),
    }
...
def repair_document(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _put_after(
        ...
        "media_term",
        {
            ...
            "term": _term("nbrc.medium:1086", SOURCE),
        },
        "physical_state",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(f"{action} {changed_count} NBRC 1091 records")
    return 0
