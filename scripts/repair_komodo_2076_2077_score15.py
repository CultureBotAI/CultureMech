#!/usr/bin/env python3
"""Repair KOMODO 2076-2077 trace mineral solution records."""
...
MEDIUM_1121_TARGET = Path("bacterial/trace_mineral_solution_medium_1121.yaml")
MEDIUM_1146_TARGET = Path("bacterial/trace_mineral_solution_medium_1146.yaml")

TARGETS: dict[Path, dict[str, str]] = {
    MEDIUM_1121_TARGET: {
        "id": "CultureMech:004353",
        "media_term": "komodo.medium:2076",
        "name": "Trace mineral solution (medium 1121)",
    },
    MEDIUM_1146_TARGET: {
        "id": "CultureMech:004354",
        "media_term": "komodo.medium:2077",
        "name": "Trace mineral solution (medium 1146)",
    },
}
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_komodo_2076_2077_score15.py"
ACTION = "RESOLVED_KOMODO_2076_2077_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

KOMODO_ROOT = "https://komodo.modelseed.org/servlet/KomodoTomcatServerSideUtilitiesModelSeed"
REFERENCES = {
    MEDIUM_1121_TARGET: f"{KOMODO_ROOT}?MediaInfo=2076",
    MEDIUM_1146_TARGET: f"{KOMODO_ROOT}?MediaInfo=2077",
}
SOURCE_LABELS = {
    MEDIUM_1121_TARGET: "KOMODO Medium 2076",
    MEDIUM_1146_TARGET: "KOMODO Medium 2077",
}
...
IMPORTED_INGREDIENT_SIGNATURES: dict[Path, tuple[Component, ...]] = {
    MEDIUM_1121_TARGET: (),
    MEDIUM_1146_TARGET: (("HCl", "variable", "VARIABLE"),),
}
...
FINAL_INGREDIENT_SIGNATURES: dict[Path, tuple[Component, ...]] = {
    MEDIUM_1121_TARGET: (
        ...
        ("SrCl2 x 6 H2O", "0.01", "G_PER_L"),
        ("Nitrilotriacetic acid", "1.50", "G_PER_L"),
        ("H2WO4", "0.10", "G_PER_L"),
        ("Na2SeO3 x 5 H2O", "0.10", "G_PER_L"),
        ("CoSO4 x 7 H2O", "0.50", "G_PER_L"),
        ("H3BO3", "0.01", "G_PER_L"),
        ("Na2MoO4 x 2 H2O", "1.00E-3", "G_PER_L"),
        ("MnSO4 x 2 H2O", "0.50", "G_PER_L"),
        ("NiCl2 x 6 H2O", "0.10", "G_PER_L"),
        ("Fe2(SO4)3 x n H2O", "1.00", "G_PER_L"),
        ("H2O", "1.0", "L"),
...
GROUNDINGS: dict[str, tuple[str, str]] = {
    ...
    "Fe2(SO4)3 x n H2O": ("CHEBI:53438", "iron(3+) sulfate"),
    "FeSO4 x 7 H2O": ("CHEBI:75836", "iron(2+) sulfate heptahydrate"),
    "H2O": ("CHEBI:15377", "water"),
    "H2WO4": ("CHEBI:36272", "tungstic acid"),
    ...
    "SrCl2 x 6 H2O": ("CHEBI:36385", "strontium dichloride hexahydrate"),
    "ZnCl2": ("CHEBI:49976", "zinc dichloride"),
    "ZnSO4 x 7 H2O": ("CHEBI:32312", "zinc sulfate heptahydrate"),
}

SOURCE_SPELLINGS = {
    (MEDIUM_1121_TARGET, "KAl(SO4)2 x 12 H2O"): "KAI(SO4)2 x 12 H2O",
    (MEDIUM_1121_TARGET, "MnSO4 x 2 H2O"): "MnSO4 x X H2O",
    (MEDIUM_1121_TARGET, "Fe2(SO4)3 x n H2O"): "Fe2(SO4)3 x xH2O",
    (MEDIUM_1146_TARGET, "Na2SeO3"): "NaSeO3",
    (MEDIUM_1146_TARGET, "H3BO3"): "H3BO",
    (MEDIUM_1146_TARGET, "Na2WO4 x 2 H2O"): "Na-tungstate x 2 H2O",
    (MEDIUM_1146_TARGET, "NiSO4 x 6 H2O"): "Ni2SO4 x 6 H2O",
}

UNIT_LABELS = {"G_PER_L": "g/L", "L": "L", "VARIABLE": "variable"}
PH_VALUES: dict[Path, float] = {MEDIUM_1146_TARGET: 3.0}

NOTES = {
    MEDIUM_1121_TARGET: (
        "KOMODO 2076 lists Trace mineral solution (medium 1121) as a defined "
        "submedium. Its metabolite table contains 1.50 g/L nitrilotriacetic acid, "
        "1.00 g/L Fe2(SO4)3 x xH2O, 0.50 g/L MnSO4 x X H2O, 0.50 g/L "
        "CoSO4 x 7 H2O, 0.18 g/L ZnSO4 x 7 H2O, 0.10 g/L H2WO4, "
        "0.10 g/L Na2SeO3 x 5 H2O, 0.10 g/L NiCl2 x 6 H2O, 0.02 g/L "
        "KAI(SO4)2 x 12 H2O, 0.01 g/L NaBr, 0.01 g/L CuSO4 x 5 H2O, "
        "0.01 g/L SrCl2 x 6 H2O, 0.01 g/L H3BO3, 1.00E-3 g/L "
        "Na2MoO4 x 2 H2O, 0.01 g/L KI, and H2O."
    ),
    MEDIUM_1146_TARGET: (
        "KOMODO 2077 lists Trace mineral solution (medium 1146) as a defined "
        ...
        "Ni2SO4 x 6 H2O, 0.02 g/L CuCl, 0.01 g/L NaSeO3, 0.01 g/L "
        "Na2MoO4 x 2 H2O, 0.01 g/L H3BO, variable HCl, and H2O."
    ),
}
    ...
    MEDIUM_1121_TARGET: (
        {
            ...
            "action": "MIX",
            "description": (
                "Prepare the medium 1121 trace mineral stock from H2O, "
                "nitrilotriacetic acid, and the bromide, copper, strontium, "
                "tungstate, selenite, cobalt, borate, molybdate, manganese, "
                "nickel, ferric sulfate, zinc, and iodide salts listed by KOMODO."
            ),
        },
    ),
    MEDIUM_1146_TARGET: (
        {
            ...
            "action": "MIX",
            "description": (
                "Prepare the 1 L medium 1146 trace mineral stock from HCl, H2O, "
                "Na-EDTA, the cobalt, selenite, zinc, aluminum, borate, "
                "tungstate, manganese, iron, nickel, molybdate, and copper "
                "salts listed by KOMODO."
            ),
        },
        {
            "step_number": 2,
            "action": "ADJUST_PH",
            "description": "Adjust the medium 1146 trace mineral stock to pH 3.0 with HCl.",
        },
    ),
}
...
def _component(
    ...
    if preferred_term == "H2O":
        row["notes"] = f"{source} lists H2O without a gram amount; normalized as stock solvent."
    elif preferred_term == "HCl":
        row["notes"] = (
            f"{source} lists HCl without a gram amount and identifies it as the pH "
            "adjuster for pH 3.0."
        )
...
def _append_event(target: Path, doc: dict[str, Any]) -> None:
    ...
    event = {
        ...
        "notes": (
            ...
            "metabolite table and grounded disclosed components through "
            "MediaIngredientMech."
        ),
    }
