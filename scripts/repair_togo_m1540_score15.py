#!/usr/bin/env python3
"""Repair TOGO M1540 Enriched Cytophaga Agar."""
...
TARGET = Path("bacterial/TOGO_M1540_Enriched_Cytophaga_Agar.yaml")
EXPECTED_ID = "CultureMech:008088"
EXPECTED_MEDIA_TERM = "TOGO:M1540"
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_togo_m1540_score15.py"
ACTION = "RESOLVED_TOGO_M1540_SCORE15"
TIMESTAMP = "2026-09-11T00:00:00-07:00"

TOGO_M1540 = "https://togomedium.org/medium/M1540"
NBRC_332 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=332"

SOURCE = "TOGO M1540 / NBRC Medium 332"
TITLE = "Enriched Cytophaga Agar"
...
REFERENCES = (TOGO_M1540, NBRC_332)
...
INGREDIENTS: tuple[dict[str, Any], ...] = (
    _component(
        ...
        "G_PER_L",
        notes=(
            "NBRC Medium 332 lists 2 g/L Bacto Tryptone (Difco); this "
    ...
    _component(
        ...
        "G_PER_L",
        notes=(
            "NBRC Medium 332 lists 0.5 g/L Beef extract; this biological "
    ...
    _component(
        ...
        "1.0",
        "L",
        notes="NBRC Medium 332 lists 1 L distilled water.",
    ),
)

NOTES = (
    "TOGO M1540 imports NBRC Medium 332 as Enriched Cytophaga Agar. "
    "NBRC 332 lists 2 g Bacto Tryptone (Difco), 0.5 g beef extract, "
    "0.5 g yeast extract, 0.2 g sodium acetate, optional 15 g agar, "
