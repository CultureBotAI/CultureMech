#!/usr/bin/env python3
"""Repair KOMODO 507 Carboxydothermus child relationships."""
...
PARENT = Path("bacterial/KOMODO_507_CARBOXYDOTHERMUS_medium.yaml")
PARENT_ID = "CultureMech:005708"
PARENT_NAME = "carboxydothermus_medium"
PARENT_SOURCE_TERM = "komodo.medium:507"
...
SIGNATURE = (
    ...
    ("CaCl2 x 2 H2O", "0.286845", "G_PER_L"),
    ("NH4Cl", "0.326409", "G_PER_L"),
    ("KH2PO4", "0.326409", "G_PER_L"),
    ("Na2-9,10-anthraquinone-2,6-disulfonate", "8.16024", "G_PER_L"),
    ("NaHCO3", "0.98912", "G_PER_L"),
    ("Yeast extract", "0.197824", "G_PER_L"),
    ("Na2-EDTA", "0.5", "G_PER_L"),
...
class Child:
    ...
    relationship: str
    notes: str
    signature: tuple[tuple[str, str, str], ...] = SIGNATURE
...
CHILDREN = (
    Child(
        Path("bacterial/carboxydothermus_siderophilus_medium.yaml"),
        "CultureMech:001640",
        "mediadive.medium:507a",
        "DSMZ Medium 507a",
        SOURCE_DUPLICATE_RELATIONSHIP,
        "DSMZ Medium 507a has the same 27-ingredient signature as KOMODO Medium 507.",
    ),
    Child(
        Path(
            "bacterial/"
            "pyruvate_as_an_alternative_substrate_for_dsm_6008_dsm_14886_"
            "and_dsm_16521.yaml"
        ),
        "CultureMech:005700",
        "komodo.medium:507.1",
        "KOMODO Medium 507.1",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 507.1 applies KOMODO Medium 507 to DSM 6008, DSM 14886 and DSM 16521.",
    ),
    Child(
        Path("bacterial/for_dsm_12326.yaml"),
        "CultureMech:005701",
        "komodo.medium:507.2",
        "KOMODO Medium 507.2",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 507.2 applies KOMODO Medium 507 to DSM 12326.",
    ),
    Child(
        Path("bacterial/for_dsm_18923.yaml"),
        "CultureMech:005702",
        "komodo.medium:507.3",
        "KOMODO Medium 507.3",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 507.3 applies KOMODO Medium 507 to DSM 18923.",
    ),
    Child(
        Path("bacterial/for_dsm_21278.yaml"),
        "CultureMech:005703",
        "komodo.medium:507.4",
        "KOMODO Medium 507.4",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 507.4 applies KOMODO Medium 507 to DSM 21278.",
    ),
    Child(
        Path("bacterial/for_dsm_21830.yaml"),
        "CultureMech:005704",
        "komodo.medium:507.5",
        "KOMODO Medium 507.5",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 507.5 applies KOMODO Medium 507 to DSM 21830.",
    ),
    Child(
        Path("bacterial/for_dsm_23132.yaml"),
        "CultureMech:005705",
        "komodo.medium:507.6",
        "KOMODO Medium 507.6",
        PH_RELATIONSHIP,
        "KOMODO Medium 507.6 applies KOMODO Medium 507 with NaOH pH adjustment to DSM 23132.",
        PH_SIGNATURE,
    ),
    Child(
        Path("bacterial/medium_507_modified_for_dsm_7242.yaml"),
        "CultureMech:005706",
        "komodo.medium:507_7242",
        "KOMODO Medium 507_7242",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 507_7242 applies KOMODO Medium 507 to DSM 7242.",
    ),
    Child(
        Path("bacterial/for_dsm_23698.yaml"),
        "CultureMech:005707",
        "komodo.medium:507.7",
        "KOMODO Medium 507.7",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 507.7 applies KOMODO Medium 507 to DSM 23698.",
    ),
)
CHILD_BY_PATH = {child.path: child for child in CHILDREN}
EXPECTED_CHILD_COUNT = 9

CURATOR = "repair_komodo_507_carboxydothermus_score10.py"
ACTION = "RESOLVED_KOMODO_507_CARBOXYDOTHERMUS_TOPOLOGY"
...
def _require_parent(doc: dict[str, Any]) -> None:
    _require_record(doc, PARENT, PARENT_ID, PARENT_SOURCE_TERM, SIGNATURE)


def _require_child(child: Child, doc: dict[str, Any]) -> None:
    _require_record(doc, child.path, child.record_id, child.source_term, child.signature)
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Curated KOMODO Medium 507 child variant topology",
            "source": "KOMODO Medium 507.1-507.7, 507_7242; DSMZ Medium 507a",
            "notes": "Kept exact DSMZ 507a as a source duplicate and resolved DSM wrappers as strain or pH variants.",
        },
    )
    return repaired
...
def repair_child(relative_path: Path, doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": f"Linked under KOMODO Medium 507 as {child.relationship}",
