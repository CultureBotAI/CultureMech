#!/usr/bin/env python3
"""Repair the score-15 NBRC Medium 225 TOGO import."""
...
TARGET = Path("bacterial/togo_medium_m1453.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

EXPECTED_ID = "CultureMech:007994"
EXPECTED_MEDIA_TERM = "TOGO:M1453"

CURATOR = "repair_nbrc_225_score15.py"
ACTION = "RESOLVED_NBRC_225_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

TOGO_M1453 = "https://togomedium.org/medium/M1453"
NBRC_225 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=225"
SOURCE = "NBRC Medium 225"

TABLE_WINE = "Table wine"
YEAST_EXTRACT = "Yeast extract"
CALCIUM_LACTATE = "Calcium lactate"
...
LEGACY_INGREDIENTS: tuple[Component, ...] = (
    (DISTILLED_WATER, "500", "G_PER_L"),
    (YEAST_EXTRACT, "20", "G_PER_L"),
    (CALCIUM_CARBONATE, "20", "G_PER_L"),
    (CALCIUM_LACTATE, "10", "G_PER_L"),
    (TABLE_WINE, "500", "G_PER_L"),
    (AGAR_IF_NEEDED, "15", "G_PER_L"),
)

FINAL_INGREDIENTS: tuple[Component, ...] = (
    (TABLE_WINE, "500", "ML_PER_L"),
    (YEAST_EXTRACT, "20", "G_PER_L"),
    (CALCIUM_LACTATE, "10", "G_PER_L"),
    (CALCIUM_CARBONATE, "20", "G_PER_L"),
    (DISTILLED_WATER, "500", "ML_PER_L"),
    (AGAR_IF_NEEDED, "15", "G_PER_L"),
)
...
PH_RANGE = {"min": 6.6, "max": 6.8}
REFERENCES = (TOGO_M1453, NBRC_225)

RECIPE_NOTES = (
    "TOGO M1453 imports NBRC Medium 225, which lists 500 ml/L Table wine, "
    "20 g/L Yeast extract, 10 g/L Calcium lactate, 20 g/L CaCO3, 500 ml/L "
    "Distilled water, and 15 g/L Agar if needed. The listed pH range is "
    "6.6 to 6.8."
)
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "action": "MIX",
        "description": (
            "Combine 500 ml/L Table wine, 20 g/L Yeast extract, 10 g/L "
            "Calcium lactate, 20 g/L CaCO3, and 500 ml/L Distilled water."
        ),
    },
    {
        "step_number": 2,
        "action": "MIX",
        "description": "Add 15 g/L agar when solid NBRC Medium 225 is needed.",
    },
    {
        "step_number": 3,
        "action": "ADJUST_PH",
        "description": "Adjust pH to 6.6 to 6.8.",
    },
)
...
def _notes(preferred_term: str, value: str, unit: str) -> str:
    if preferred_term == TABLE_WINE:
        return (
            f"{SOURCE} lists {value} {UNIT_LABELS[unit]} Table wine; this "
            "fermented source material is retained as an opaque complex "
            "component."
        )
