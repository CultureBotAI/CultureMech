#!/usr/bin/env python3
"""Repair the score-15 NBRC Medium 277 TOGO import."""
...
TARGET = Path("bacterial/togo_medium_m1494.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

EXPECTED_ID = "CultureMech:008039"
EXPECTED_MEDIA_TERM = "TOGO:M1494"

CURATOR = "repair_nbrc_277_score15.py"
ACTION = "RESOLVED_NBRC_277_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

TOGO_M1494 = "https://togomedium.org/medium/M1494"
NBRC_277 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=277"
SOURCE = "NBRC Medium 277"
...
REFERENCES = (TOGO_M1494, NBRC_277)

RECIPE_NOTES = (
    "TOGO M1494 imports NBRC Medium 277, which lists 5 g/L Bacto "
    "Casitone (Difco), 5 g/L Yeast extract, 1 g/L MgSO4·7H2O, 1 L "
    "Distilled water, and 15 g/L Agar if needed. The source does not "
    "state pH or incubation temperature."
)
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "action": "MIX",
        "description": (
            "Combine 5 g/L Bacto Casitone (Difco), 5 g/L Yeast extract, "
    ...
    },
    {
        "step_number": 2,
        "action": "MIX",
        "description": "Add 15 g/L agar when solid NBRC Medium 277 is needed.",
    },
)
...
def _notes(preferred_term: str, value: str, unit: str) -> str:
    ...
    if preferred_term == BACTO_CASITONE:
        return (
            f"{SOURCE} lists {value} {UNIT_LABELS[unit]} Bacto Casitone "
            "from Difco; this commercial casein digest is retained without "
...
def _ensure_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            "Curated TOGO:M1494 from TOGO and NBRC Medium 277; corrected "
            "Distilled water from a mass-like 1 g/L import to 1 L, grounded "
            "yeast extract, magnesium sulfate heptahydrate, water, and agar, "
            "and retained Bacto Casitone as a sourced unmapped component. "
            "NBRC Medium 277 does not state pH or incubation temperature."
        ),
    }
