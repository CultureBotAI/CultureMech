#!/usr/bin/env python3
"""Repair TOGO M2012 LB + Ampicillin, Cefpodoxime, Kanamycin medium."""
...
TARGET = Path("bacterial/lb_ampicillin_cefpodoxime_kanamycin_medium.yaml")
LB_PARENT = Path("bacterial/lb_medium.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_togo_m2012_lb_ampicillin_cefpodoxime_kanamycin_score15.py"
ACTION = "RESOLVED_TOGO_M2012_LB_AMPICILLIN_CEFPODOXIME_KANAMYCIN_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

EXPECTED_ID = "CultureMech:008599"
EXPECTED_MEDIA_TERM = "TOGO:M2012"
LB_PARENT_ID = "CultureMech:008037"
TOGO_M2012 = "https://togomedium.org/medium/M2012"
NBRC_1300 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=1300"
SOURCE = "TOGO M2012 / NBRC Medium 1300"
...
IMPORTED_SOLUTION_SIGNATURE: tuple[SolutionSignature, ...] = (
    ("Kanamycin solution (50 mg/ml)*", "1", "G_PER_L", ()),
    ("Ampicillin solution (50 mg/ml)*", "1", "G_PER_L", ()),
    ("Cefpodoxime solution (10 mg/ml)*", "1", "G_PER_L", ()),
)
...
AMPICILLIN_SIGNATURE: tuple[Component, ...] = (("Ampicillin", "50.0", "MG_PER_ML"),)

CEFPODOXIME_SIGNATURE: tuple[Component, ...] = (("Cefpodoxime", "10.0", "MG_PER_ML"),)

KANAMYCIN_SIGNATURE: tuple[Component, ...] = (("Kanamycin", "50.0", "MG_PER_ML"),)

FINAL_SOLUTION_SIGNATURE: tuple[SolutionSignature, ...] = (
    ("Ampicillin solution (50 mg/ml)", "1.0", "ML_PER_L", AMPICILLIN_SIGNATURE),
    ("Cefpodoxime solution (10 mg/ml)", "1.0", "ML_PER_L", CEFPODOXIME_SIGNATURE),
    ("Kanamycin solution (50 mg/ml)", "1.0", "ML_PER_L", KANAMYCIN_SIGNATURE),
)

GROUNDINGS: dict[str, tuple[str, str]] = {
    "Agar (if needed)": ("CHEBI:2509", "agar"),
    "Ampicillin": ("CHEBI:28971", "ampicillin"),
    "Cefpodoxime": ("CHEBI:3504", "Cefpodoxime"),
...
NOTES = (
    "TOGO M2012 imports NBRC Medium 1300 LB + Ampicillin, Cefpodoxime, "
    "Kanamycin medium. NBRC 1300 lists the LB base with 1.0 ml/L Ampicillin "
    "solution (50 mg/ml), 1.0 ml/L Cefpodoxime solution (10 mg/ml), "
    "1.0 ml/L Kanamycin solution (50 mg/ml), 15 g/L agar if needed, "
    "and pH 7.0."
)
...
PARENT_MEDIA = {
    ...
    "name": "lb_medium",
    "notes": (
        "NBRC Medium 1300 supplements LB Medium with separately "
        "filter-sterilized 1.0 ml/L Ampicillin solution (50 mg/ml), "
        "1.0 ml/L Cefpodoxime solution (10 mg/ml), and 1.0 ml/L "
...
VARIANT_CHILD = {
    ...
    "relationship": "SUPPLEMENTED_VARIANT",
    "id": EXPECTED_ID,
    "name": "lb_ampicillin_cefpodoxime_kanamycin_medium",
    "notes": PARENT_MEDIA["notes"],
}

VARIANT_MODIFICATIONS = (
    "Adds 1.0 ml/L Ampicillin solution (50 mg/ml), 1.0 ml/L Cefpodoxime "
    "solution (10 mg/ml), and 1.0 ml/L Kanamycin solution (50 mg/ml) after "
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "description": (
            "Sterilize the 50 mg/ml ampicillin, 10 mg/ml cefpodoxime, and "
            "50 mg/ml kanamycin stocks separately by filtration."
        ),
    },
    {
        "step_number": 3,
        "action": "MIX",
        "description": (
            "Add 1.0 ml/L each filter-sterilized Ampicillin solution "
            "(50 mg/ml), Cefpodoxime solution (10 mg/ml), and Kanamycin "
            "solution (50 mg/ml) to the LB base."
        ),
    },
)
...
INGREDIENTS: tuple[dict[str, Any], ...] = (
    _component(
        ...
        "G_PER_L",
        notes=(
            "NBRC Medium 1300 lists Bacto Tryptone (Difco) as a source-disclosed "
...
SOLUTIONS: tuple[dict[str, Any], ...] = (
    {
        ...
        "composition": [
            _component(
                ...
                "50.0",
                "MG_PER_ML",
                notes="NBRC Medium 1300 specifies this stock as 50 mg/ml Ampicillin.",
            )
        ],
    ...
    {
        "preferred_term": "Cefpodoxime solution (10 mg/ml)",
        "concentration": {"value": "1.0", "unit": "ML_PER_L"},
        "source": SOURCE,
        "notes": f"{SOURCE} lists 1 ml/L Cefpodoxime solution (10 mg/ml).",
        "term": _term(*GROUNDINGS["Cefpodoxime"]),
        "mediaingredientmech_chebi_term": _term(*GROUNDINGS["Cefpodoxime"]),
        "composition": [
            _component(
                "Cefpodoxime",
                "10.0",
                "MG_PER_ML",
                notes="NBRC Medium 1300 specifies this stock as 10 mg/ml Cefpodoxime.",
            )
        ],
        "name": "Cefpodoxime solution (10 mg/ml)",
        "preparation_notes": "Sterilize separately by filtration.",
    },
    {
        "preferred_term": "Kanamycin solution (50 mg/ml)",
        "concentration": {"value": "1.0", "unit": "ML_PER_L"},
        "source": SOURCE,
        "notes": f"{SOURCE} lists 1 ml/L Kanamycin solution (50 mg/ml).",
        "term": _term(*GROUNDINGS["Kanamycin"]),
        "mediaingredientmech_chebi_term": _term(*GROUNDINGS["Kanamycin"]),
        "composition": [
            _component(
                "Kanamycin",
                "50.0",
                "MG_PER_ML",
                notes="NBRC Medium 1300 specifies this stock as 50 mg/ml Kanamycin.",
            )
        ],
        "name": "Kanamycin solution (50 mg/ml)",
        "preparation_notes": "Sterilize separately by filtration.",
    },
)
...
def _ensure_references(doc: dict[str, Any]) -> None:
    ...
    for reference in (TOGO_M2012, NBRC_1300):
...
def _append_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            ...
            "ampicillin, cefpodoxime, and kanamycin stocks."
        ),
    }
