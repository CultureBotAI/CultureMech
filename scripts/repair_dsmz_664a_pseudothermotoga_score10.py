#!/usr/bin/env python3
"""Repair DSMZ/KOMODO 664a Pseudothermotoga variant topology."""
...
PARENT = Path("bacterial/pseudothermotoga_lettingae_medium.yaml")
PARENT_ID = "CultureMech:001803"
PARENT_NAME = "pseudothermotoga_lettingae_medium"
PARENT_SOURCE_TERM = "mediadive.medium:664a"
...
CURATOR = "repair_dsmz_664a_pseudothermotoga_score10.py"
ACTION = "RESOLVED_DSMZ_KOMODO_664A_TOPOLOGY"
...
CHILDREN = (
    Child(
        Path("bacterial/thermotoga_elfii_medium.yaml"),
        "CultureMech:006247",
        "thermotoga_elfii_medium",
        "komodo.medium:664",
        "KOMODO Medium 664",
        SOURCE_DUPLICATE_RELATIONSHIP,
        "KOMODO Medium 664 has the same formulation as DSMZ Medium 664a.",
    ),
    Child(
        Path("bacterial/for_dsm_14385.yaml"),
        "CultureMech:006246",
        "for_dsm_14385",
        "komodo.medium:664.1",
        "KOMODO Medium 664.1",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 664.1 applies DSMZ Medium 664a to DSM 14385.",
    ),
)
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Promoted DSMZ Medium 664a to the exact-signature parent",
            "source": "DSMZ Medium 664a and KOMODO Medium 664-664.1",
            "notes": (
                "Moved the exact-signature KOMODO 664 records under the "
                "DSMZ/MediaDive Pseudothermotoga lettingae base."
            ),
        },
    )
    return repaired
...
def repair_child(relative_path: Path, doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Linked under DSMZ Medium 664a",
