#!/usr/bin/env python3
"""Repair KOMODO 2039 Trace element solution (medium 141)."""
...
TARGET = Path("bacterial/trace_element_solution_medium_141.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_komodo_2039_score15.py"
ACTION = "RESOLVED_KOMODO_2039_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

EXPECTED_ID = "CultureMech:004310"
EXPECTED_MEDIA_TERM = "komodo.medium:2039"
KOMODO_2039 = (
    "https://komodo.modelseed.org/servlet/KomodoTomcatServerSideUtilitiesModelSeed?MediaInfo=2039"
)
SOURCE = "KOMODO Medium 2039"
...
NOTES = (
    "KOMODO 2039 lists Trace element solution (medium 141) as a defined "
    ...
    "0.10 g/L FeSO4 x 7 H2O, 0.03 g/L NiCl2 x 6 H2O, 0.02 g/L "
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "description": (
            ...
            "zinc salts listed by KOMODO 2039."
        ),
    },
    {
        "step_number": 2,
...
def _component(preferred_term: str, value: str, unit: str) -> dict[str, Any]:
    ...
    if preferred_term == "H2O":
        row["notes"] = (
            ...
            "the solvent for 1 L of Trace element solution (medium 141)."
        )
...
def _ensure_references(doc: dict[str, Any]) -> None:
    ...
    if not any(row.get("reference") == KOMODO_2039 for row in references if isinstance(row, dict)):
        references.append({"reference": KOMODO_2039})
...
def _append_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            ...
            "2039 metabolite table; preserved KOH as a variable listed "
