#!/usr/bin/env python3
"""Repair KOMODO 870 Syntrophothermus strain child links."""
...
PARENT = Path("bacterial/KOMODO_870_SYNTROPHOTHERMUS_MEDIUM.yaml")
PARENT_ID = "CultureMech:006705"
PARENT_NAME = "syntrophothermus_medium"
PARENT_SOURCE_TERM = "komodo.medium:870"
STRAIN_RELATIONSHIP = "STRAIN_SPECIFIC_VARIANT"

SIGNATURE = (
    ("KH2PO4", "0.13834", "G_PER_L"),
    ("MgCl2 x 6 H2O", "0.197628", "G_PER_L"),
    ("CaCl2 x 2 H2O", "0.248221", "G_PER_L"),
    ("NH4Cl", "0.533597", "G_PER_L"),
    ("Sodium resazurin", "0.000494071", "G_PER_L"),
    ("Na2CO3", "0.988142", "G_PER_L"),
    ("Na2S x 9 H2O", "0.296443", "G_PER_L"),
    ("L-Cysteine HCl x H2O", "0.296443", "G_PER_L"),
...
CHILDREN = (
    Child(
        Path("bacterial/for_dsm_12680.yaml"),
        "CultureMech:006703",
        "komodo.medium:870.1",
        "KOMODO Medium 870.1",
        "DSM 12680",
    ...
    Child(
        Path("bacterial/for_dsm12681.yaml"),
        "CultureMech:006704",
        "komodo.medium:870.2",
        "KOMODO Medium 870.2",
        "DSM 12681",
...
CURATOR = "repair_komodo_870_syntrophothermus_score10.py"
ACTION = "RESOLVED_KOMODO_870_SYNTROPHOTHERMUS_TOPOLOGY"
...
def _notes(child: Child) -> str:
    return f"{child.source_label} applies Syntrophothermus medium to {child.target}."
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Resolved KOMODO Medium 870 Syntrophothermus child topology",
            "source": "KOMODO Medium 870.1 and 870.2",
            "notes": (
                "Kept KOMODO Medium 870 linked under DSMZ Medium 870 and retyped "
                "KOMODO Medium 870.1 and 870.2 as DSM strain wrappers."
            ),
        },
    )
    return repaired
...
def repair_child(relative_path: Path, doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _put_after(repaired, "variant_modifications", [_notes(child)], "variant_relationship")
    _upsert_event(
        repaired,
        {
            "timestamp": TIMESTAMP,
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Linked as a KOMODO Medium 870 strain-specific variant",
