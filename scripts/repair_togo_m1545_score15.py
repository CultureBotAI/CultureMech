#!/usr/bin/env python3
"""Repair TOGO M1545 Caulobacter Medium."""
...
TARGET = Path("bacterial/TOGO_M1545_Caulobacter_Medium.yaml")
EXPECTED_ID = "CultureMech:008093"
EXPECTED_MEDIA_TERM = "TOGO:M1545"
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_togo_m1545_score15.py"
ACTION = "RESOLVED_TOGO_M1545_SCORE15"
TIMESTAMP = "2026-09-11T00:00:00-07:00"

TOGO_M1545 = "https://togomedium.org/medium/M1545"
NBRC_338 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=338"

SOURCE = "TOGO M1545 / NBRC Medium 338"
TITLE = "Caulobacter Medium"
...
REFERENCES = (TOGO_M1545, NBRC_338)
...
INGREDIENTS: tuple[dict[str, Any], ...] = (
    _component(
        ...
        "G_PER_L",
        notes=(
            "NBRC Medium 338 lists 2 g/L Peptone; this hydrolysate mixture "
            "is retained as an opaque complex component."
        ),
    ),
    _component("Yeast extract", "1.0", "G_PER_L"),
    _component("MgSO4·7H2O", "0.2", "G_PER_L"),
    _component("Agar (if needed)", "10.0", "G_PER_L"),
    _component(
        "Distilled water",
        "1.0",
        "L",
        notes="NBRC Medium 338 lists 1 L distilled water.",
    ),
)

NOTES = (
    "TOGO M1545 imports NBRC Medium 338 as Caulobacter Medium. "
    "NBRC 338 lists 2 g peptone, 1 g yeast extract, 0.2 g "
    "MgSO4·7H2O, optional 10 g agar, and 1 L distilled water at pH "
    "7.0. The source does not state sterilization, incubation "
    "temperature, or other preparation steps."
)
