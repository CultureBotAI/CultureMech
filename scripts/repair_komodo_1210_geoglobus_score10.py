#!/usr/bin/env python3
"""Repair KOMODO 1210 Geoglobus exact child links."""
...
PARENT = Path("archaea/KOMODO_1210_GEOGLOBUS_medium.yaml")
PARENT_ID = "CultureMech:003962"
PARENT_NAME = "geoglobus_medium"
PARENT_SOURCE_TERM = "komodo.medium:1210"
...
CHILDREN = (
    Child(
        Path("bacterial/dsm_24515.yaml"),
        "CultureMech:003961",
        "komodo.medium:1210.1",
        "KOMODO Medium 1210.1",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 1210.1 applies Geoglobus medium to DSM 24515.",
    ),
    Child(
        Path("bacterial/thermosulfuriphilus_medium.yaml"),
        "CultureMech:000668",
        "mediadive.medium:1210c",
        "DSMZ Medium 1210c",
        SOURCE_DUPLICATE_RELATIONSHIP,
        "DSMZ Medium 1210c has the same 33-ingredient signature as KOMODO Medium 1210.",
    ),
)
CHILD_BY_PATH = {child.path: child for child in CHILDREN}
EXPECTED_CHILD_COUNT = 2

CURATOR = "repair_komodo_1210_geoglobus_score10.py"
ACTION = "RESOLVED_KOMODO_1210_GEOGLOBUS_TOPOLOGY"
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Resolved KOMODO Medium 1210 Geoglobus child topology",
            "source": "KOMODO Medium 1210.1 and DSMZ Medium 1210c",
            "notes": (
                "Kept the exact-signature DSM 24515 KOMODO strain wrapper and "
                "DSMZ Medium 1210c duplicate under the KOMODO Medium 1210 "
                "Geoglobus base."
            ),
        },
    )
...
def repair_child(relative_path: Path, doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": f"Linked as a KOMODO Medium 1210 {child.relationship}",
