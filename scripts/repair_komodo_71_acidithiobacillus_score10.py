#!/usr/bin/env python3
"""Repair KOMODO 71 Acidithiobacillus exact and strain child links."""
...
PARENT = Path("bacterial/acidithiobacillus_thiooxidans_medium.yaml")
PARENT_ID = "CultureMech:001858"
PARENT_NAME = "acidithiobacillus_thiooxidans_medium"
PARENT_SOURCE_TERM = "mediadive.medium:71"
...
CHILDREN = (
    Child(
        Path("bacterial/thiobacillus_ferrooxidans_medium_with_thiosulfate.yaml"),
        "CultureMech:006362",
        "komodo.medium:71",
        "KOMODO Medium 71",
        SOURCE_DUPLICATE_RELATIONSHIP,
        "KOMODO Medium 71 has the same 5-ingredient signature as DSMZ Medium 71.",
    ),
    Child(
        Path("bacterial/for_dsm_14366.yaml"),
        "CultureMech:006345",
        "komodo.medium:71.1",
        "KOMODO Medium 71.1",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 71.1 applies Acidithiobacillus thiooxidans medium to DSM 14366.",
    ),
)
CHILD_BY_PATH = {child.path: child for child in CHILDREN}
EXPECTED_CHILD_COUNT = 2

CURATOR = "repair_komodo_71_acidithiobacillus_score10.py"
ACTION = "RESOLVED_KOMODO_71_ACIDITHIOBACILLUS_TOPOLOGY"
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Re-rooted KOMODO Medium 71 Acidithiobacillus exact topology",
            "source": "DSMZ Medium 71; KOMODO Medium 71, 71.1",
            "notes": "Moved exact KOMODO Medium 71 and its strain wrapper under DSMZ Medium 71.",
        },
    )
    return repaired
...
def repair_child(relative_path: Path, doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": f"Linked under DSMZ Medium 71 as {child.relationship}",
