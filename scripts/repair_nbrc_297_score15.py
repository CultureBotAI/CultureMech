#!/usr/bin/env python3
"""Repair the score-15 NBRC Medium 297 TOGO import."""
...
TARGET = Path("bacterial/togo_medium_m1512.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

EXPECTED_ID = "CultureMech:008057"
EXPECTED_MEDIA_TERM = "TOGO:M1512"

CURATOR = "repair_nbrc_297_score15.py"
ACTION = "RESOLVED_NBRC_297_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

TOGO_M1512 = "https://togomedium.org/medium/M1512"
NBRC_297 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=297"
SOURCE = "NBRC Medium 297"
...
LEGACY_INGREDIENTS: tuple[Component, ...] = (
    ...
    (SODIUM_CHLORIDE, "5", "G_PER_L"),
    (AGAR_IF_NEEDED, "15", "G_PER_L"),
    (BEEF_EXTRACT, "1", "G_PER_L"),
    (PEPTONE, "5", "G_PER_L"),
)
...
REFERENCES = (TOGO_M1512, NBRC_297)

RECIPE_NOTES = (
    "TOGO M1512 imports NBRC Medium 297, which lists 1 g/L Beef extract, "
    "2 g/L Yeast extract, 5 g/L Peptone, 5 g/L NaCl, 1 L Distilled "
    "water, and 15 g/L Agar if needed. The final pH is 7.0."
)
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "action": "MIX",
        "description": (
            "Combine 1 g/L Beef extract, 2 g/L Yeast extract, 5 g/L "
            "Peptone, 5 g/L NaCl, and 1 L Distilled water."
        ),
    },
    {
        "step_number": 2,
        "action": "MIX",
        "description": "Add 15 g/L agar when solid NBRC Medium 297 is needed.",
    },
    {
        "step_number": 3,
        "action": "ADJUST_PH",
...
def _notes(preferred_term: str, value: str, unit: str) -> str:
    ...
    if preferred_term == BEEF_EXTRACT:
        return (
            f"{SOURCE} lists {value} {UNIT_LABELS[unit]} Beef extract; "
            "this generic complex extract is retained without an ontology "
            "grounding."
        )
...
def _ensure_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            "Curated TOGO:M1512 from TOGO and NBRC Medium 297; corrected "
            "Distilled water from a mass-like 1 g/L import to 1 L, added "
            "pH 7.0, grounded yeast extract, peptone, sodium chloride, water, "
            "and agar, and retained Beef extract as a sourced unmapped "
            "component."
        ),
    }
