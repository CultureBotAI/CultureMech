#!/usr/bin/env python3
"""Repair TOGO M3062 / NBRC Medium 1636 GYP for acetic acid bacteria."""
...
TARGET = Path("bacterial/gyp_for_acetic_acid_bacteria_ph_6_0_glucose_30g.yaml")
EXPECTED_ID = "CultureMech:009577"
EXPECTED_MEDIA_TERM = "TOGO:M3062"
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_togo_m3062_gyp_acetic_score15.py"
ACTION = "RESOLVED_TOGO_M3062_GYP_ACETIC_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

TOGO_M3062 = "https://togomedium.org/medium/M3062"
NBRC_1636 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=1636"
SOURCE = "TOGO M3062 / NBRC Medium 1636"
TITLE = "GYP for Acetic acid bacteria (pH 6.0, Glucose 30g)"
...
REFERENCES = (TOGO_M3062, NBRC_1636)
...
COMPONENT_NOTES: dict[str, str] = {
    "Glucose": "NBRC Medium 1636 lists 30 g/L glucose.",
    "Yeast Extract": "NBRC Medium 1636 lists 5 g/L Yeast Extract.",
    "Peptone": (
        "NBRC Medium 1636 lists 2 g/L Peptone; this protein digest is "
        "retained as an opaque complex component."
    ),
    "Distilled water": "NBRC Medium 1636 lists 1 L distilled water.",
    "Agar (if needed)": "NBRC Medium 1636 lists 20 g/L agar if needed.",
}
...
NOTES = (
    "TOGO M3062 imports NBRC Medium 1636 as GYP for Acetic acid bacteria "
    "(pH 6.0, Glucose 30g). NBRC 1636 lists 30 g glucose, 5 g Yeast "
    "Extract, 2 g Peptone, 1 L distilled water, 20 g agar if needed, "
    "and pH 6.0."
)
...
def _append_curation_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            f"{NOTES} Corrected the imported distilled-water unit, restored "
            "the migrated agar row to the ingredient list, added the NBRC pH, "
