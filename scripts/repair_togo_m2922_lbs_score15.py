...
TARGET = Path("bacterial/lbs_medium.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_togo_m2922_lbs_score15.py"
ACTION = "RESOLVED_TOGO_M2922_LBS_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

EXPECTED_ID = "CultureMech:009458"
EXPECTED_MEDIA_TERM = "TOGO:M2922"
TOGO_M2922 = "https://togomedium.org/medium/M2922"
TOGO_API = "https://togomedium.org/sparqlist/api/gmdb_medium_by_gmid?gm_id=M2922"
SOURCE = "TOGO M2922"
...
REFERENCES = (TOGO_M2922, TOGO_API)

GROUNDINGS: dict[str, tuple[str, str]] = {
    "Distilled water": ("CHEBI:15377", "water"),
    "NaCl": ("CHEBI:26710", "sodium chloride"),
    "Tris, pH 7.5": ("CHEBI:9754", "tris"),
...
NOTES = (
    "TOGO M2922 reports LBS medium with 1000 ml/L Distilled water, 1.5 g/L "
    "Yeast extract, 342 mM NaCl, 20 mM Tris at pH 7.5, and 10 g/L Tryptone."
)
...
INGREDIENTS: tuple[dict[str, Any], ...] = (
    ...
    _component("Yeast extract", "1.5", "G_PER_L"),
    _component("NaCl", "342", "MILLIMOLAR"),
    _component("Tris, pH 7.5", "20", "MILLIMOLAR"),
    _component(
        "Tryptone",
        "10",
        "G_PER_L",
        notes=(
            "TOGO M2922 lists 10 g/L Tryptone as a digest product not reducible "
...
def _append_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            ...
            "artifact to 1000 ml/L and added explicit FoodOn/ChEBI grounding "
            "for the four mappable components."
        ),
    }
