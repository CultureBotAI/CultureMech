#!/usr/bin/env python3
"""Repair KOMODO 2049 Trace element solution (medium 69)."""
...
TARGET = Path("bacterial/trace_element_solution_medium_69.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_komodo_2049_score15.py"
ACTION = "RESOLVED_KOMODO_2049_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

EXPECTED_ID = "CultureMech:004321"
EXPECTED_MEDIA_TERM = "komodo.medium:2049"
KOMODO_2049 = (
    "https://komodo.modelseed.org/servlet/KomodoTomcatServerSideUtilitiesModelSeed?MediaInfo=2049"
)
SOURCE = "KOMODO Medium 2049"
...
FINAL_INGREDIENT_SIGNATURE: tuple[Component, ...] = (
    ("CoCl2 x 6 H2O", "1.61", "G_PER_L"),
    ("CaCl2 x 2 H2O", "5.54", "G_PER_L"),
    ("H2O", "1.0", "L"),
    ("ZnSO4 x 7 H2O", "22.00", "G_PER_L"),
    ("KOH", "variable", "VARIABLE"),
    ("CuSO4 x 5 H2O", "1.57", "G_PER_L"),
    ("MnCl2 x 4 H2O", "5.06", "G_PER_L"),
    ("FeSO4 x 7 H2O", "5.00", "G_PER_L"),
    ("(NH4)6 Mo7O24 x 4 H2O", "1.10", "G_PER_L"),
    ("Na2-EDTA", "50.00", "G_PER_L"),
)

GROUNDINGS: dict[str, tuple[str, str]] = {
    "(NH4)6 Mo7O24 x 4 H2O": ("CHEBI:91249", "ammonium molybdate"),
...
NOTES = (
    "KOMODO 2049 lists Trace element solution (medium 69) as a defined "
    "submedium at pH 6.0. Its metabolite table contains 50.00 g/L Na2-EDTA, "
    "22.00 g/L ZnSO4 x 7 H2O, 5.54 g/L CaCl2 x 2 H2O, "
    "5.06 g/L MnCl2 x 4 H2O, 5.00 g/L FeSO4 x 7 H2O, "
    "1.61 g/L CoCl2 x 6 H2O, 1.57 g/L CuSO4 x 5 H2O, "
    "1.10 g/L (NH4)6 Mo7O24 x 4 H2O, variable KOH, and H2O."
)
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "action": "MIX",
        "description": (
            "Prepare the 1 L Trace element solution stock from H2O, KOH, "
            "Na2-EDTA, the cobalt, calcium, zinc, copper, manganese, iron, and "
            "molybdate salts listed by KOMODO 2049."
        ),
    },
    {
        "step_number": 2,
        "action": "ADJUST_PH",
        "description": "Adjust the Trace element solution stock to pH 6.0 with KOH as needed.",
    },
)
...
def _component(preferred_term: str, value: str, unit: str) -> dict[str, Any]:
    ...
    if preferred_term == "H2O":
        row["notes"] = (
            ...
            "the solvent for 1 L of Trace element solution (medium 69)."
        )
    elif preferred_term == "KOH":
        row["notes"] = (
            f"{SOURCE} lists KOH without a gram amount and also identifies "
            "KOH as the pH adjuster for pH 6.0."
        )
...
def _ensure_references(doc: dict[str, Any]) -> None:
    ...
    if not any(row.get("reference") == KOMODO_2049 for row in references if isinstance(row, dict)):
        references.append({"reference": KOMODO_2049})
...
def _append_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            ...
            "2049 metabolite table; preserved KOH as a variable listed "
