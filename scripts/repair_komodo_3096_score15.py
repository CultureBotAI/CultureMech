#!/usr/bin/env python3
"""Repair KOMODO 3096 Trace elements solution (medium 1183)."""
...
TARGET = Path("bacterial/trace_elements_solution_medium_1183.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_komodo_3096_score15.py"
ACTION = "RESOLVED_KOMODO_3096_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

EXPECTED_ID = "CultureMech:004882"
EXPECTED_MEDIA_TERM = "komodo.medium:3096"
KOMODO_3096 = (
    "https://komodo.modelseed.org/servlet/KomodoTomcatServerSideUtilitiesModelSeed?MediaInfo=3096"
)
SOURCE = "KOMODO Medium 3096"
...
FINAL_INGREDIENT_SIGNATURE: tuple[Component, ...] = (
    ("CoCl2 x 6 H2O", "1.00E-3", "G_PER_L"),
    ("HCl", "variable", "VARIABLE"),
    ("NiCl2 x 6 H2O", "3.00E-3", "G_PER_L"),
    ("ZnSO4 x 7 H2O", "5.00E-3", "G_PER_L"),
    ("Distilled water", "1.0", "L"),
    ("MnCl2 x 4 H2O", "3.00E-3", "G_PER_L"),
    ("FeSO4 x 7 H2O", "0.30", "G_PER_L"),
    ("CuCl2 x 2 H2O", "2.00E-3", "G_PER_L"),
    ("Na2MoO4 x 2 H2O", "3.00E-3", "G_PER_L"),
    ("H3BO3", "2.00E-3", "G_PER_L"),
)
...
NOTES = (
    "KOMODO 3096 lists Trace elements solution (medium 1183) as a defined "
    "submedium at pH 3.0. Its metabolite table contains 0.30 g/L FeSO4 x 7 H2O, "
    "5.00E-3 g/L ZnSO4 x 7 H2O, 3.00E-3 g/L NiCl2 x 6 H2O, "
    "3.00E-3 g/L MnCl2 x 4 H2O, 3.00E-3 g/L Na2MoO4 x 2 H2O, "
    "2.00E-3 g/L CuCl2 x 2 H2O, 2.00E-3 g/L H3BO3, "
    "1.00E-3 g/L CoCl2 x 6 H2O, variable HCl, and Distilled water."
)
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "description": (
            ...
            "water, HCl, and the cobalt, nickel, zinc, manganese, iron, "
            "copper, molybdate, and borate salts listed by KOMODO 3096."
        ),
    },
    {
        "step_number": 2,
        "action": "ADJUST_PH",
        "description": "Adjust the Trace elements solution stock to pH 3.0 with HCl as needed.",
    },
)
...
def _component(preferred_term: str, value: str, unit: str) -> dict[str, Any]:
    ...
    if preferred_term == "Distilled water":
        row["notes"] = (
            ...
            "here as the solvent for 1 L of Trace elements solution (medium 1183)."
        )
...
def _ensure_references(doc: dict[str, Any]) -> None:
    ...
    if not any(row.get("reference") == KOMODO_3096 for row in references if isinstance(row, dict)):
        references.append({"reference": KOMODO_3096})
...
def _append_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            ...
            "3096 metabolite table; preserved HCl as a variable listed "
