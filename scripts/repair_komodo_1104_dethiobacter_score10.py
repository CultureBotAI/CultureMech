#!/usr/bin/env python3
"""Repair KOMODO 1104.1 Dethiobacter strain child link."""
...
PARENT = Path("bacterial/KOMODO_1104_DETHIOBACTER_medium.yaml")
PARENT_ID = "CultureMech:003804"
PARENT_NAME = "dethiobacter_medium"
PARENT_SOURCE_TERM = "komodo.medium:1104"

CHILD = Path("bacterial/for_dsm_19089.yaml")
CHILD_ID = "CultureMech:003803"
CHILD_SOURCE_TERM = "komodo.medium:1104.1"
RELATIONSHIP = "STRAIN_SPECIFIC_VARIANT"
CHILD_NOTES = "KOMODO Medium 1104.1 applies DETHIOBACTER medium to DSM 19089."

SOURCE_DUPLICATE_PARENT = {
    "path": "data/normalized_yaml/bacterial/dethiobacter_medium.yaml",
    "relationship": "SOURCE_DUPLICATE",
    "id": "CultureMech:000537",
    "name": "dethiobacter_medium",
...
INGREDIENT_SIGNATURE = (
    ("NaCl", "5.9761", "G_PER_L"),
    ("K2HPO4", "0.498008", "G_PER_L"),
    ("NaHCO3", "7.96813", "G_PER_L"),
    ("Na2CO3", "21.9123", "G_PER_L"),
    ("Sulfur", "1.49402", "G_PER_L"),
    ("NH4Cl", "0.199203", "G_PER_L"),
    ("MgCl2 x 6 H2O", "0.199203", "G_PER_L"),
    ("Yeast extract", "0.0498008", "G_PER_L"),
    ("Ethanol absolute", "0.6", "G_PER_L"),
    ("Na-acetate", "0.398406", "G_PER_L"),
    ("Na2S2O3 x 5 H2O", "2.49004", "G_PER_L"),
    ("Na2S x 9 H2O", "0.239044", "G_PER_L"),
    ("EDTA", "5", "G_PER_L"),
...
CURATOR = "repair_komodo_1104_dethiobacter_score10.py"
ACTION = "RESOLVED_KOMODO_1104_DETHIOBACTER_TOPOLOGY"
...
def _parent_ref() -> dict[str, str]:
    return {
        ...
        "id": PARENT_ID,
        "name": PARENT_NAME,
        "notes": "KOMODO Medium 1104 is the DETHIOBACTER base for KOMODO Medium 1104.1.",
    }
...
def _require_parent(doc: dict[str, Any]) -> None:
    ...
    if doc.get("parent_media") != SOURCE_DUPLICATE_PARENT:
        raise ValueError(f"{PARENT}: expected DSMZ 1104 source-duplicate parent")
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Reclassified KOMODO Medium 1104.1 as a strain variant",
            "source": "KOMODO Medium 1104 and 1104.1",
            "notes": (
                "Linked KOMODO Medium 1104.1 under the KOMODO Medium 1104 "
                "DETHIOBACTER base while preserving the DSMZ 1104 duplicate "
                "parent relationship."
            ),
        },
    )
...
def repair_child(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Linked under KOMODO Medium 1104",
            "source": "KOMODO Medium 1104.1",
            "notes": CHILD_NOTES,
        },
    )
    return repaired
