#!/usr/bin/env python3
"""Repair the score-15 NBRC Medium 316 TOGO import."""
...
TARGET = Path("bacterial/togo_medium_m1529.yaml")
PARENT = Path("bacterial/TOGO_M1553_Methylobacterium_Medium.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

EXPECTED_ID = "CultureMech:008075"
EXPECTED_PARENT_ID = "CultureMech:008102"
EXPECTED_MEDIA_TERM = "TOGO:M1529"
EXPECTED_PARENT_MEDIA_TERM = "TOGO:M1553"

CURATOR = "repair_nbrc_316_score15.py"
ACTION = "RESOLVED_NBRC_316_SCORE15"
LINK_ACTION = "LINKED_NBRC_316_METHYLOBACTERIUM_VARIANT"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

TOGO_M1529 = "https://togomedium.org/medium/M1529"
NBRC_316 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=316"
SOURCE = "NBRC Medium 316"
...
REFERENCES = (TOGO_M1529, NBRC_316)

VARIANT_MODIFICATIONS = (
    "Substitutes 10 g/L separately autoclaved Na2CO3 for the 5 ml/L methanol "
    "supplement in TOGO M1553.",
    "Decreases MgSO4·7H2O from 1 g/L to 0.5 g/L.",
)
VARIANT_NOTES = (
    "Substitutes 10 g/L separately autoclaved Na2CO3 for methanol and "
    "decreases MgSO4·7H2O from 1 g/L to 0.5 g/L."
)
PARENT_MEDIA = {
...
RECIPE_NOTES = (
    "TOGO M1529 imports NBRC Medium 316, which lists 10 g/L Hipolypepton "
    "from Wako Pure Chemical Industries, 2 g/L Yeast extract, 0.5 g/L "
    "MgSO4·7H2O, 10 g/L Na2CO3, 1 L Distilled water, and 15 g/L Agar "
    "if needed. The Na2CO3 is sterilized separately by autoclaving and "
    "added to the other ingredients, giving a final pH between 9.0 and 10.0."
)
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "description": (
            ...
            "0.5 g/L MgSO4·7H2O, and 1 L Distilled water."
        ),
    },
    {
        "step_number": 2,
        "action": "MIX",
        "description": "Add 15 g/L agar when solid NBRC Medium 316 is needed.",
    },
    {
        "step_number": 3,
        "action": "AUTOCLAVE",
        "description": "Sterilize Na2CO3 separately by autoclaving.",
    },
    {
        "step_number": 4,
        "action": "MIX",
        "description": (
            "Add 10 g/L separately autoclaved Na2CO3 to the other ingredients; "
            "the final pH is between 9.0 and 10.0."
        ),
    },
)
...
def _notes(preferred_term: str, value: str, unit: str) -> str:
    ...
    if preferred_term == SODIUM_CARBONATE:
        return (
            f"{SOURCE} lists {value} {UNIT_LABELS[unit]} Na2CO3, sterilized "
            "separately by autoclaving before addition."
        )
...
def repair_target(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _put_after(repaired, "ph_range", {"min": 9.0, "max": 10.0}, "physical_state")
    ...
    _append_curation_event(
        ...
        action=ACTION,
        notes=(
            "Curated TOGO:M1529 from TOGO and NBRC Medium 316; corrected "
            "Distilled water from a mass-like 1 g/L import to 1 L, moved "
            "Hipolypepton and Na2CO3 from migrated empty G_PER_L solutions "
            "to sourced formula ingredients, added the final pH 9.0-10.0 "
            "range, grounded yeast extract, magnesium sulfate heptahydrate, "
            "sodium carbonate, water, and agar, retained Hipolypepton as a "
            "sourced opaque component, and linked M1529 to M1553 as a "
            "substituted-component variant."
        ),
    )
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _append_curation_event(
        ...
        action=LINK_ACTION,
        notes=(
            "Linked NBRC Medium 316 as a substituted-component Methylobacterium Medium variant."
        ),
    )
    return repaired
