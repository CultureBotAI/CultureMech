#!/usr/bin/env python3
"""Repair KOMODO 398 topology rooted at a strain-specific duplicate."""
...
PARENT = Path("archaea/thermoplasma_volcanium_medium.yaml")
PARENT_ID = "CultureMech:001507"
PARENT_NAME = "thermoplasma_volcanium_medium"
PARENT_SOURCE_TERM = "mediadive.medium:398"
...
KOMODO_INGREDIENT_SIGNATURE = (
    *BASE_INGREDIENT_SIGNATURE,
    ("H2SO4", "variable", "VARIABLE"),
)

CURATOR = "repair_komodo_398_thermoplasma_score10.py"
ACTION = "RESOLVED_KOMODO_398_THERMOPLASMA_TOPOLOGY"
...
CHILDREN = (
    Child(
        Path("archaea/KOMODO_398_THERMOPLASMA_VOLCANIUM_medium.yaml"),
        "CultureMech:005187",
        "thermoplasma_volcanium_medium",
        "komodo.medium:398",
        "SOURCE_DUPLICATE",
        2.0,
        KOMODO_INGREDIENT_SIGNATURE,
        (
            "KOMODO Medium 398 mirrors DSMZ Medium 398 with sulfuric acid "
            "represented as the variable pH-adjustment ingredient."
        ),
    ),
    Child(
        Path("bacterial/aerobic_version.yaml"),
        "CultureMech:005186",
        "aerobic_version",
        "komodo.medium:398.2",
        "SOURCE_DUPLICATE",
        ...
        KOMODO_INGREDIENT_SIGNATURE,
        (
            "KOMODO Medium 398.2 mirrors DSMZ Medium 398 with sulfuric acid "
            "represented as the variable pH-adjustment ingredient."
        ),
    ),
    Child(
        Path("bacterial/for_dsm_4301.yaml"),
        "CultureMech:005185",
        "for_dsm_4301",
        "komodo.medium:398.1",
        ...
        {"min": 2.0, "max": 3.0},
        BASE_INGREDIENT_SIGNATURE,
        "KOMODO Medium 398.1 applies THERMOPLASMA VOLCANIUM MEDIUM for DSM 4301.",
    ),
)
    ...
    _upsert_event(
        repaired,
        {
            ...
            "notes": (
                ...
                "to the DSMZ/MediaDive THERMOPLASMA VOLCANIUM MEDIUM record."
            ),
        },
    )
    return repaired
...
def repair_child(doc: dict[str, Any], child: Child) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Linked under MediaDive Medium 398",
