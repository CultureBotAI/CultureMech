#!/usr/bin/env python3
"""Repair the recovered NBRC Medium 1155 TG agar record."""
...
CURATOR = "repair_nbrc_1158_score15.py"
ACTION = "RESOLVED_NBRC_1158_SCORE15"
TIMESTAMP = "2026-09-11T00:00:00-07:00"

TARGET_PATH = "bacterial/NBRC_1158.yaml"
TARGET_ID = "CultureMech:007459"
REQUIRED_ACTION = "Recovered composition from source HTML"

SOURCE = "NBRC Medium 1155"
NBRC_URL = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=1155"
TITLE = "TG agar"

Component = tuple[str, str, str]

IMPORTED_INGREDIENT_SIGNATURE: tuple[Component, ...] = (
    ("Tryptone (Diffico)", "10", "G_PER_L"),
    ("Glucose", "3", "G_PER_L"),
    ("Agar", "10", "G_PER_L"),
    ("Distilled water", "1", "L"),
)
...
INGREDIENTS: tuple[dict[str, Any], ...] = (
    _component(
        ...
        "10",
        "G_PER_L",
        notes="NBRC Medium 1155 lists 10 g Tryptone (Diffico).",
    ...
    _component(
        ...
        "3",
        "G_PER_L",
        notes="NBRC Medium 1155 lists 3 g glucose.",
    ...
    _component(
        ...
        "10",
        "G_PER_L",
        notes="NBRC Medium 1155 lists 10 g agar.",
    ...
    _component(
        ...
        "1",
        "L",
        notes="NBRC Medium 1155 lists 1 L distilled water.",
        term=("CHEBI:15377", "water"),
    ),
)

PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    _step(1, "DISSOLVE", "Dissolve Tryptone (Diffico), glucose, and agar in 1 L distilled water."),
    _step(2, "AUTOCLAVE", "Sterilize by autoclaving."),
)

NOTES = (
    "Source: NBRC Medium 1155 | Link: "
    "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=1155\n\n"
    "NBRC lists TG agar with Tryptone (Diffico), glucose, agar, and distilled "
    "water."
)
...
def _ensure_target(doc: dict[str, Any]) -> None:
    ...
    if doc.get("name") not in {"1158", TITLE}:
...
def _ensure_flags(doc: dict[str, Any]) -> None:
    ...
    if any(not _grounded(row) for row in ingredients):
...
def _ensure_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "curator": CURATOR,
        "action": ACTION,
        "changes": "Curated recovered NBRC Medium 1155 TG agar",
        "source": NBRC_URL,
        "notes": (
            "Added the NBRC Medium 1155 source term and official title, "
            "grounded all recovered TG agar ingredients, and converted the "
            "placeholder preparation into source-specific autoclave steps."
        ),
    }
...
def repair_document(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _put_after(
        ...
        "media_term",
        {
            ...
            "term": _term("nbrc.medium:1155", SOURCE),
        },
        "physical_state",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(f"{action} {changed_count} NBRC 1158 records")
    return 0
