#!/usr/bin/env python3
"""Repair KOMODO 9.1 topology rooted at a strain-specific duplicate."""
...
PARENT = Path("bacterial/KOMODO_9_VY_2_AGAR.yaml")
PARENT_ID = "CultureMech:006985"
PARENT_NAME = "vy_2_agar"
PARENT_SOURCE_TERM = "komodo.medium:9"

CHILD = Path("bacterial/for_dsm_11116.yaml")
CHILD_ID = "CultureMech:006764"
CHILD_NAME = "for_dsm_11116"
CHILD_SOURCE_TERM = "komodo.medium:9.1"
RELATIONSHIP = "STRAIN_SPECIFIC_VARIANT"
CHILD_NOTES = "KOMODO Medium 9.1 applies VY/2 AGAR to DSM 11116."

PH = 7.2
INGREDIENT_SIGNATURE = (
    ("Baker's yeast", "5", "G_PER_L"),
    ("CaCl2 x 2 H2O", "1.36", "G_PER_L"),
    ("Vitamin B12", "0.0005", "G_PER_L"),
    ("Agar", "15", "G_PER_L"),
    ("KOH", "variable", "VARIABLE"),
)

CURATOR = "repair_komodo_9_vy2_score10.py"
ACTION = "RESOLVED_KOMODO_9_VY2_TOPOLOGY"
...
def _parent_ref() -> dict[str, str]:
    return {
        ...
        "id": PARENT_ID,
        "name": PARENT_NAME,
        "notes": "KOMODO Medium 9 is the VY/2 AGAR base for Medium 9.1.",
    }
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Promoted KOMODO Medium 9 to the VY/2 AGAR parent",
            "source": "KOMODO Medium 9 and KOMODO Medium 9.1",
            "notes": (
                "Linked the strain-specific KOMODO Medium 9.1 record under "
                "the KOMODO Medium 9 VY/2 AGAR base."
            ),
        },
    )
    return repaired
...
def repair_child(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Linked under KOMODO Medium 9",
            "source": "KOMODO Medium 9.1",
            "notes": CHILD_NOTES,
        },
    )
    return repaired
