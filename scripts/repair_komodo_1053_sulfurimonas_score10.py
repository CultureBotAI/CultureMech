#!/usr/bin/env python3
"""Repair KOMODO 1053.1 SULFURIMONAS PARALVINELLA strain child link."""
...
PARENT = Path("bacterial/KOMODO_1053_SULFURIMONAS_PARALVINELLA_MEDIUM.yaml")
PARENT_ID = "CultureMech:003629"
PARENT_NAME = "sulfurimonas_paralvinella_medium"
PARENT_SOURCE_TERM = "komodo.medium:1053"

CHILD = Path("bacterial/for_dsm_19353.yaml")
CHILD_ID = "CultureMech:003628"
CHILD_SOURCE_TERM = "komodo.medium:1053.1"
RELATIONSHIP = "STRAIN_SPECIFIC_VARIANT"
CHILD_NOTES = "KOMODO Medium 1053.1 applies SULFURIMONAS PARALVINELLA medium to DSM 19353."

PH = 6.5
INGREDIENT_SIGNATURE = (
    ("NaCl", "20.7824", "G_PER_L"),
    ("K2HPO4", "0.0890208", "G_PER_L"),
    ("KH2PO4", "0.0692384", "G_PER_L"),
    ("CaCl2", "0.791296", "G_PER_L"),
    ("NH4Cl", "0.24728", "G_PER_L"),
    ("NaNO3", "0.98912", "G_PER_L"),
    ("MgSO4 x 7 H2O", "6.95648", "G_PER_L"),
    ("MgCl2 x 6 H2O", "2.96736", "G_PER_L"),
    ("KCl", "0.326409", "G_PER_L"),
    ("Fe2(SO4)3 x H2O", "0.0098912", "G_PER_L"),
    ("Na2S2O3 x 5 H2O", "0.98912", "G_PER_L"),
...
CURATOR = "repair_komodo_1053_sulfurimonas_score10.py"
ACTION = "RESOLVED_KOMODO_1053_SULFURIMONAS_TOPOLOGY"
...
def _parent_ref() -> dict[str, str]:
    return {
        ...
        "id": PARENT_ID,
        "name": PARENT_NAME,
        "notes": "KOMODO Medium 1053 is the SULFURIMONAS PARALVINELLA base for this record.",
    }
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Reclassified KOMODO Medium 1053.1 as a strain variant",
            "source": "KOMODO Medium 1053 and 1053.1",
            "notes": (
                "Linked KOMODO Medium 1053.1 under the KOMODO Medium 1053 "
                "SULFURIMONAS PARALVINELLA base."
            ),
        },
    )
    return repaired
...
def repair_child(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Linked under KOMODO Medium 1053",
            "source": "KOMODO Medium 1053.1",
            "notes": CHILD_NOTES,
        },
    )
    return repaired
