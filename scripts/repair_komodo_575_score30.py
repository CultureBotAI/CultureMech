#!/usr/bin/env python3
"""Repair empty KOMODO 575 ANAEROVIBRIO BURKINABENSIS medium."""
...
TARGET = Path("bacterial/anaerovibrio_burkinabensis_medium.yaml")
EXPECTED_ID = "CultureMech:006022"
EXPECTED_MEDIA_TERM = "komodo.medium:575"
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

KOMODO_575_URL = (
    "https://komodo.modelseed.org/servlet/" "KomodoTomcatServerSideUtilitiesModelSeed?MediaInfo=575"
)
DSMZ_575_URL = (
    "https://web.archive.org/web/20121030082653id_/"
    "http://www.dsmz.de/microorganisms/medium/pdf/DSMZ_Medium575.pdf"
)

SOURCE_575 = "Archived DSMZ Medium 575"

CURATOR = "repair_komodo_575_score30.py"
ACTION = "RESOLVED_KOMODO_575_SCORE30"
TIMESTAMP = "2026-09-10T00:00:00-07:00"
NOTES = (
    "Archived DSMZ Medium 575 defines ANAEROVIBRIO BURKINABENSIS MEDIUM as "
    "DSMZ Medium 194 with 2.5 g/L sodium lactate replacing sodium propionate "
    "and with separately sterilized yeast extract at 0.1% final concentration; "
    "this record expands archived DSMZ Media 193, 194, 320, and 141 into final "
    "per-liter components."
)


def _iter_komodo_575_components() -> tuple[Component, ...]:
            ...
            components.extend(
                (
                    Component(
                        ...
                        SOURCE_575,
                        (
                            f"{SOURCE_575} replaces sodium propionate with "
                    ...
                    Component(
                        ...
                        SOURCE_575,
                        (
                            f"{SOURCE_575} adds separately sterilized yeast "
                            "extract to 0.1% final concentration."
                        ),
                    ),
                )
            )
    ...
    components.append(
        Component(
            ...
            (
                ...
                f"additions; {SOURCE_575} replaces the DSMZ Medium 194 "
...
COMPONENTS = _iter_komodo_575_components()
...
def _ensure_references(doc: dict[str, Any]) -> None:
    doc["references"] = [
        {"reference": KOMODO_575_URL},
        {"reference": DSMZ_575_URL},
...
def repair_record(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    repaired["ph_range"] = {"min": 6.8, "max": 7.2}
