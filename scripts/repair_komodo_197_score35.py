#!/usr/bin/env python3
"""Repair empty KOMODO 197 DESULFOCOCCUS MEDIUM."""
...
TARGET = "bacterial/desulfococcus_medium.yaml"
EXPECTED_ID = "CultureMech:004258"
EXPECTED_MEDIA_TERM = "komodo.medium:197"
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

KOMODO_197_URL = (
    "https://komodo.modelseed.org/servlet/" "KomodoTomcatServerSideUtilitiesModelSeed?MediaInfo=197"
)
DSMZ_197_URL = (
    "https://web.archive.org/web/20121030082653id_/"
    "http://www.dsmz.de/microorganisms/medium/pdf/DSMZ_Medium197.pdf"
)
DSMZ_193_URL = (
    "https://web.archive.org/web/20121030082653id_/"
...
SOURCE_197 = "Archived DSMZ Medium 197"
...
CURATOR = "repair_komodo_197_score35.py"
ACTION = "RESOLVED_KOMODO_197_SCORE35"
TIMESTAMP = "2026-09-10T00:00:00-07:00"
NOTES = (
    "Archived DSMZ Medium 197 defines DESULFOCOCCUS MEDIUM as DSMZ Medium "
    "193 with 0.6 g/L sodium benzoate replacing sodium acetate and 3 ug/L "
    "Na2SeO3 x 5 H2O; this record expands archived DSMZ Media 193, 320, "
    "and 141 into final per-liter components."
)
...
COMPONENTS: tuple[Component, ...] = (
    ...
    Component(
        ...
        SOURCE_193,
        _base_note("NaCl", "7.00 g", "6.993007"),
    ),
    Component(
        "MgCl2 x 6 H2O",
        "1.298701",
        ...
        SOURCE_193,
        _base_note("MgCl2 x 6 H2O", "1.30 g", "1.298701"),
    ),
    Component(
        "KCl",
        "0.499500",
    ...
    Component(
        ...
        SOURCE_197,
        f"{SOURCE_197} replaces sodium acetate with 0.6 g/L sodium benzoate.",
    ),
    Component(
        "Biotin",
        "0.0000200",
    ...
    Component(
        ...
        SOURCE_197,
        f"{SOURCE_197} adds 3 ug/L Na2SeO3 x 5 H2O.",
    ),
    Component(
        "CO2",
        "variable",
    ...
    Component(
        ...
        (
            ...
            f"{SOURCE_197} replaces the dissolved acetate with sodium benzoate."
        ),
    ),
)
...
def _ensure_references(doc: dict[str, Any]) -> None:
    ...
    for url in (KOMODO_197_URL, DSMZ_197_URL, DSMZ_193_URL, DSMZ_320_URL, DSMZ_141_URL):
        if url not in found:
...
def _ensure_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "curator": CURATOR,
        "action": ACTION,
        "changes": "Replaced empty KOMODO 197 composition with archived DSMZ data",
        "source": DSMZ_197_URL,
        "notes": NOTES,
    }
