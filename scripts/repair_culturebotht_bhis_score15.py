#!/usr/bin/env python3
"""Normalize CultureBotHT BHIS source provenance for score-15 review."""
...
TARGET = Path("specialized/bhis.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_culturebotht_bhis_score15.py"
ACTION = "NORMALIZED_CULTUREBOTHT_BHIS_SOURCE"
TIMESTAMP = "2026-09-13T00:00:00-07:00"

EXPECTED_ID = "CultureMech:015493"
SOURCE_ID = "BHIS"
...
def _require_target(doc: dict[str, Any]) -> None:
    ...
    if _component_names(doc) != EXPECTED_INGREDIENTS:
        raise ValueError(f"{TARGET}: CultureBotHT BHIS ingredient list drifted")
...
def _ensure_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "curator": CURATOR,
        "action": ACTION,
        "changes": "Normalized BHIS CultureBotHT provenance",
        "source": f"CultureBotHT:{SOURCE_ID}; {CULTUREBOTHT_URL}",
        "notes": (
            "Copied the CultureBotHT BHIS source identity from source_data into the "
