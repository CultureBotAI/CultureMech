#!/usr/bin/env python3
"""Repair KOMODO 2034 Trace element solution (medium 1228)."""
...
TARGET = Path("bacterial/trace_element_solution_medium_1228.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_komodo_2034_score15.py"
ACTION = "RESOLVED_KOMODO_2034_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

EXPECTED_ID = "CultureMech:004305"
EXPECTED_MEDIA_TERM = "komodo.medium:2034"
KOMODO_2034 = (
    "https://komodo.modelseed.org/servlet/KomodoTomcatServerSideUtilitiesModelSeed?MediaInfo=2034"
)
SOURCE = "KOMODO Medium 2034"
...
NOTES = (
    "KOMODO 2034 lists Trace element solution (medium 1228) as a defined "
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "description": (
            ...
            "Na2MoO4 x 2 H2O listed by KOMODO 2034."
        ),
    },
    {
        "step_number": 2,
...
def _component(preferred_term: str, value: str, unit: str) -> dict[str, Any]:
    ...
    if preferred_term == "H2O":
        row["notes"] = (
            ...
            "the solvent for 1 L of Trace element solution (medium 1228)."
        )
...
def _ensure_references(doc: dict[str, Any]) -> None:
    ...
    if not any(row.get("reference") == KOMODO_2034 for row in references if isinstance(row, dict)):
        references.append({"reference": KOMODO_2034})
...
def _append_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            ...
            "2034 metabolite table; preserved HCl as a variable listed "
