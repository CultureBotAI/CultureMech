#!/usr/bin/env python3
"""Repair KOMODO 2041 Trace element solution (medium 315)."""
...
TARGET = Path("bacterial/trace_element_solution_medium_315.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_komodo_2041_score15.py"
ACTION = "RESOLVED_KOMODO_2041_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

EXPECTED_ID = "CultureMech:004313"
EXPECTED_MEDIA_TERM = "komodo.medium:2041"
KOMODO_2041 = (
    "https://komodo.modelseed.org/servlet/KomodoTomcatServerSideUtilitiesModelSeed?MediaInfo=2041"
)
SOURCE = "KOMODO Medium 2041"
...
NOTES = (
    "KOMODO 2041 lists Trace element solution (medium 315) as a defined "
    "submedium at pH 7.0. Its metabolite table contains 3.00 g/L MgSO4 x 7 H2O, "
    "1.50 g/L nitrilotriacetic acid, 1.00 g/L NaCl, 0.50 g/L MnSO4 x H2O, "
    "0.18 g/L CoSO4 x 7 H2O, 0.18 g/L ZnSO4 x 7 H2O, 0.10 g/L CaCl2 x 2 H2O, "
    "0.10 g/L FeSO4 x 7 H2O, 0.02 g/L NiCl2 x 6 H2O, 0.02 g/L "
    "KAl(SO4)2 x 12 H2O, 0.01 g/L CuSO4 x 5 H2O, 0.01 g/L H3BO3, "
    "0.01 g/L Na2MoO4 x 2 H2O, 3.00E-4 g/L Na2SeO3 x 5 H2O, variable KOH, "
    "and H2O."
)
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "description": (
            ...
            "nitrilotriacetic acid, NaCl, the calcium, copper, iron, selenite, "
            "cobalt, borate, molybdate, nickel, alum, manganese, magnesium, and "
            "zinc salts listed by KOMODO 2041."
        ),
    },
    {
        "step_number": 2,
...
def _component(preferred_term: str, value: str, unit: str) -> dict[str, Any]:
    ...
    if preferred_term == "H2O":
        row["notes"] = (
            ...
            "the solvent for 1 L of Trace element solution (medium 315)."
        )
...
def _ensure_references(doc: dict[str, Any]) -> None:
    ...
    if not any(row.get("reference") == KOMODO_2041 for row in references if isinstance(row, dict)):
        references.append({"reference": KOMODO_2041})
...
def _append_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            ...
            "2041 metabolite table; preserved KOH as a variable listed "
