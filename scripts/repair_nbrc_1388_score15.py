#!/usr/bin/env python3
"""Repair the score-15 NBRC Medium 1388 TOGO import."""
...
TARGET = Path("bacterial/togo_medium_m2079.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

EXPECTED_ID = "CultureMech:008668"
EXPECTED_MEDIA_TERM = "TOGO:M2079"

CURATOR = "repair_nbrc_1388_score15.py"
ACTION = "RESOLVED_NBRC_1388_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

TOGO_M2079 = "https://togomedium.org/medium/M2079"
NBRC_1388 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=1388"
SOURCE = "NBRC Medium 1388"

YEAST_EXTRACT = "Yeast extract"
CASAMINO_ACIDS = "Casamino acids"
...
LEGACY_INGREDIENTS: tuple[Component, ...] = (
    ...
    (SODIUM_CHLORIDE, "10", "G_PER_L"),
    (AGAR_IF_NEEDED, "15", "G_PER_L"),
    (CASAMINO_ACIDS, "1", "G_PER_L"),
)
...
REFERENCES = (TOGO_M2079, NBRC_1388)

RECIPE_NOTES = (
    "TOGO M2079 imports NBRC Medium 1388, which lists 5 g/L Yeast "
    "extract, 1 g/L Casamino acids, 10 g/L NaCl, 1 L Distilled water, "
    "and 15 g/L Agar if needed at pH 7.0."
)
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "action": "MIX",
        "description": (
            "Combine 5 g/L Yeast extract, 1 g/L Casamino acids, "
            "10 g/L NaCl, and 1 L Distilled water."
        ),
    },
    {
        "step_number": 2,
        "action": "MIX",
        "description": "Add 15 g/L agar when solid NBRC Medium 1388 is needed.",
    },
    {
        "step_number": 3,
        "action": "ADJUST_PH",
...
def _notes(preferred_term: str, value: str, unit: str) -> str:
    if preferred_term == CASAMINO_ACIDS:
        return (
            f"{SOURCE} lists 1 g/L Casamino acids; this hydrolyzed casein "
            "mixture is retained as an opaque complex component."
        )
...
def _append_curation_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            "Curated TOGO:M2079 from TOGO and NBRC Medium 1388; corrected "
            "Distilled water from a mass-like 1 g/L import to 1 L, added "
            "pH 7.0, grounded yeast extract, sodium chloride, water, and "
            "agar, and retained Casamino acids as a sourced opaque "
            "hydrolyzed-casein component."
        ),
    }
