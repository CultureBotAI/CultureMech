#!/usr/bin/env python3
"""Repair the recovered NBRC Medium 279 TYG record."""
...
CURATOR = "repair_nbrc_280_score15.py"
ACTION = "RESOLVED_NBRC_280_SCORE15"
TIMESTAMP = "2026-09-11T00:00:00-07:00"

TARGET_PATH = "bacterial/NBRC_280.yaml"
TARGET_ID = "CultureMech:007484"
REQUIRED_ACTION = "Recovered composition from source HTML"

SOURCE = "NBRC Medium 279"
NBRC_URL = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=279"
TITLE = "Tryptone Yeast Extract Agar (TYG)"

Component = tuple[str, str, str]

IMPORTED_INGREDIENT_SIGNATURE: tuple[Component, ...] = (
    ("Bacto Tryptone (Difco)", "3", "G_PER_L"),
...
NOTES = (
    "Source: NBRC Medium 279 | Link: "
    "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=279\n\n"
    "NBRC lists Tryptone Yeast Extract Agar (TYG) with Bacto Tryptone "
    "(Difco), yeast extract, glucose, distilled water, and agar at final "
    "pH 7.0."
)
...
def _ensure_flags(doc: dict[str, Any]) -> None:
    ...
    known_unmapped = {"Bacto Tryptone (Difco)", "Yeast extract"}
    chemical_rows = [
        row
        for row in doc.get("ingredients") or []
...
def _ensure_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "curator": CURATOR,
        "action": ACTION,
        "changes": "Grounded recovered NBRC Medium 279 TYG formula",
        "source": NBRC_URL,
        "notes": (
            "Added the NBRC Medium 279 source term and official title, "
...
def repair_document(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _put_after(
        ...
        "media_term",
        {
            ...
            "term": _term("nbrc.medium:279", SOURCE),
        },
        "physical_state",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(f"{action} {changed_count} NBRC 280 records")
    return 0
