#!/usr/bin/env python3
"""Repair TOGO M1935 LB + Kanamycin, Hygromycin medium."""
...
TARGET = Path("bacterial/lb_kanamycin_hygromycin_medium.yaml")
LB_PARENT = Path("bacterial/lb_medium.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_togo_m1935_lb_kanamycin_hygromycin_score15.py"
ACTION = "RESOLVED_TOGO_M1935_LB_KANAMYCIN_HYGROMYCIN_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

EXPECTED_ID = "CultureMech:008513"
EXPECTED_MEDIA_TERM = "TOGO:M1935"
LB_PARENT_ID = "CultureMech:008037"
TOGO_M1935 = "https://togomedium.org/medium/M1935"
NBRC_1202 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=1202"
SOURCE = "TOGO M1935 / NBRC Medium 1202"
...
IMPORTED_SOLUTION_SIGNATURE: tuple[SolutionSignature, ...] = (
    ("Kanamycin solution (20 mg/ml)*", "1", "G_PER_L", ()),
...
KANAMYCIN_SIGNATURE: tuple[Component, ...] = (("Kanamycin", "20.0", "MG_PER_ML"),)

HYGROMYCIN_B_SIGNATURE: tuple[Component, ...] = (("Hygromycin B", "50.0", "MG_PER_ML"),)

FINAL_SOLUTION_SIGNATURE: tuple[SolutionSignature, ...] = (
    ("Kanamycin solution (20 mg/ml)", "1.0", "ML_PER_L", KANAMYCIN_SIGNATURE),
...
NOTES = (
    "TOGO M1935 imports NBRC Medium 1202 LB + Kanamycin, Hygromycin medium. "
    "NBRC 1202 lists the LB base with 1.0 ml/L Kanamycin solution "
    "(20 mg/ml), 3.0 ml/L Hygromycin B solution (50 mg/ml), 15 g/L agar "
...
PARENT_MEDIA = {
    ...
    "name": "lb_medium",
    "notes": (
        "NBRC Medium 1202 supplements LB Medium with 1.0 ml/L Kanamycin "
        "solution (20 mg/ml) and 3.0 ml/L Hygromycin B solution (50 mg/ml), "
...
VARIANT_CHILD = {
    ...
    "relationship": "SUPPLEMENTED_VARIANT",
    "id": EXPECTED_ID,
    "name": "lb_kanamycin_hygromycin_medium",
    "notes": PARENT_MEDIA["notes"],
}

VARIANT_MODIFICATIONS = (
    "Adds 1.0 ml/L Kanamycin solution (20 mg/ml) and 3.0 ml/L Hygromycin B "
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "description": (
            "Sterilize the 20 mg/ml kanamycin and 50 mg/ml hygromycin B stocks "
    ...
    },
    {
        ...
        "action": "MIX",
        "description": (
            "Add 1.0 ml/L filter-sterilized Kanamycin solution (20 mg/ml) and "
...
INGREDIENTS: tuple[dict[str, Any], ...] = (
    _component(
        ...
        "G_PER_L",
        notes=(
            "NBRC Medium 1202 lists Bacto Tryptone (Difco) as a source-disclosed "
...
SOLUTIONS: tuple[dict[str, Any], ...] = (
    {
        "preferred_term": "Kanamycin solution (20 mg/ml)",
        "concentration": {"value": "1.0", "unit": "ML_PER_L"},
        "source": SOURCE,
        "notes": f"{SOURCE} lists 1 ml/L Kanamycin solution (20 mg/ml).",
        ...
        "composition": [
            _component(
                ...
                "20.0",
                "MG_PER_ML",
                notes="NBRC Medium 1202 specifies this stock as 20 mg/ml Kanamycin.",
            )
        ],
        "name": "Kanamycin solution (20 mg/ml)",
    ...
    },
    {
        ...
        "composition": [
            _component(
                ...
                "50.0",
                "MG_PER_ML",
                notes=("NBRC Medium 1202 specifies this stock as 50 mg/ml " "Hygromycin B."),
            )
        ],
...
def _ensure_references(doc: dict[str, Any]) -> None:
    ...
    for reference in (TOGO_M1935, NBRC_1202):
...
def _append_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            ...
            "20 mg/ml kanamycin and 50 mg/ml hygromycin B stocks."
        ),
    }
