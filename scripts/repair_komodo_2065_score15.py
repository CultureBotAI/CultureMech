#!/usr/bin/env python3
"""Repair KOMODO 2065 Trace element solution SL-4 (medium 457)."""
...
TARGET = Path("bacterial/trace_element_solution_sl_4_medium_457.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_komodo_2065_score15.py"
ACTION = "RESOLVED_KOMODO_2065_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

EXPECTED_ID = "CultureMech:004339"
EXPECTED_MEDIA_TERM = "komodo.medium:2065"
KOMODO_2065 = (
    "https://komodo.modelseed.org/servlet/KomodoTomcatServerSideUtilitiesModelSeed?MediaInfo=2065"
)
SOURCE = "KOMODO Medium 2065"
...
FINAL_INGREDIENT_SIGNATURE: tuple[Component, ...] = (
    ...
    ("NiCl2 x 6 H2O", "2.00E-3", "G_PER_L"),
    ("H2O", "1.0", "L"),
    ("EDTA", "0.50", "G_PER_L"),
    ("ZnSO4 x 7 H2O", "0.01", "G_PER_L"),
    ("MnCl2 x 4 H2O", "3.00E-3", "G_PER_L"),
    ("FeSO4 x 7 H2O", "0.20", "G_PER_L"),
    ("CuCl2 x 2 H2O", "1.00E-3", "G_PER_L"),
...
PH_RANGE: dict[str, float] = {"min": 7.0, "max": 8.0}

NOTES = (
    "KOMODO 2065 lists Trace element solution SL-4 (medium 457) as a defined "
    "submedium at pH 7.0-8.0. Its metabolite table contains 0.50 g/L EDTA, "
    "0.20 g/L FeSO4 x 7 H2O, 0.03 g/L H3BO3, 0.02 g/L CoCl2 x 6 H2O, "
    "0.01 g/L ZnSO4 x 7 H2O, 3.00E-3 g/L MnCl2 x 4 H2O, "
    "3.00E-3 g/L Na2MoO4 x 2 H2O, 2.00E-3 g/L NiCl2 x 6 H2O, "
    "1.00E-3 g/L CuCl2 x 2 H2O, variable NaOH, and H2O."
)
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "action": "MIX",
        "description": (
            "Prepare the 1 L Trace element solution SL-4 stock from H2O, "
            "EDTA, NaOH, and the cobalt, nickel, zinc, manganese, iron, "
            "copper, molybdate, and borate salts listed by KOMODO 2065."
        ),
    },
    {
        "step_number": 2,
...
def _component(preferred_term: str, value: str, unit: str) -> dict[str, Any]:
    ...
    if preferred_term == "H2O":
        row["notes"] = (
            ...
            "the solvent for 1 L of Trace element solution SL-4 (medium 457)."
        )
    elif preferred_term == "NaOH":
        row["notes"] = (
            f"{SOURCE} lists NaOH without a gram amount and also identifies "
            "NaOH as the pH adjuster for pH 7.0-8.0."
        )
...
def _ensure_references(doc: dict[str, Any]) -> None:
    ...
    if not any(row.get("reference") == KOMODO_2065 for row in references if isinstance(row, dict)):
        references.append({"reference": KOMODO_2065})
...
def _append_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            ...
            "2065 metabolite table; preserved NaOH as a variable listed "
