#!/usr/bin/env python3
"""Repair KOMODO 2047 Trace element solution (medium 574)."""
...
TARGET = Path("bacterial/trace_element_solution_medium_574.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_komodo_2047_score15.py"
ACTION = "RESOLVED_KOMODO_2047_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

EXPECTED_ID = "CultureMech:004319"
EXPECTED_MEDIA_TERM = "komodo.medium:2047"
KOMODO_2047 = (
    "https://komodo.modelseed.org/servlet/KomodoTomcatServerSideUtilitiesModelSeed?MediaInfo=2047"
)
SOURCE = "KOMODO Medium 2047"
...
FINAL_INGREDIENT_SIGNATURE: tuple[Component, ...] = (
    ("CoCl2 x 6 H2O", "1.60", "G_PER_L"),
    ("CaCl2 x 2 H2O", "5.50", "G_PER_L"),
    ("H2O", "1.0", "L"),
    ("ZnSO4 x 7 H2O", "2.20", "G_PER_L"),
    ("KOH", "variable", "VARIABLE"),
    ("CuSO4 x 5 H2O", "1.60", "G_PER_L"),
    ("MnCl2 x 4 H2O", "5.10", "G_PER_L"),
...
NOTES = (
    "KOMODO 2047 lists Trace element solution (medium 574) as a defined "
    "submedium at pH 6.0. Its metabolite table contains 50.00 g/L Na2-EDTA, "
    "5.50 g/L CaCl2 x 2 H2O, 5.10 g/L MnCl2 x 4 H2O, 5.00 g/L FeSO4 x 7 H2O, "
    "2.20 g/L ZnSO4 x 7 H2O, 1.60 g/L CoCl2 x 6 H2O, "
    "1.60 g/L CuSO4 x 5 H2O, 1.10 g/L (NH4)6 Mo7O24 x 4 H2O, variable KOH, "
    "and H2O."
)
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "description": (
            ...
            "molybdate salts listed by KOMODO 2047."
        ),
    },
    {
        "step_number": 2,
...
def _component(preferred_term: str, value: str, unit: str) -> dict[str, Any]:
    ...
    if preferred_term == "H2O":
        row["notes"] = (
            ...
            "the solvent for 1 L of Trace element solution (medium 574)."
        )
...
def _ensure_references(doc: dict[str, Any]) -> None:
    ...
    if not any(row.get("reference") == KOMODO_2047 for row in references if isinstance(row, dict)):
        references.append({"reference": KOMODO_2047})
...
def _append_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            ...
            "2047 metabolite table; preserved KOH as a variable listed "
