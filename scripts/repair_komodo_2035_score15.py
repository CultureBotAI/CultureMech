#!/usr/bin/env python3
"""Repair KOMODO 2035 Trace element solution (medium 1229)."""
...
TARGET = Path("bacterial/trace_element_solution_medium_1229.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_komodo_2035_score15.py"
ACTION = "RESOLVED_KOMODO_2035_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

EXPECTED_ID = "CultureMech:004306"
EXPECTED_MEDIA_TERM = "komodo.medium:2035"
KOMODO_2035 = (
    "https://komodo.modelseed.org/servlet/KomodoTomcatServerSideUtilitiesModelSeed?MediaInfo=2035"
)
SOURCE = "KOMODO Medium 2035"
...
FINAL_INGREDIENT_SIGNATURE: tuple[Component, ...] = (
    ...
    ("EDTA", "5.00E-3", "G_PER_L"),
    ("MnCl2 x 4 H2O", "0.03", "G_PER_L"),
    ("FeSO4 x 7 H2O", "2.00E-3", "G_PER_L"),
...
NOTES = (
    "KOMODO 2035 lists Trace element solution (medium 1229) as a defined "
    "submedium at pH 3.0. Its metabolite table contains 0.30 g/L H3BO3, "
    "0.20 g/L CoCl2 x 6 H2O, 0.10 g/L ZnSO4 x 7 H2O, 0.03 g/L MnCl2 x 4 H2O, "
    "0.03 g/L Na2MoO4 x 2 H2O, 0.02 g/L NiCl2 x 6 H2O, 0.01 g/L CuCl2 x 2 H2O, "
    "5.00E-3 g/L EDTA, 2.00E-3 g/L FeSO4 x 7 H2O, variable HCl, and H2O."
)
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "action": "MIX",
        "description": (
            "Prepare the 1 L Trace element solution stock from H2O, HCl, EDTA, "
            "the chloride salts, ZnSO4 x 7 H2O, FeSO4 x 7 H2O, H3BO3, and "
            "Na2MoO4 x 2 H2O listed by KOMODO 2035."
        ),
    },
    {
        "step_number": 2,
        "action": "ADJUST_PH",
        "description": "Adjust the Trace element solution stock to pH 3.0 with HCl as needed.",
    },
)
...
def _component(preferred_term: str, value: str, unit: str) -> dict[str, Any]:
    ...
    if preferred_term == "H2O":
        row["notes"] = (
            ...
            "the solvent for 1 L of Trace element solution (medium 1229)."
        )
...
def _ensure_references(doc: dict[str, Any]) -> None:
    ...
    if not any(row.get("reference") == KOMODO_2035 for row in references if isinstance(row, dict)):
        references.append({"reference": KOMODO_2035})
...
def _append_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            ...
            "2035 metabolite table; preserved HCl as a variable listed "
