#!/usr/bin/env python3
"""Repair the score-15 NBRC Medium 248 TOGO import."""
...
TARGET = Path("bacterial/togo_medium_m1469.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

EXPECTED_ID = "CultureMech:008011"
EXPECTED_MEDIA_TERM = "TOGO:M1469"

CURATOR = "repair_nbrc_248_score15.py"
ACTION = "RESOLVED_NBRC_248_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

TOGO_M1469 = "https://togomedium.org/medium/M1469"
NBRC_248 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=248"
SOURCE = "NBRC Medium 248"
...
LEGACY_SOLUTIONS: tuple[SolutionSignature, ...] = (("Na2CO3*", "10", "G_PER_L", ()),)
...
PHYSICOCHEMICAL_ROLES: dict[str, tuple[str, ...]] = {
    ...
    SODIUM_CARBONATE: ("BUFFER",),
}
UNIT_LABELS = {
    "G_PER_L": "g/L",
    "ML_PER_L": "ml/L",
}
PH_RANGE = {"min": 9.0, "max": 10.0}
REFERENCES = (TOGO_M1469, NBRC_248)

RECIPE_NOTES = (
    "TOGO M1469 imports NBRC Medium 248, which lists 4 g/L Yeast extract, "
    "10 g/L Malt extract, 4 g/L Glucose, 10 g/L Na2CO3, 1000 ml/L "
    "Distilled water, and 20 g/L Agar if needed. NBRC lists pH 9.0 to "
    "10.0 and instructs that Na2CO3 is sterilized separately."
)
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "description": (
            ...
            "Glucose, and 1000 ml/L Distilled water."
        ),
    },
    {
        "step_number": 2,
        "action": "MIX",
        "description": "Add 10 g/L Na2CO3 sterilized separately.",
    },
    {
        "step_number": 3,
        "action": "MIX",
        "description": "Add 20 g/L agar when solid NBRC Medium 248 is needed.",
    },
    {
        "step_number": 4,
        "action": "ADJUST_PH",
        "description": "Adjust pH to 9.0 to 10.0.",
    },
)
...
def _notes(preferred_term: str, value: str, unit: str) -> str:
    ...
    if preferred_term == SODIUM_CARBONATE:
        return f"{SOURCE} lists {value} {UNIT_LABELS[unit]} Na2CO3 sterilized separately."
...
def _ensure_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            "Curated TOGO:M1469 from TOGO and NBRC Medium 248; corrected "
            "Distilled water from a mass-like 1 g/L import to 1000 ml/L, "
            "moved Na2CO3 from the false empty solution into the final "
            "formula, added pH 9.0 to 10.0, and grounded all components."
        ),
    }
