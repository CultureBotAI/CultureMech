#!/usr/bin/env python3
"""Repair the score-15 NBRC Medium 802 TOGO import."""
...
TARGET = Path("bacterial/togo_medium_m1603.yaml")
PARENT = Path("bacterial/TOGO_M1553_Methylobacterium_Medium.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

EXPECTED_ID = "CultureMech:008156"
EXPECTED_PARENT_ID = "CultureMech:008102"
EXPECTED_MEDIA_TERM = "TOGO:M1603"
EXPECTED_PARENT_MEDIA_TERM = "TOGO:M1553"

CURATOR = "repair_nbrc_802_score15.py"
ACTION = "RESOLVED_NBRC_802_SCORE15"
LINK_ACTION = "LINKED_NBRC_802_METHYLOBACTERIUM_VARIANT"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

TOGO_M1603 = "https://togomedium.org/medium/M1603"
NBRC_802 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=802"
SOURCE = "NBRC Medium 802"
...
LEGACY_SOLUTIONS: tuple[SolutionSignature, ...] = ((HIPOLYPEPTON, "10", "G_PER_L", ()),)
...
REFERENCES = (TOGO_M1603, NBRC_802)

VARIANT_MODIFICATIONS = (
    "Omits the 5 ml/L separately filter-sterilized methanol supplement from TOGO M1553.",
)
VARIANT_NOTES = "Omits the 5 ml/L methanol supplement from TOGO M1553."
PARENT_MEDIA = {
...
RECIPE_NOTES = (
    "TOGO M1603 imports NBRC Medium 802, which lists 10 g/L Hipolypepton "
    "from FUJIFILM Wako Pure Chemical Corporation, 2 g/L Yeast extract, "
    "1 g/L MgSO4·7H2O, 1 L Distilled water, and 15 g/L Agar if needed "
    "at pH 7.0."
)
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        "step_number": 2,
        "action": "MIX",
        "description": "Add 15 g/L agar when solid NBRC Medium 802 is needed.",
    },
    {
        "step_number": 3,
        "action": "ADJUST_PH",
...
def _notes(preferred_term: str, value: str, unit: str) -> str:
    ...
    if preferred_term == HIPOLYPEPTON:
        return (
            ...
            "notes that the asterisk marks FUJIFILM Wako Pure Chemical "
            "Corporation; this peptone product is retained as an opaque "
            "complex component."
        )
...
def repair_target(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _append_curation_event(
        ...
        action=ACTION,
        notes=(
            "Curated TOGO:M1603 from TOGO and current NBRC Medium 802; "
            "corrected Distilled water from a mass-like 1 g/L import to "
            "1 L, moved Hipolypepton from a migrated empty solution to a "
            "sourced formula ingredient, added pH 7.0, grounded yeast "
            "extract, magnesium sulfate heptahydrate, water, and agar, "
            "retained Hipolypepton as a sourced opaque component, and "
            "linked M1603 to M1553 as an omitted-component variant."
        ),
    )
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _append_curation_event(
        repaired,
        action=LINK_ACTION,
        notes="Linked NBRC Medium 802 as an omitted-component Methylobacterium Medium variant.",
    )
    return repaired
