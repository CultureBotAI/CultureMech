#!/usr/bin/env python3
"""Repair TOGO M2050 LB + Ampicillin, Kanamycin medium."""
...
TARGET = Path("bacterial/lb_ampicillin_kanamycin_medium.yaml")
LB_PARENT = Path("bacterial/lb_medium.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_togo_m2050_lb_ampicillin_kanamycin_score15.py"
ACTION = "RESOLVED_TOGO_M2050_LB_AMPICILLIN_KANAMYCIN_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

EXPECTED_ID = "CultureMech:008641"
EXPECTED_MEDIA_TERM = "TOGO:M2050"
LB_PARENT_ID = "CultureMech:008037"
TOGO_M2050 = "https://togomedium.org/medium/M2050"
NBRC_1350 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=1350"
SOURCE = "TOGO M2050 / NBRC Medium 1350"
...
NOTES = (
    "TOGO M2050 imports NBRC Medium 1350 LB + Ampicillin, Kanamycin medium. "
    "NBRC 1350 lists a high-salt LB base with 10 g/L Bacto Tryptone (Difco), "
    "5 g/L yeast extract, 10 g/L NaCl, 1.0 ml/L Ampicillin solution "
    "(50 mg/ml), 1.0 ml/L Kanamycin solution (50 mg/ml), 15 g/L agar "
...
PARENT_MEDIA = {
    ...
    "name": "lb_medium",
    "notes": (
        "NBRC Medium 1350 increases NaCl from 5 g/L to 10 g/L and supplements "
        "LB Medium with separately filter-sterilized 1.0 ml/L Ampicillin "
        "solution (50 mg/ml) and 1.0 ml/L Kanamycin solution (50 mg/ml)."
    ),
}
...
VARIANT_CHILD = {
    ...
    "relationship": "SUPPLEMENTED_VARIANT",
    "id": EXPECTED_ID,
    "name": "lb_ampicillin_kanamycin_medium",
    "notes": PARENT_MEDIA["notes"],
}

VARIANT_MODIFICATIONS = (
    "Increases NaCl from 5 g/L to 10 g/L and adds 1.0 ml/L Ampicillin solution "
    "(50 mg/ml) plus 1.0 ml/L Kanamycin solution (50 mg/ml) after separate "
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "action": "MIX",
        "description": (
            "Prepare the high-salt LB base from 10 g/L Bacto Tryptone (Difco), "
            "5 g/L yeast extract, 10 g/L NaCl, 1000 ml/L distilled water, and "
            "15 g/L agar if needed."
        ),
    },
    {
        "step_number": 2,
        ...
        "description": (
            "Sterilize the 50 mg/ml ampicillin and 50 mg/ml kanamycin stocks "
    ...
    },
    {
        ...
        "description": (
            ...
            "(50 mg/ml) and Kanamycin solution (50 mg/ml) to the high-salt "
            "LB base."
        ),
    },
)
...
INGREDIENTS: tuple[dict[str, Any], ...] = (
    _component(
        ...
        "G_PER_L",
        notes=(
            "NBRC Medium 1350 lists Bacto Tryptone (Difco) as a source-disclosed "
            "digest product not reducible to one ChEBI molecule."
        ),
    ),
    _component("Yeast extract", "5", "G_PER_L"),
    _component("NaCl", "10", "G_PER_L"),
...
SOLUTIONS: tuple[dict[str, Any], ...] = (
    {
        ...
        "composition": [
            _component(
                ...
                "50.0",
                "MG_PER_ML",
                notes="NBRC Medium 1350 specifies this stock as 50 mg/ml Ampicillin.",
            )
        ],
    ...
    },
    {
        ...
        "composition": [
            _component(
                ...
                "50.0",
                "MG_PER_ML",
                notes="NBRC Medium 1350 specifies this stock as 50 mg/ml Kanamycin.",
            )
        ],
...
def _ensure_references(doc: dict[str, Any]) -> None:
    ...
    for reference in (TOGO_M2050, NBRC_1350):
...
def _append_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            ...
            "ampicillin and kanamycin stocks."
        ),
    }
