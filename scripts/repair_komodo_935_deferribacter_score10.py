#!/usr/bin/env python3
"""Repair KOMODO 935 Deferribacter exact and strain child links."""
...
PARENT = Path("bacterial/deferribacter_desulfuricans_medium.yaml")
PARENT_ID = "CultureMech:002109"
PARENT_NAME = "deferribacter_desulfuricans_medium"
PARENT_SOURCE_TERM = "mediadive.medium:935a"
...
SIGNATURE = (
    ...
    ("NaCl", "25.728", "G_PER_L"),
    ("KNO3", "0.49456", "G_PER_L"),
    ("Na-acetate", "0.791296", "G_PER_L"),
    ("Yeast extract", "0.49456", "G_PER_L"),
    ("Na2CO3", "0.49456", "G_PER_L"),
    ("Na2S", "0.296736", "G_PER_L"),
...
CHILDREN = (
    Child(
        Path("bacterial/KOMODO_935_DEFERRIBACTER_medium.yaml"),
        "CultureMech:006857",
        "komodo.medium:935",
        "KOMODO Medium 935",
        SOURCE_DUPLICATE_RELATIONSHIP,
        "KOMODO Medium 935 has the same 34-ingredient signature as DSMZ Medium 935a.",
    ),
    Child(
        Path("bacterial/for_dsm_14813.yaml"),
        "CultureMech:006856",
        "komodo.medium:935.1",
        "KOMODO Medium 935.1",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 935.1 applies DSMZ Medium 935a to DSM 14813.",
    ),
    Child(
        Path("bacterial/medium_935_modified_for_dsm_14783.yaml"),
        "CultureMech:006855",
        "komodo.medium:935_14783",
        "KOMODO Medium 935_14783",
        STRAIN_RELATIONSHIP,
        "KOMODO Medium 935_14783 applies DSMZ Medium 935a to DSM 14783.",
    ),
)
CHILD_BY_PATH = {child.path: child for child in CHILDREN}
EXPECTED_CHILD_COUNT = 3

CURATOR = "repair_komodo_935_deferribacter_score10.py"
ACTION = "RESOLVED_KOMODO_935_DEFERRIBACTER_TOPOLOGY"
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Re-rooted KOMODO Medium 935 exact topology under DSMZ Medium 935a",
            "source": "DSMZ Medium 935a; KOMODO Medium 935, 935.1, 935_14783",
            "notes": (
                "Left DSMZ Medium 935 out because it has a distinct 31-ingredient "
                "signature from the 34-ingredient DSMZ Medium 935a group."
            ),
        },
    )
    return repaired
...
def repair_child(relative_path: Path, doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": f"Linked under DSMZ Medium 935a as {child.relationship}",
