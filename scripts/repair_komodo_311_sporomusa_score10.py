#!/usr/bin/env python3
"""Repair exact KOMODO 311 Sporomusa strain child links."""
...
PARENT = Path("bacterial/KOMODO_311_SPOROMUSA_medium.yaml")
PARENT_ID = "CultureMech:004964"
PARENT_NAME = "sporomusa_medium"
PARENT_SOURCE_TERM = "komodo.medium:311"
STRAIN_RELATIONSHIP = "STRAIN_SPECIFIC_VARIANT"

INGREDIENT_SIGNATURE = (
    ("NH4Cl", "0.497512", "G_PER_L"),
    ("MgSO4 x 7 H2O", "0.497512", "G_PER_L"),
    ("CaCl2 x 2 H2O", "0.248756", "G_PER_L"),
    ("NaCl", "24.8756", "G_PER_L"),
    ("FeSO4 x 7 H2O", "0.00199005", "G_PER_L"),
    ("Yeast extract", "1.99005", "G_PER_L"),
    ("Casitone", "1.99005", "G_PER_L"),
    ("Betaine x H2O", "6.66667", "G_PER_L"),
    ("Sodium resazurin", "0.000497512", "G_PER_L"),
    ("K2HPO4", "0.348259", "G_PER_L"),
    ("KH2PO4", "0.228856", "G_PER_L"),
    ("Na2CO3", "1.49254", "G_PER_L"),
    ("L-Cysteine HCl x H2O", "0.298507", "G_PER_L"),
    ("Na2S x 9 H2O", "0.298507", "G_PER_L"),
    ("HCl", "2.5", "G_PER_L"),
...
CHILDREN = (
    Child(
        Path("bacterial/for_dsm_3132.yaml"),
        "CultureMech:004949",
        "komodo.medium:311.1",
        "KOMODO Medium 311.1",
        "KOMODO Medium 311.1 applies KOMODO Medium 311 to DSM 3132.",
    ),
    Child(
        Path("bacterial/for_dsm_4440.yaml"),
        "CultureMech:004951",
        "komodo.medium:311.2",
        "KOMODO Medium 311.2",
        "KOMODO Medium 311.2 applies KOMODO Medium 311 to DSM 4440.",
    ),
    Child(
        Path("bacterial/for_dsm_16652.yaml"),
        "CultureMech:004952",
        "komodo.medium:311.3",
        "KOMODO Medium 311.3",
        "KOMODO Medium 311.3 applies KOMODO Medium 311 to DSM 16652.",
    ),
    Child(
        Path("bacterial/medium_311_modified_for_dsm_2767.yaml"),
        "CultureMech:004950",
        "komodo.medium:311_2767",
        "KOMODO Medium 311_2767",
        "KOMODO Medium 311_2767 applies KOMODO Medium 311 to DSM 2767.",
    ),
    Child(
        Path("bacterial/medium_311_modified_for_dsm_5090.yaml"),
        "CultureMech:004953",
        "komodo.medium:311_5090",
        "KOMODO Medium 311_5090",
        "KOMODO Medium 311_5090 applies KOMODO Medium 311 to DSM 5090.",
    ),
)
CHILD_BY_PATH = {child.path: child for child in CHILDREN}
EXPECTED_CHILD_COUNT = 5

CURATOR = "repair_komodo_311_sporomusa_score10.py"
ACTION = "RESOLVED_KOMODO_311_SPOROMUSA_TOPOLOGY"
...
def repair_parent(doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Linked exact KOMODO Medium 311 DSM strain wrappers",
            "source": "KOMODO Medium 311 and exact 311 strain wrapper records",
            "notes": (
                "Left KOMODO 311a and MediaDive 311/311b records out because this "
                "pass only links exact KOMODO Medium 311 source terms."
            ),
        },
    )
    return repaired
...
def repair_child(relative_path: Path, doc: dict[str, Any]) -> dict[str, Any]:
    ...
    _upsert_event(
        repaired,
        {
            ...
            "curator": CURATOR,
            "action": ACTION,
            "changes": "Linked under KOMODO Medium 311 as STRAIN_SPECIFIC_VARIANT",
