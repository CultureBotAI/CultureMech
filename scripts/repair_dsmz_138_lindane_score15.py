#!/usr/bin/env python3
"""Repair DSMZ Medium 138 Lindane Medium and its KOMODO duplicate."""
...
CURATOR = "repair_dsmz_138_lindane_score15.py"
ACTION = "RESOLVED_DSMZ_138_LINDANE_SCORE15"
TIMESTAMP = "2026-09-11T00:00:00-07:00"

DSMZ_138 = "https://www.dsmz.de/microorganisms/medium/pdf/DSMZ_Medium138.pdf"
SOURCE = "DSMZ Medium 138"

Component = tuple[str, str, str]

IMPORTED_INGREDIENT_SIGNATURE: tuple[Component, ...] = (
    ("Yeast extract", "5", "G_PER_L"),
    ("Hexachlorocyclo-hexane", "0.1", "G_PER_L"),
)
...
TARGETS: tuple[Target, ...] = (
    Target(
        path="bacterial/lindane_medium.yaml",
        expected_id="CultureMech:000850",
        expected_source_term="mediadive.medium:138",
    ),
    Target(
        path="bacterial/KOMODO_138_LINDANE_medium.yaml",
        expected_id="CultureMech:004112",
        expected_source_term="komodo.medium:138",
    ),
)
...
INGREDIENTS: tuple[dict[str, Any], ...] = (
    _component(
        ...
        "5.0",
        "G_PER_L",
        notes="DSMZ Medium 138 lists 5.0 g yeast extract.",
    ...
    _component(
        ...
        "0.1",
        "G_PER_L",
        notes="DSMZ Medium 138 lists 0.1 g hexachlorocyclo-hexane (lindane).",
        term=("CHEBI:24536", "hexachlorocyclohexane"),
    ),
    _component(
        "Distilled water",
        "1000.0",
        "ML_PER_L",
        notes="DSMZ Medium 138 lists 1000.0 ml distilled water.",
        term=("CHEBI:15377", "water"),
    ),
)

PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    _step(1, "ADJUST_PH", "Adjust DSMZ Medium 138 to pH 7.0."),
)

NOTES = (
    "DSMZ Medium 138 lists yeast extract, hexachlorocyclo-hexane (lindane), "
    "distilled water, and pH 7.0."
)
...
def _ensure_references(doc: dict[str, Any]) -> None:
    ...
    if DSMZ_138 not in existing:
        references.append({"reference": DSMZ_138})
