#!/usr/bin/env python3
"""Repair TOGO M1685 LB + Ampicillin medium."""
...
TARGET = Path("bacterial/lb_ampicillin_medium.yaml")
LB_PARENT = Path("bacterial/lb_medium.yaml")
STALE_PARENT = Path("bacterial/lb_kanamycin_medium.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_togo_m1685_lb_ampicillin_score15.py"
ACTION = "RESOLVED_TOGO_M1685_LB_AMPICILLIN_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

EXPECTED_ID = "CultureMech:008244"
EXPECTED_MEDIA_TERM = "TOGO:M1685"
LB_PARENT_ID = "CultureMech:008037"
STALE_PARENT_ID = "CultureMech:008515"
TOGO_M1685 = "https://togomedium.org/medium/M1685"
NBRC_890 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=890"
SOURCE = "TOGO M1685 / NBRC Medium 890"
...
IMPORTED_SOLUTION_SIGNATURE: tuple[SolutionSignature, ...] = (
    ("Sodium ampicillin solution (50 mg/ml)*", "1", "G_PER_L", ()),
)
...
GROUNDINGS: dict[str, tuple[str, str]] = {
    ...
    "Sodium ampicillin": ("CHEBI:34535", "Na-ampicillin"),
...
NOTES = (
    "TOGO M1685 imports NBRC Medium 890 LB + Ampicillin medium. NBRC 890 "
    "lists the LB base with 1.0 ml/L Sodium ampicillin solution (50 mg/ml), "
...
PARENT_MEDIA = {
    ...
    "name": "lb_medium",
    "notes": (
        "NBRC Medium 890 supplements LB Medium with 1.0 ml/L separately "
        "filter-sterilized Sodium ampicillin solution (50 mg/ml)."
    ),
}
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "action": "MIX",
        "description": (
            "Add 1.0 ml/L filter-sterilized Sodium ampicillin solution "
...
INGREDIENTS: tuple[dict[str, Any], ...] = (
    _component(
        ...
        "G_PER_L",
        notes=(
            "NBRC Medium 890 lists Bacto Tyrptone (Difco) as a source-disclosed "
...
SOLUTIONS: tuple[dict[str, Any], ...] = (
    {
        "preferred_term": "Sodium ampicillin solution (50 mg/ml)",
        "concentration": {"value": "1.0", "unit": "ML_PER_L"},
        "source": SOURCE,
        "notes": f"{SOURCE} lists 1 ml/L Sodium ampicillin solution (50 mg/ml).",
        "term": _term(*GROUNDINGS["Sodium ampicillin"]),
        "mediaingredientmech_chebi_term": _term(*GROUNDINGS["Sodium ampicillin"]),
        "composition": [
            _component(
                "Sodium ampicillin",
                "50.0",
...
def _ensure_references(doc: dict[str, Any]) -> None:
    ...
    for reference in (TOGO_M1685, NBRC_890):
...
def _append_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "curator": CURATOR,
        "action": ACTION,
        "source": f"{TOGO_M1685}; {NBRC_890}",
        "notes": (
            f"{NOTES} Corrected the imported distilled-water row from a g/L artifact "
            "to an ml/L volume, nested the 50 mg/ml sodium ampicillin stock, and "
