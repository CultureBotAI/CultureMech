#!/usr/bin/env python3
"""Repair the score-15 NBRC Medium 1227 TOGO import."""
...
TARGET = Path("bacterial/togo_medium_m1952.yaml")
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

EXPECTED_ID = "CultureMech:008532"
EXPECTED_MEDIA_TERM = "TOGO:M1952"

CURATOR = "repair_nbrc_1227_score15.py"
ACTION = "RESOLVED_NBRC_1227_SCORE15"
TIMESTAMP = "2026-09-12T00:00:00-07:00"

TOGO_M1952 = "https://togomedium.org/medium/M1952"
NBRC_1227 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=1227"
SOURCE = "NBRC Medium 1227"
...
LEGACY_INGREDIENTS: tuple[Component, ...] = (
    ...
    (GLUCOSE, "7.5", "G_PER_L"),
    (AGAR_IF_NEEDED, "8", "G_PER_L"),
)

LEGACY_SOLUTIONS: tuple[SolutionSignature, ...] = (
    (ETHANOL, "30", "G_PER_L", ()),
    (ACETIC_ACID, "30", "G_PER_L", ()),
    (HIPOLYPEPTON, "4", "G_PER_L", ()),
)
...
GROUNDINGS: dict[str, tuple[str, str]] = {
    ACETIC_ACID: ("CHEBI:15366", "acetic acid"),
...
REFERENCES = (TOGO_M1952, NBRC_1227)

RECIPE_NOTES = (
    "TOGO M1952 imports NBRC Medium 1227, which lists 4 g/L "
    "Hipolypepton from Wako Pure Chemical Industries, 3 g/L Yeast "
    "extract, 7.5 g/L Glucose, 30 ml/L Acetic acid, 30 ml/L Ethanol, "
    "8 g/L Agar if needed, and 1 L Distilled water with pH unadjusted. "
    "Acetic acid and ethanol are sterilized separately by filtration."
)
...
PREPARATION_STEPS: tuple[dict[str, Any], ...] = (
    {
        ...
        "action": "MIX",
        "description": (
            "Combine 4 g/L Hipolypepton, 3 g/L Yeast extract, "
            "7.5 g/L Glucose, and 1 L Distilled water."
        ),
    },
    {
        "step_number": 2,
        "action": "MIX",
        "description": "Add 8 g/L agar when solid NBRC Medium 1227 is needed.",
    },
    {
        "step_number": 3,
        "action": "FILTER_STERILIZE",
        "description": "Sterilize Acetic acid and Ethanol separately by filtration.",
    },
    {
        "step_number": 4,
        "action": "MIX",
        "description": "Add 30 ml/L Acetic acid and 30 ml/L Ethanol.",
    },
    {
        "step_number": 5,
        "action": "MIX",
        "description": "Leave pH unadjusted.",
    },
)
...
def _notes(preferred_term: str, value: str, unit: str) -> str:
    if preferred_term == HIPOLYPEPTON:
        return (
            f"{SOURCE} lists 4 g/L Hipolypepton and notes that the asterisk "
            "marks Wako Pure Chemical Industries; this peptone product is "
            "retained as an opaque complex component."
        )
    if preferred_term in {ACETIC_ACID, ETHANOL}:
        bare_name = preferred_term.removesuffix("**")
        return (
            f"{SOURCE} lists {value} {UNIT_LABELS[unit]} {bare_name} and "
            "notes that the double asterisk marks separate filter "
            "sterilization."
        )
...
def _ensure_target(doc: dict[str, Any]) -> None:
    ...
    if solution_signatures not in {LEGACY_SOLUTIONS, ()}:
...
def _append_curation_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            "Curated TOGO:M1952 from TOGO and NBRC Medium 1227; "
            "corrected Distilled water from a mass-like 1 g/L import to "
            "1 L, moved Hipolypepton, Acetic acid, and Ethanol from "
            "migrated empty solutions to the formula, corrected Acetic "
            "acid and Ethanol from g/L to ml/L, added the unadjusted pH "
            "endpoint, grounded yeast extract, glucose, acetic acid, "
            "ethanol, water, and agar, and retained Hipolypepton as a "
