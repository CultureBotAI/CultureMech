#!/usr/bin/env python3
"""Add reciprocal links for repaired KOMODO strain-specific variants."""
...
CURATOR = "repair_komodo_strain_backlinks.py"
ACTION = "ADDED_KOMODO_STRAIN_BACKLINKS"
...
KOMODO_131 = Parent(
    Path("archaea/KOMODO_131_METHANOBACTERIUM_THERMOAUTOTROPHICUM_MEDIUM.yaml"),
    "CultureMech:004074",
    "methanobacterium_thermoautotrophicum_medium",
    "komodo.medium:131",
)
KOMODO_777 = Parent(
    Path("bacterial/sporomusa_silvacetica_medium.yaml"),
    "CultureMech:006435",
    "sporomusa_silvacetica_medium",
    "komodo.medium:777",
)

CHILDREN = (
    Child(
        Path("bacterial/medium_131_modified_for_dsm_6216.yaml"),
        "CultureMech:004066",
        "medium_131_modified_for_dsm_6216",
        "komodo.medium:131_6216",
        KOMODO_131,
    ),
    Child(
        Path("bacterial/medium_777_modified_for_dsm_14980.yaml"),
        "CultureMech:006434",
        "medium_777_modified_for_dsm_14980",
        "komodo.medium:777_14980",
        KOMODO_777,
    ),
)
PARENTS = (KOMODO_131, KOMODO_777)
...
def _upsert_event(doc: dict[str, Any], parent: Parent) -> None:
    event = {
        ...
        "notes": "Mirrored curated KOMODO parent_media links on the parent record.",
    }
...
def _require_child(child: Child, doc: dict[str, Any]) -> None:
    ...
    if doc.get("parent_media") != _parent_ref(child):
