#!/usr/bin/env python3
"""Repair TOGO M1553 Methylobacterium Medium."""
...
TARGET = Path("bacterial/TOGO_M1553_Methylobacterium_Medium.yaml")
EXPECTED_ID = "CultureMech:008102"
EXPECTED_MEDIA_TERM = "TOGO:M1553"
YAML_LOADER = getattr(yaml, "CSafeLoader", yaml.SafeLoader)

CURATOR = "repair_togo_m1553_score15.py"
ACTION = "RESOLVED_TOGO_M1553_SCORE15"
TIMESTAMP = "2026-09-11T00:00:00-07:00"

TOGO_M1553 = "https://togomedium.org/medium/M1553"
NBRC_352 = "https://www.nite.go.jp/nbrc/catalogue/NBRCMediumDetailServlet?NO=352"

SOURCE = "TOGO M1553 / NBRC Medium 352"
TITLE = "Methylobacterium Medium"
...
INGREDIENTS: tuple[dict[str, Any], ...] = (
    ...
    _component("Yeast extract", "2.0", "G_PER_L"),
    _component(
        "Methanol**",
        "5.0",
        "ML_PER_L",
        notes=(
            "NBRC Medium 352 lists 5 ml/L Methanol and notes that the double "
            "asterisk marks separate filter sterilization."
        ),
    ),
    _component("MgSO4·7H2O", "1.0", "G_PER_L"),
    _component("Agar (if needed)", "15.0", "G_PER_L"),
    _component(
        "Distilled water",
        "1.0",
        "L",
        notes="NBRC Medium 352 lists 1 L distilled water.",
    ),
)
...
NOTES = (
    "TOGO M1553 imports NBRC Medium 352 as Methylobacterium Medium. "
    "NBRC 352 lists 10 g Hipolypepton from Wako Pure Chemical Industries, "
    "2 g yeast extract, 5 ml methanol, 1 g MgSO4·7H2O, optional 15 g agar, "
    "and 1 L distilled water at pH 7.0, and states that methanol is "
...
def _ensure_target(doc: dict[str, Any]) -> None:
    ...
    if solution_signatures not in (IMPORTED_SOLUTION_SIGNATURES, ()):
        raise ValueError(
...
def _append_curation_event(doc: dict[str, Any]) -> None:
    event = {
        ...
        "notes": (
            f"{NOTES} Moved methanol and Hipolypepton out of empty solution "
            "wrappers, corrected liquid quantities, and marked the NBRC "
            "formula as curated."
        ),
    }
