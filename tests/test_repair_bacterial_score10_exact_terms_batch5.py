...
SCRIPT = REPO / "scripts" / "repair_bacterial_score10_exact_terms_batch5.py"
...
def repair_module():
    return _load_script(SCRIPT, "repair_bacterial_score10_exact_terms_batch5")


@pytest.fixture(scope="module")
def scorer_module():
    return _load_script(SCORER, "score_review_need_for_bacterial_score10_batch5")
...
@pytest.mark.parametrize("target", tuple(_load_script(SCRIPT, "bacterial_batch5").TARGETS))
