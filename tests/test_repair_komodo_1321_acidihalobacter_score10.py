...
SCRIPT = REPO / "scripts" / "repair_komodo_1321_acidihalobacter_score10.py"
...
def repair_module():
    return _load_script(SCRIPT, "repair_komodo_1321_acidihalobacter")


@pytest.fixture(scope="module")
def scorer_module():
    return _load_script(SCORER, "score_review_need_for_komodo_1321")
...
def test_parent_promotes_acidihalobacter_root(repair_module) -> None:
