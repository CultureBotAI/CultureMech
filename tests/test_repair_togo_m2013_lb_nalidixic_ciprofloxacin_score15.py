...
SCRIPT = REPO / "scripts" / "repair_togo_m2013_lb_nalidixic_ciprofloxacin_score15.py"
...
def repair_module():
    return _load_script(SCRIPT, "repair_togo_m2013_lb_nalidixic_ciprofloxacin_score15")


@pytest.fixture(scope="module")
def scorer_module():
    return _load_script(SCORER, "score_review_need_for_togo_m2013")
...
def _target_doc(repair_module) -> dict:
    return {
        ...
        "original_name": "LB + Nalidixic acid, Ciprofloxacin medium",
        "category": "bacterial",
        "medium_type": "COMPLEX",
        ...
        "media_term": {
            "preferred_term": "TOGO Medium M2013",
            "term": {
                "id": repair_module.EXPECTED_MEDIA_TERM,
                "label": "LB + Nalidixic acid, Ciprofloxacin medium",
            },
        },
...
def test_repair_expands_lb_antibiotic_stocks(
    ...
    nalidixic = solutions["Nalidixic acid solution (30 mg/ml)"]["composition"][0]
    ciprofloxacin = solutions["Ciprofloxacin solution (5 mg/ml)"]["composition"][0]
    ...
    assert nalidixic["concentration"] == {"value": "30.0", "unit": "MG_PER_ML"}
    assert nalidixic["term"] == {"id": "CHEBI:100147", "label": "nalidixic acid"}
    assert ciprofloxacin["concentration"] == {"value": "5.0", "unit": "MG_PER_ML"}
    assert ciprofloxacin["term"] == {
        "id": "CHEBI:100241",
        "label": "ciprofloxacin",
    }
...
def test_repair_adds_flags_references_and_event_once(repair_module) -> None:
    ...
    assert once["references"] == [
        {"reference": repair_module.TOGO_M2013},
        {"reference": repair_module.NBRC_1301},
    ]
    matching_events = [
        event
...
def test_repair_rejects_solution_drift(repair_module) -> None:
    doc = _target_doc(repair_module)
    doc["solutions"][0]["preferred_term"] = "Ciprofloxacin"
