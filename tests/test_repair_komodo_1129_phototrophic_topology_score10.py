...
SCRIPT = REPO / "scripts" / "repair_komodo_1129_phototrophic_topology_score10.py"
...
def repair_module():
    return _load_script(SCRIPT, "repair_komodo_1129_phototrophic_topology_score10")


@pytest.fixture(scope="module")
def scorer_module():
    return _load_script(SCORER, "score_review_need_for_komodo_1129")
...
def test_mediadive_record_remains_source_duplicate(repair_module) -> None:
