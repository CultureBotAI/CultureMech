...
SCRIPT = REPO / "scripts" / "repair_komodo_8301_r2a_score10.py"
...
def repair_module():
    return _load_script(SCRIPT, "repair_komodo_8301_r2a")


@pytest.fixture(scope="module")
def scorer_module():
    return _load_script(SCORER, "score_review_need_for_komodo_8301")
...
def test_parent_reclassifies_only_dsm_22224_child(repair_module) -> None:
