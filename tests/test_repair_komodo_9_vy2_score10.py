...
SCRIPT = REPO / "scripts" / "repair_komodo_9_vy2_score10.py"
...
def repair_module():
    return _load_script(SCRIPT, "repair_komodo_9_vy2")


@pytest.fixture(scope="module")
def scorer_module():
    return _load_script(SCORER, "score_review_need_for_komodo_9_vy2")
...
def test_parent_promotes_vy2_root(repair_module) -> None:
