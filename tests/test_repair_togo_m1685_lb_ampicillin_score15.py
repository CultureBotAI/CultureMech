...
SCRIPT = REPO / "scripts" / "repair_togo_m1685_lb_ampicillin_score15.py"
...
def repair_module():
    return _load_script(SCRIPT, "repair_togo_m1685_lb_ampicillin_score15")


@pytest.fixture(scope="module")
def scorer_module():
    return _load_script(SCORER, "score_review_need_for_togo_m1685")
...
def _target_doc(repair_module) -> dict:
    return {
        ...
        "original_name": "LB + Ampicillin medium",
        "category": "bacterial",
        "medium_type": "COMPLEX",
        ...
        "media_term": {
            "preferred_term": "TOGO Medium M1685",
            "term": {
                "id": repair_module.EXPECTED_MEDIA_TERM,
                "label": "LB + Ampicillin medium",
            },
        },
...
def test_repair_expands_lb_sodium_ampicillin_stock(
    repair_module,
    scorer_module,
) -> None:
    ...
    assert sodium_ampicillin["concentration"] == {
        "value": "50.0",
        "unit": "MG_PER_ML",
    }
    assert sodium_ampicillin["term"] == {
        "id": "CHEBI:34535",
        "label": "Na-ampicillin",
    }
...
def test_repair_adds_flags_references_and_event_once(repair_module) -> None:
    ...
    assert once["references"] == [
        {"reference": repair_module.TOGO_M1685},
        {"reference": repair_module.NBRC_890},
    ]
    matching_events = [
        event
...
def test_repair_rejects_solution_drift(repair_module) -> None:
    doc = _target_doc(repair_module)
    doc["solutions"][0]["preferred_term"] = "Ampicillin"
