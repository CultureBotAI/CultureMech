...
SCRIPT = REPO / "scripts" / "repair_komodo_391_wmc_score10.py"
...
def repair_module():
    return _load_script(SCRIPT, "repair_komodo_391_wmc")


@pytest.fixture(scope="module")
def scorer_module():
    return _load_script(SCORER, "score_review_need_for_komodo_391")
...
@pytest.mark.parametrize(
    "child",
    tuple(_load_script(SCRIPT, "komodo_391").STRAIN_CHILDREN),
)
...
def test_named_duplicate_links_to_dsmz_391_parent(repair_module) -> None:
