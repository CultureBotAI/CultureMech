...
SCRIPT = REPO / "scripts" / "repair_komodo_503d_tmao3_tmpn3_score10.py"
...
def repair_module():
    return _load_script(SCRIPT, "repair_komodo_503d_tmao3_tmpn3")


@pytest.fixture(scope="module")
def scorer_module():
    return _load_script(SCORER, "score_review_need_for_komodo_503d")
...
def test_parent_lists_komodo_503d_children(repair_module) -> None:
