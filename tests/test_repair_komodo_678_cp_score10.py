...
SCRIPT = REPO / "scripts" / "repair_komodo_678_cp_score10.py"
...
def repair_module():
    return _load_script(SCRIPT, "repair_komodo_678_cp_score10")


@pytest.fixture(scope="module")
def scorer_module():
    return _load_script(SCORER, "score_review_need_for_komodo_678")
...
def test_parent_preserves_coprothermobacter_source_duplicate(repair_module) -> None:
