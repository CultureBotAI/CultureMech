...
SCRIPT = REPO / "scripts" / "repair_komodo_614_acetobacterium_score10.py"
...
def repair_module():
    return _load_script(SCRIPT, "repair_komodo_614_acetobacterium")


@pytest.fixture(scope="module")
def scorer_module():
    return _load_script(SCORER, "score_review_need_for_komodo_614")
