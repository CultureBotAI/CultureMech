...
SCRIPT = REPO / "scripts" / "repair_komodo_104b_pyx_ph_score10.py"
...
def repair_module():
    return _load_script(SCRIPT, "repair_komodo_104b_pyx_ph_score10")


@pytest.fixture(scope="module")
def scorer_module():
    return _load_script(SCORER, "score_review_need_for_komodo_104b")
...
def test_parent_preserves_exact_duplicate_children(repair_module) -> None:
