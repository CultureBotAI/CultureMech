...
SCRIPT = REPO / "scripts" / "repair_komodo_516_anaerocellum_score10.py"
...
def repair_module():
    return _load_script(SCRIPT, "repair_komodo_516_anaerocellum")


@pytest.fixture(scope="module")
def scorer_module():
    return _load_script(SCORER, "score_review_need_for_komodo_516")
...
@pytest.mark.parametrize("child_name", ["for_dsm_6724", "medium_516_modified_for_dsm_9003"])
def test_strain_variants_are_finalized(
    repair_module,
    scorer_module,
    child_name: str,
) -> None:
