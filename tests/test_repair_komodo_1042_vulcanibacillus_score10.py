...
SCRIPT = REPO / "scripts" / "repair_komodo_1042_vulcanibacillus_score10.py"
...
def repair_module():
    return _load_script(SCRIPT, "repair_komodo_1042_vulcanibacillus")


@pytest.fixture(scope="module")
def scorer_module():
    return _load_script(SCORER, "score_review_need_for_komodo_1042")
...
def test_parent_preserves_dsmz_duplicate_and_lists_child(repair_module) -> None:
