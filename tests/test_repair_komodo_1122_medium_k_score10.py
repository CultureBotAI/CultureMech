...
SCRIPT = REPO / "scripts" / "repair_komodo_1122_medium_k_score10.py"
...
def repair_module():
    return _load_script(SCRIPT, "repair_komodo_1122_medium_k")


@pytest.fixture(scope="module")
def scorer_module():
    return _load_script(SCORER, "score_review_need_for_komodo_1122")
...
def test_parent_preserves_dsmz_1122a_duplicate_child(repair_module) -> None:
