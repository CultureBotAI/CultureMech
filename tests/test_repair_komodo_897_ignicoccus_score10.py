...
SCRIPT = REPO / "scripts" / "repair_komodo_897_ignicoccus_score10.py"
...
def repair_module():
    return _load_script(SCRIPT, "repair_komodo_897_ignicoccus")


@pytest.fixture(scope="module")
def scorer_module():
    return _load_script(SCORER, "score_review_need_for_komodo_897")
...
def test_parent_promotes_ignicoccus_root(repair_module) -> None:
