...
SCRIPT = REPO / "scripts" / "repair_komodo_1163_oceanotoga_score10.py"
...
def repair_module():
    return _load_script(SCRIPT, "repair_komodo_1163_oceanotoga")


@pytest.fixture(scope="module")
def scorer_module():
    return _load_script(SCORER, "score_review_need_for_komodo_1163")
...
@pytest.mark.parametrize("child", tuple(_load_script(SCRIPT, "komodo_1163").CHILDREN))
