...
SCRIPT = REPO / "scripts" / "repair_komodo_1101_desulfonatronospira_score10.py"
...
def repair_module():
    return _load_script(SCRIPT, "repair_komodo_1101_desulfonatronospira")


@pytest.fixture(scope="module")
def scorer_module():
    return _load_script(SCORER, "score_review_need_for_komodo_1101")
