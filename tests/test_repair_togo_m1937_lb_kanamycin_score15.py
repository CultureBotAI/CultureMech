...
SCRIPT = REPO / "scripts" / "repair_togo_m1937_lb_kanamycin_score15.py"
...
def repair_module():
    return _load_script(SCRIPT, "repair_togo_m1937_lb_kanamycin_score15")


@pytest.fixture(scope="module")
def scorer_module():
    return _load_script(SCORER, "score_review_need_for_togo_m1937")
...
def _target_doc(repair_module) -> dict:
    return {
        ...
        "original_name": "LB + Kanamycin medium",
        "category": "bacterial",
        "medium_type": "COMPLEX",
        ...
        "media_term": {
            "preferred_term": "TOGO Medium M1937",
            "term": {
                "id": repair_module.EXPECTED_MEDIA_TERM,
                "label": "LB + Kanamycin medium",
            },
        },
...
def test_repair_expands_lb_kanamycin_stock(
    repair_module,
    scorer_module,
) -> None:
    ...
    kanamycin = solutions["Kanamycin sulfate solution (20 mg/ml)"]["composition"][0]
...
def test_repair_adds_flags_references_and_event_once(repair_module) -> None:
    ...
    assert once["references"] == [
        {"reference": repair_module.TOGO_M1937},
        {"reference": repair_module.NBRC_1204},
    ]
    matching_events = [
        event
...
def test_repair_rejects_solution_drift(repair_module) -> None:
    doc = _target_doc(repair_module)
    doc["solutions"][0]["preferred_term"] = "Kanamycin sulfate"
