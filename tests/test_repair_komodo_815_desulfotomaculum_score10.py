...
SCRIPT = REPO / "scripts" / "repair_komodo_815_desulfotomaculum_score10.py"
...
def repair_module():
    return _load_script(SCRIPT, "repair_komodo_815_desulfotomaculum")


@pytest.fixture(scope="module")
def scorer_module():
    return _load_script(SCORER, "score_review_need_for_komodo_815")
...
def test_parent_promotes_desulfotomaculum_root(repair_module) -> None:
