...
SCRIPT = REPO / "scripts" / "repair_komodo_1053_sulfurimonas_score10.py"
...
def repair_module():
    return _load_script(SCRIPT, "repair_komodo_1053_sulfurimonas")


@pytest.fixture(scope="module")
def scorer_module():
    return _load_script(SCORER, "score_review_need_for_komodo_1053")
...
def test_parent_lists_strain_child(repair_module) -> None:
