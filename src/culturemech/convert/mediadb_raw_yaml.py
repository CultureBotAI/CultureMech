"""Convert MediaDB SQL/JSON to raw YAML format.

Performs direct 1:1 conversion of MediaDB exports to YAML
without any normalization or LinkML validation.

Input: raw/mediadb/*.json (or *.sql converted to JSON)
Output: raw_yaml/mediadb/*.yaml
"""
