...
nano raw/atcc/atcc_media_manual.json

# 4. Import to CultureMech
just import-atcc

# 5. Validate
just validate normalized_yaml/bacterial/[medium_name].yaml
...
cat raw/mediadive/mediadive_media.json | jq '.data[] | select(.id == "632")'
