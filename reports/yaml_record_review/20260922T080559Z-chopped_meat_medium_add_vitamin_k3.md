# YAML Record Review: Chopped Meat Medium (add Vitamin K3)

- Repository: CultureBotAI/CultureMech
- Record: data/merge_yaml/merged/chopped_meat_medium_add_vitamin_k3.yaml
- Started UTC: 2026-09-22T08:05:16Z
- Finished UTC: 2026-09-22T08:06:01Z
...
| --- | --- |
| Class | MediaRecipe |
| ID | CultureMech:009093 |
| Label | Chopped Meat Medium (add Vitamin K3) |
| Generated record | data/merge_yaml/merged/chopped_meat_medium_add_vitamin_k3.yaml |
| Maintained owner | data/normalized_yaml/bacterial/chopped_meat_medium_add_vitamin_k3.yaml |
| Source | TOGO Medium M2523, DSMZ Medium 78 |

The reviewed file is a generated one-source merge of the DSMZ Medium 78
Vitamin K3 variant through TOGO M2523. Future fixes belong in the maintained
...
| `scripts/validate_strict.py` on the generated record | Passed; 0 errors in `/private/tmp/chopped_meat_medium_add_vitamin_k3.strict.tsv` |
...
The source identity is correct: `CultureMech:009093`, `TOGO:M2523`, the
maintained owner stem, and the generated merge fingerprint all denote Chopped
Meat Medium with the DSMZ Medium 78 Haemin and Vitamin K3 additions.
...
TOGO M2523 source ID, maintained owner stem, and merge fingerprint found this
generated record, its maintained owner, normalized index entries, and the
separate Vitamin K3-plus-agar sibling record.

## Evidence

TOGO M2523 and DSMZ Medium 78 support DSMZ Chopped Meat Medium with 10.00 mL
Haemin solution and 10.00 mL Vitamin K3 solution added to 1000 mL medium after
...
The record flattens both stock recipes into final-medium ingredients:
99 mL Haemin-stock water is merged with 1000 mL base water into 1099 g/L,
1 mL Haemin-stock NaOH is a separate 1 g/L parent ingredient, 50 mg haemin is
recorded as 50 g/L, Vitamin K3's 5 mg/mL stock concentration is recorded as
5 g/L, and 95% ethanol is defaulted to a variable parent ingredient. The final
10 mL additions of Haemin solution and Vitamin K3 solution are present only as
empty `G_PER_L` solution shells.
...
| Severity | Finding |
| --- | --- |
| Major | Haemin solution and Vitamin K3 solution internals are flattened into parent ingredients, while the two 10 mL stock additions remain as empty `G_PER_L` solution shells. **Owner:** `data/normalized_yaml/bacterial/chopped_meat_medium_add_vitamin_k3.yaml` or solution migration. |
...
Then manually compare the regenerated record against TOGO M2523 and DSMZ Medium
78 to confirm the base medium, Haemin stock, Vitamin K3 stock, source units, pH,
